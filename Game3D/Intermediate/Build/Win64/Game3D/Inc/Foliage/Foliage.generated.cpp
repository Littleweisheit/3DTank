...
void EmptyLinkFunctionForGeneratedCode1Foliage() {}
...
// Cross Module References
	...
	FOLIAGE_API class UEnum* Z_Construct_UEnum_Foliage_EVertexColorMaskChannel();
	FOLIAGE_API class UEnum* Z_Construct_UEnum_Foliage_FoliageVertexColorMask();
	FOLIAGE_API class UScriptStruct* Z_Construct_UScriptStruct_FFoliageVertexColorChannelMask();
	...
	FOLIAGE_API class UPackage* Z_Construct_UPackage__Script_Foliage();
	UFunction* Z_Construct_UDelegateFunction_Foliage_InstanceRadialDamageSignature__DelegateSignature()
	{
		...
		UObject* Outer=Z_Construct_UPackage__Script_Foliage();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("InstanceRadialDamageSignature__DelegateSignature"), RF_Public|RF_Transient|RF_MarkAsNative) UDelegateFunction(FObjectInitializer(), NULL, 0x00130000, 65535, sizeof(_Script_Foliage_eventInstanceRadialDamageSignature_Parms));
			UProperty* NewProp_DamageCauser = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("DamageCauser"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(DamageCauser, _Script_Foliage_eventInstanceRadialDamageSignature_Parms), 0x0010000000000080, Z_Construct_UClass_AActor_NoRegister());
			UProperty* NewProp_DamageType = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("DamageType"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(DamageType, _Script_Foliage_eventInstanceRadialDamageSignature_Parms), 0x0010000000000082, Z_Construct_UClass_UDamageType_NoRegister());
			UProperty* NewProp_MaxRadius = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("MaxRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxRadius, _Script_Foliage_eventInstanceRadialDamageSignature_Parms), 0x0010000000000080);
			UProperty* NewProp_Origin = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Origin"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Origin, _Script_Foliage_eventInstanceRadialDamageSignature_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_InstigatedBy = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("InstigatedBy"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(InstigatedBy, _Script_Foliage_eventInstanceRadialDamageSignature_Parms), 0x0010000000000080, Z_Construct_UClass_AController_NoRegister());
			UProperty* NewProp_Damages = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Damages"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(Damages, _Script_Foliage_eventInstanceRadialDamageSignature_Parms), 0x0010000008000182);
			UProperty* NewProp_Damages_Inner = new(EC_InternalUseOnlyConstructor, NewProp_Damages, TEXT("Damages"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			UProperty* NewProp_Instances = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Instances"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(Instances, _Script_Foliage_eventInstanceRadialDamageSignature_Parms), 0x0010000008000182);
			UProperty* NewProp_Instances_Inner = new(EC_InternalUseOnlyConstructor, NewProp_Instances, TEXT("Instances"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			ReturnFunction->Bind();
			...
			MetaData->SetValue(NewProp_Damages, TEXT("NativeConst"), TEXT(""));
			MetaData->SetValue(NewProp_Instances, TEXT("NativeConst"), TEXT(""));
#endif
		}
	...
	UFunction* Z_Construct_UDelegateFunction_Foliage_InstancePointDamageSignature__DelegateSignature()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("InstancePointDamageSignature__DelegateSignature"), RF_Public|RF_Transient|RF_MarkAsNative) UDelegateFunction(FObjectInitializer(), NULL, 0x00130000, 65535, sizeof(_Script_Foliage_eventInstancePointDamageSignature_Parms));
			UProperty* NewProp_DamageCauser = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("DamageCauser"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(DamageCauser, _Script_Foliage_eventInstancePointDamageSignature_Parms), 0x0010000000000080, Z_Construct_UClass_AActor_NoRegister());
			UProperty* NewProp_DamageType = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("DamageType"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(DamageType, _Script_Foliage_eventInstancePointDamageSignature_Parms), 0x0010000000000082, Z_Construct_UClass_UDamageType_NoRegister());
			UProperty* NewProp_ShotFromDirection = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ShotFromDirection"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ShotFromDirection, _Script_Foliage_eventInstancePointDamageSignature_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_HitLocation = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("HitLocation"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(HitLocation, _Script_Foliage_eventInstancePointDamageSignature_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_InstigatedBy = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("InstigatedBy"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(InstigatedBy, _Script_Foliage_eventInstancePointDamageSignature_Parms), 0x0010000000000080, Z_Construct_UClass_AController_NoRegister());
			UProperty* NewProp_Damage = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Damage"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Damage, _Script_Foliage_eventInstancePointDamageSignature_Parms), 0x0010000000000080);
			UProperty* NewProp_InstanceIndex = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("InstanceIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(InstanceIndex, _Script_Foliage_eventInstancePointDamageSignature_Parms), 0x0010000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_UFoliageInstancedStaticMeshComponent()
	{
		...
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage__Script_Foliage();
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				...
				UProperty* NewProp_FoliageHiddenEditorViews = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FoliageHiddenEditorViews"), RF_Public|RF_Transient|RF_MarkAsNative) UUInt64Property(CPP_PROPERTY_BASE(FoliageHiddenEditorViews, UFoliageInstancedStaticMeshComponent), 0x0010000800002000);
#endif // WITH_EDITORONLY_DATA
				UProperty* NewProp_OnInstanceTakeRadialDamage = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnInstanceTakeRadialDamage"), RF_Public|RF_Transient|RF_MarkAsNative) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnInstanceTakeRadialDamage, UFoliageInstancedStaticMeshComponent), 0x0010000010080000, Z_Construct_UDelegateFunction_Foliage_InstanceRadialDamageSignature__DelegateSignature());
				UProperty* NewProp_OnInstanceTakePointDamage = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnInstanceTakePointDamage"), RF_Public|RF_Transient|RF_MarkAsNative) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnInstanceTakePointDamage, UFoliageInstancedStaticMeshComponent), 0x0010000010080000, Z_Construct_UDelegateFunction_Foliage_InstancePointDamageSignature__DelegateSignature());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UFoliageInstancedStaticMeshComponent> > StaticCppClassTypeInfo;
	...
	IMPLEMENT_CLASS(UFoliageInstancedStaticMeshComponent, 2437631852);
	...
	UFunction* Z_Construct_UFunction_UFoliageStatistics_FoliageOverlappingBoxCount()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FoliageOverlappingBoxCount"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04822401, 65535, sizeof(FoliageStatistics_eventFoliageOverlappingBoxCount_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(ReturnValue, FoliageStatistics_eventFoliageOverlappingBoxCount_Parms), 0x0010000000000580);
			UProperty* NewProp_Box = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Box"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Box, FoliageStatistics_eventFoliageOverlappingBoxCount_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FBox());
			UProperty* NewProp_StaticMesh = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("StaticMesh"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(StaticMesh, FoliageStatistics_eventFoliageOverlappingBoxCount_Parms), 0x0010000000000082, Z_Construct_UClass_UStaticMesh_NoRegister());
			UProperty* NewProp_WorldContextObject = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("WorldContextObject"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(WorldContextObject, FoliageStatistics_eventFoliageOverlappingBoxCount_Parms), 0x0010000000000080, Z_Construct_UClass_UObject_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			...
			MetaData->SetValue(NewProp_StaticMesh, TEXT("NativeConst"), TEXT(""));
#endif
		}
		return ReturnFunction;
	}
	UFunction* Z_Construct_UFunction_UFoliageStatistics_FoliageOverlappingSphereCount()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FoliageOverlappingSphereCount"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04822401, 65535, sizeof(FoliageStatistics_eventFoliageOverlappingSphereCount_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(ReturnValue, FoliageStatistics_eventFoliageOverlappingSphereCount_Parms), 0x0010000000000580);
			UProperty* NewProp_Radius = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Radius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Radius, FoliageStatistics_eventFoliageOverlappingSphereCount_Parms), 0x0010000000000080);
			UProperty* NewProp_CenterPosition = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("CenterPosition"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(CenterPosition, FoliageStatistics_eventFoliageOverlappingSphereCount_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_StaticMesh = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("StaticMesh"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(StaticMesh, FoliageStatistics_eventFoliageOverlappingSphereCount_Parms), 0x0010000000000082, Z_Construct_UClass_UStaticMesh_NoRegister());
			UProperty* NewProp_WorldContextObject = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("WorldContextObject"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(WorldContextObject, FoliageStatistics_eventFoliageOverlappingSphereCount_Parms), 0x0010000000000080, Z_Construct_UClass_UObject_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_UFoliageStatistics()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFoliageStatistics_FoliageOverlappingBoxCount(), "FoliageOverlappingBoxCount"); // 1465145245
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFoliageStatistics_FoliageOverlappingSphereCount(), "FoliageOverlappingSphereCount"); // 1450024155
				static TCppClassTypeInfo<TCppClassTypeTraits<UFoliageStatistics> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UFoliageStatistics, 3641840412);
...
{
	extern FOLIAGE_API class UPackage* Z_Construct_UPackage__Script_Foliage();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFoliageScaling(EFoliageScaling_StaticEnum, TEXT("/Script/Foliage"), TEXT("EFoliageScaling"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_Foliage_EFoliageScaling()
	{
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EFoliageScaling"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EFoliageScaling::Uniform"), 0);
			EnumNames.Emplace(TEXT("EFoliageScaling::Free"), 1);
			EnumNames.Emplace(TEXT("EFoliageScaling::LockXY"), 2);
			EnumNames.Emplace(TEXT("EFoliageScaling::LockXZ"), 3);
			EnumNames.Emplace(TEXT("EFoliageScaling::LockYZ"), 4);
			EnumNames.Emplace(TEXT("EFoliageScaling::EFoliageScaling_MAX"), 5);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("EFoliageScaling");
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UEnum_Foliage_EFoliageScaling_CRC() { return 2994000641U; }
static UEnum* EVertexColorMaskChannel_StaticEnum()
{
	...
	if (!Singleton)
	{
		extern FOLIAGE_API class UEnum* Z_Construct_UEnum_Foliage_EVertexColorMaskChannel();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EVertexColorMaskChannel(EVertexColorMaskChannel_StaticEnum, TEXT("/Script/Foliage"), TEXT("EVertexColorMaskChannel"), false, nullptr, nullptr);
	...
	{
		UPackage* Outer=Z_Construct_UPackage__Script_Foliage();
		extern uint32 Get_Z_Construct_UEnum_Foliage_EVertexColorMaskChannel_CRC();
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EVertexColorMaskChannel"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EVertexColorMaskChannel::Red"), 0);
			EnumNames.Emplace(TEXT("EVertexColorMaskChannel::Green"), 1);
			EnumNames.Emplace(TEXT("EVertexColorMaskChannel::Blue"), 2);
			EnumNames.Emplace(TEXT("EVertexColorMaskChannel::Alpha"), 3);
			EnumNames.Emplace(TEXT("EVertexColorMaskChannel::MAX_None"), 4);
			EnumNames.Emplace(TEXT("EVertexColorMaskChannel::EVertexColorMaskChannel_MAX"), 5);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("EVertexColorMaskChannel");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("MAX_None.Hidden"), TEXT(""));
			MetaData->SetValue(ReturnEnum, TEXT("ModuleRelativePath"), TEXT("Public/FoliageType.h"));
#endif
		}
		return ReturnEnum;
	}
	uint32 Get_Z_Construct_UEnum_Foliage_EVertexColorMaskChannel_CRC() { return 3572524854U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_FoliageVertexColorMask(FoliageVertexColorMask_StaticEnum, TEXT("/Script/Foliage"), TEXT("FoliageVertexColorMask"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_Foliage_FoliageVertexColorMask()
	{
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FoliageVertexColorMask"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("FOLIAGEVERTEXCOLORMASK_Disabled"), 0);
			EnumNames.Emplace(TEXT("FOLIAGEVERTEXCOLORMASK_Red"), 1);
			EnumNames.Emplace(TEXT("FOLIAGEVERTEXCOLORMASK_Green"), 2);
			EnumNames.Emplace(TEXT("FOLIAGEVERTEXCOLORMASK_Blue"), 3);
			EnumNames.Emplace(TEXT("FOLIAGEVERTEXCOLORMASK_Alpha"), 4);
			EnumNames.Emplace(TEXT("FOLIAGEVERTEXCOLORMASK_MAX"), 5);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Regular);
			ReturnEnum->CppType = TEXT("FoliageVertexColorMask");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
	...
	uint32 Get_Z_Construct_UEnum_Foliage_FoliageVertexColorMask_CRC() { return 518259763U; }
class UScriptStruct* FFoliageVertexColorChannelMask::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern FOLIAGE_API class UScriptStruct* Z_Construct_UScriptStruct_FFoliageVertexColorChannelMask();
...
static struct FScriptStruct_Foliage_StaticRegisterNativesFFoliageVertexColorChannelMask
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FFoliageVertexColorChannelMask()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FoliageVertexColorChannelMask"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FFoliageVertexColorChannelMask>, EStructFlags(0x00000001));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(InvertMask, FFoliageVertexColorChannelMask, uint8);
			UProperty* NewProp_InvertMask = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("InvertMask"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(InvertMask, FFoliageVertexColorChannelMask), 0x0010000000000001, CPP_BOOL_PROPERTY_BITMASK(InvertMask, FFoliageVertexColorChannelMask), sizeof(uint8), false);
			UProperty* NewProp_MaskThreshold = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("MaskThreshold"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaskThreshold, FFoliageVertexColorChannelMask), 0x0010000000000001);
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(UseMask, FFoliageVertexColorChannelMask, uint8);
			UProperty* NewProp_UseMask = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("UseMask"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(UseMask, FFoliageVertexColorChannelMask), 0x0010000000000001, CPP_BOOL_PROPERTY_BITMASK(UseMask, FFoliageVertexColorChannelMask), sizeof(uint8), false);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/FoliageType.h"));
			MetaData->SetValue(NewProp_InvertMask, TEXT("Category"), TEXT("VertexColorMask"));
			MetaData->SetValue(NewProp_InvertMask, TEXT("ModuleRelativePath"), TEXT("Public/FoliageType.h"));
			MetaData->SetValue(NewProp_InvertMask, TEXT("ToolTip"), TEXT("When unchecked, foliage instances will be placed only when the vertex color in the specified channel(s) is above the threshold amount.\nWhen checked, the vertex color must be less than the threshold amount"));
			MetaData->SetValue(NewProp_MaskThreshold, TEXT("Category"), TEXT("VertexColorMask"));
			MetaData->SetValue(NewProp_MaskThreshold, TEXT("ModuleRelativePath"), TEXT("Public/FoliageType.h"));
			MetaData->SetValue(NewProp_MaskThreshold, TEXT("ToolTip"), TEXT("Specifies the threshold value above which the static mesh vertex color value must be, in order for foliage instances to be placed in a specific area"));
			MetaData->SetValue(NewProp_UseMask, TEXT("Category"), TEXT("VertexColorMask"));
			MetaData->SetValue(NewProp_UseMask, TEXT("ModuleRelativePath"), TEXT("Public/FoliageType.h"));
			MetaData->SetValue(NewProp_UseMask, TEXT("ToolTip"), TEXT("When checked, foliage will be masked from this mesh using this color channel"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FFoliageVertexColorChannelMask_CRC() { return 2539673957U; }
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
#if WITH_EDITORONLY_DATA
				UProperty* NewProp_MaxScale = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxScale"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxScale_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_MinScale = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MinScale"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MinScale_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_MinGroundSlope = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MinGroundSlope"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MinGroundSlope_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_GroundSlope = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("GroundSlope"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(GroundSlope_DEPRECATED, UFoliageType), 0x0040000820000000);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(LockScaleZ_DEPRECATED, UFoliageType, uint8);
				UProperty* NewProp_LockScaleZ = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("LockScaleZ"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(LockScaleZ_DEPRECATED, UFoliageType), 0x0040000820000000, CPP_BOOL_PROPERTY_BITMASK(LockScaleZ_DEPRECATED, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(LockScaleY_DEPRECATED, UFoliageType, uint8);
				UProperty* NewProp_LockScaleY = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("LockScaleY"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(LockScaleY_DEPRECATED, UFoliageType), 0x0040000820000000, CPP_BOOL_PROPERTY_BITMASK(LockScaleY_DEPRECATED, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(LockScaleX_DEPRECATED, UFoliageType, uint8);
				UProperty* NewProp_LockScaleX = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("LockScaleX"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(LockScaleX_DEPRECATED, UFoliageType), 0x0040000820000000, CPP_BOOL_PROPERTY_BITMASK(LockScaleX_DEPRECATED, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(UniformScale_DEPRECATED, UFoliageType, uint8);
				UProperty* NewProp_UniformScale = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("UniformScale"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(UniformScale_DEPRECATED, UFoliageType), 0x0040000820000000, CPP_BOOL_PROPERTY_BITMASK(UniformScale_DEPRECATED, UFoliageType), sizeof(uint8), false);
				UProperty* NewProp_EndCullDistance = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("EndCullDistance"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(EndCullDistance_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_StartCullDistance = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("StartCullDistance"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(StartCullDistance_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_ZOffsetMax = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ZOffsetMax"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ZOffsetMax_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_ZOffsetMin = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ZOffsetMin"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ZOffsetMin_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_HeightMax = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("HeightMax"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(HeightMax_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_HeightMin = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("HeightMin"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(HeightMin_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_ScaleMaxZ = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ScaleMaxZ"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ScaleMaxZ_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_ScaleMaxY = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ScaleMaxY"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ScaleMaxY_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_ScaleMaxX = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ScaleMaxX"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ScaleMaxX_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_ScaleMinZ = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ScaleMinZ"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ScaleMinZ_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_ScaleMinY = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ScaleMinY"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ScaleMinY_DEPRECATED, UFoliageType), 0x0040000820000000);
				UProperty* NewProp_ScaleMinX = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ScaleMinX"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ScaleMinX_DEPRECATED, UFoliageType), 0x0040000820000000);
#endif // WITH_EDITORONLY_DATA
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bEnableDensityScaling, UFoliageType, uint8);
				UProperty* NewProp_bEnableDensityScaling = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bEnableDensityScaling"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bEnableDensityScaling, UFoliageType), 0x0010000000000001, CPP_BOOL_PROPERTY_BITMASK(bEnableDensityScaling, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyVertexColorMask, UFoliageType, uint8);
				UProperty* NewProp_ReapplyVertexColorMask = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyVertexColorMask"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyVertexColorMask, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyVertexColorMask, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyCollisionWithWorld, UFoliageType, uint8);
				UProperty* NewProp_ReapplyCollisionWithWorld = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyCollisionWithWorld"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyCollisionWithWorld, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyCollisionWithWorld, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyZOffset, UFoliageType, uint8);
				UProperty* NewProp_ReapplyZOffset = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyZOffset"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyZOffset, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyZOffset, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyLandscapeLayers, UFoliageType, uint8);
				UProperty* NewProp_ReapplyLandscapeLayers = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyLandscapeLayers"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyLandscapeLayers, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyLandscapeLayers, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyHeight, UFoliageType, uint8);
				UProperty* NewProp_ReapplyHeight = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyHeight"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyHeight, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyHeight, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyGroundSlope, UFoliageType, uint8);
				UProperty* NewProp_ReapplyGroundSlope = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyGroundSlope"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyGroundSlope, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyGroundSlope, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyRandomPitchAngle, UFoliageType, uint8);
				UProperty* NewProp_ReapplyRandomPitchAngle = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyRandomPitchAngle"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyRandomPitchAngle, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyRandomPitchAngle, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyScaleZ, UFoliageType, uint8);
				UProperty* NewProp_ReapplyScaleZ = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyScaleZ"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyScaleZ, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyScaleZ, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyScaleY, UFoliageType, uint8);
				UProperty* NewProp_ReapplyScaleY = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyScaleY"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyScaleY, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyScaleY, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyScaleX, UFoliageType, uint8);
				UProperty* NewProp_ReapplyScaleX = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyScaleX"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyScaleX, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyScaleX, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyScaling, UFoliageType, uint8);
				UProperty* NewProp_ReapplyScaling = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyScaling"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyScaling, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyScaling, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyRandomYaw, UFoliageType, uint8);
				UProperty* NewProp_ReapplyRandomYaw = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyRandomYaw"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyRandomYaw, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyRandomYaw, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyAlignToNormal, UFoliageType, uint8);
				UProperty* NewProp_ReapplyAlignToNormal = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyAlignToNormal"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyAlignToNormal, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyAlignToNormal, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyRadius, UFoliageType, uint8);
				UProperty* NewProp_ReapplyRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyRadius, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyRadius, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReapplyDensity, UFoliageType, uint8);
				UProperty* NewProp_ReapplyDensity = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReapplyDensity"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReapplyDensity, UFoliageType), 0x0010000000010001, CPP_BOOL_PROPERTY_BITMASK(ReapplyDensity, UFoliageType), sizeof(uint8), false);
				UProperty* NewProp_ChangeCount = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ChangeCount"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(ChangeCount, UFoliageType), 0x0010000000000000);
				UProperty* NewProp_ScaleCurve = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ScaleCurve"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ScaleCurve, UFoliageType), 0x0010000000000001, Z_Construct_UScriptStruct_FRuntimeFloatCurve());
				UProperty* NewProp_ProceduralScale = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ProceduralScale"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ProceduralScale, UFoliageType), 0x0010000000000001, Z_Construct_UScriptStruct_FFloatInterval());
				UProperty* NewProp_OverlapPriority = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OverlapPriority"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(OverlapPriority, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_MaxAge = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxAge"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxAge, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_MaxInitialAge = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxInitialAge"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxInitialAge, UFoliageType), 0x0010000000000001);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bSpawnsInShade, UFoliageType, bool);
				UProperty* NewProp_bSpawnsInShade = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bSpawnsInShade"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bSpawnsInShade, UFoliageType), 0x0010000000000001, CPP_BOOL_PROPERTY_BITMASK(bSpawnsInShade, UFoliageType), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bCanGrowInShade, UFoliageType, bool);
				UProperty* NewProp_bCanGrowInShade = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bCanGrowInShade"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bCanGrowInShade, UFoliageType), 0x0010000000000001, CPP_BOOL_PROPERTY_BITMASK(bCanGrowInShade, UFoliageType), sizeof(bool), true);
				UProperty* NewProp_MaxInitialSeedOffset = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxInitialSeedOffset"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxInitialSeedOffset, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_DistributionSeed = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DistributionSeed"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(DistributionSeed, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_SeedsPerStep = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SeedsPerStep"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(SeedsPerStep, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_SpreadVariance = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SpreadVariance"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(SpreadVariance, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_AverageSpreadDistance = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AverageSpreadDistance"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(AverageSpreadDistance, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_InitialSeedDensity = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("InitialSeedDensity"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(InitialSeedDensity, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_NumSteps = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("NumSteps"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(NumSteps, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_ShadeRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ShadeRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ShadeRadius, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_CollisionRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CollisionRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(CollisionRadius, UFoliageType), 0x0010000000000001);
#if WITH_EDITORONLY_DATA
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(IsSelected, UFoliageType, uint8);
				UProperty* NewProp_IsSelected = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("IsSelected"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(IsSelected, UFoliageType), 0x0010000800000000, CPP_BOOL_PROPERTY_BITMASK(IsSelected, UFoliageType), sizeof(uint8), false);
				UProperty* NewProp_HiddenEditorViews = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("HiddenEditorViews"), RF_Public|RF_Transient|RF_MarkAsNative) UUInt64Property(CPP_PROPERTY_BASE(HiddenEditorViews, UFoliageType), 0x0010000800002000);
#endif // WITH_EDITORONLY_DATA
				UProperty* NewProp_CustomDepthStencilValue = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CustomDepthStencilValue"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(CustomDepthStencilValue, UFoliageType), 0x0010040000000015);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bRenderCustomDepth, UFoliageType, uint8);
				UProperty* NewProp_bRenderCustomDepth = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bRenderCustomDepth"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bRenderCustomDepth, UFoliageType), 0x0010040000000015, CPP_BOOL_PROPERTY_BITMASK(bRenderCustomDepth, UFoliageType), sizeof(uint8), false);
				UProperty* NewProp_LightingChannels = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("LightingChannels"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(LightingChannels, UFoliageType), 0x0010040000000015, Z_Construct_UScriptStruct_FLightingChannels());
				UProperty* NewProp_CustomNavigableGeometry = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CustomNavigableGeometry"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(CustomNavigableGeometry, UFoliageType), 0x0010000000000001, Z_Construct_UEnum_Engine_EHasCustomNavigableGeometry());
				UProperty* NewProp_BodyInstance = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("BodyInstance"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(BodyInstance, UFoliageType), 0x0010000000000001, Z_Construct_UScriptStruct_FBodyInstance());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bUseAsOccluder, UFoliageType, uint8);
				UProperty* NewProp_bUseAsOccluder = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bUseAsOccluder"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bUseAsOccluder, UFoliageType), 0x0010040000000015, CPP_BOOL_PROPERTY_BITMASK(bUseAsOccluder, UFoliageType), sizeof(uint8), false);
				UProperty* NewProp_OverriddenLightMapRes = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OverriddenLightMapRes"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(OverriddenLightMapRes, UFoliageType), 0x0010000000000015);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bOverrideLightMapRes, UFoliageType, uint8);
				UProperty* NewProp_bOverrideLightMapRes = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bOverrideLightMapRes"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bOverrideLightMapRes, UFoliageType), 0x0010000000000015, CPP_BOOL_PROPERTY_BITMASK(bOverrideLightMapRes, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bReceivesDecals, UFoliageType, uint8);
				UProperty* NewProp_bReceivesDecals = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bReceivesDecals"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bReceivesDecals, UFoliageType), 0x0010040000000015, CPP_BOOL_PROPERTY_BITMASK(bReceivesDecals, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bCastShadowAsTwoSided, UFoliageType, uint8);
				UProperty* NewProp_bCastShadowAsTwoSided = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bCastShadowAsTwoSided"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bCastShadowAsTwoSided, UFoliageType), 0x0010040000000015, CPP_BOOL_PROPERTY_BITMASK(bCastShadowAsTwoSided, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bCastStaticShadow, UFoliageType, uint8);
				UProperty* NewProp_bCastStaticShadow = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bCastStaticShadow"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bCastStaticShadow, UFoliageType), 0x0010000000000015, CPP_BOOL_PROPERTY_BITMASK(bCastStaticShadow, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bCastDynamicShadow, UFoliageType, uint8);
				UProperty* NewProp_bCastDynamicShadow = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bCastDynamicShadow"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bCastDynamicShadow, UFoliageType), 0x0010000000000015, CPP_BOOL_PROPERTY_BITMASK(bCastDynamicShadow, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAffectDistanceFieldLighting, UFoliageType, uint8);
				UProperty* NewProp_bAffectDistanceFieldLighting = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bAffectDistanceFieldLighting"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAffectDistanceFieldLighting, UFoliageType), 0x0010000000000015, CPP_BOOL_PROPERTY_BITMASK(bAffectDistanceFieldLighting, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAffectDynamicIndirectLighting, UFoliageType, uint8);
				UProperty* NewProp_bAffectDynamicIndirectLighting = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bAffectDynamicIndirectLighting"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAffectDynamicIndirectLighting, UFoliageType), 0x0010000000000015, CPP_BOOL_PROPERTY_BITMASK(bAffectDynamicIndirectLighting, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(CastShadow, UFoliageType, uint8);
				UProperty* NewProp_CastShadow = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CastShadow"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(CastShadow, UFoliageType), 0x0010000000000015, CPP_BOOL_PROPERTY_BITMASK(CastShadow, UFoliageType), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bEnableStaticLighting_DEPRECATED, UFoliageType, uint8);
				UProperty* NewProp_bEnableStaticLighting = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bEnableStaticLighting"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bEnableStaticLighting_DEPRECATED, UFoliageType), 0x0010000020000000, CPP_BOOL_PROPERTY_BITMASK(bEnableStaticLighting_DEPRECATED, UFoliageType), sizeof(uint8), false);
				UProperty* NewProp_CullDistance = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CullDistance"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(CullDistance, UFoliageType), 0x0010000000000001, Z_Construct_UScriptStruct_FInt32Interval());
				UProperty* NewProp_Mobility = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Mobility"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(Mobility, UFoliageType), 0x0010000000000015, Z_Construct_UEnum_Engine_EComponentMobility());
				UProperty* NewProp_LowBoundOriginRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("LowBoundOriginRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(LowBoundOriginRadius, UFoliageType), 0x0010000000000000, Z_Construct_UScriptStruct_FVector());
				UProperty* NewProp_MeshBounds = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MeshBounds"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(MeshBounds, UFoliageType), 0x0010000000000000, Z_Construct_UScriptStruct_FBoxSphereBounds());
				UProperty* NewProp_MinimumLayerWeight = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MinimumLayerWeight"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MinimumLayerWeight, UFoliageType), 0x0010040000000001);
				UProperty* NewProp_CollisionScale = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CollisionScale"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(CollisionScale, UFoliageType), 0x0010040000000001, Z_Construct_UScriptStruct_FVector());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(CollisionWithWorld, UFoliageType, uint8);
				UProperty* NewProp_CollisionWithWorld = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CollisionWithWorld"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(CollisionWithWorld, UFoliageType), 0x0010040000000001, CPP_BOOL_PROPERTY_BITMASK(CollisionWithWorld, UFoliageType), sizeof(uint8), false);
				UProperty* NewProp_LandscapeLayer = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("LandscapeLayer"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(LandscapeLayer_DEPRECATED, UFoliageType), 0x0010000020000000);
				UProperty* NewProp_LandscapeLayers = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("LandscapeLayers"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(LandscapeLayers, UFoliageType), 0x0010040000000001);
				UProperty* NewProp_LandscapeLayers_Inner = new(EC_InternalUseOnlyConstructor, NewProp_LandscapeLayers, TEXT("LandscapeLayers"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
				UProperty* NewProp_Height = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Height"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Height, UFoliageType), 0x0010000000000001, Z_Construct_UScriptStruct_FFloatInterval());
				UProperty* NewProp_GroundSlopeAngle = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("GroundSlopeAngle"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(GroundSlopeAngle, UFoliageType), 0x0010000000000001, Z_Construct_UScriptStruct_FFloatInterval());
				UProperty* NewProp_RandomPitchAngle = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("RandomPitchAngle"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(RandomPitchAngle, UFoliageType), 0x0010000000000001);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(RandomYaw, UFoliageType, uint8);
				UProperty* NewProp_RandomYaw = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("RandomYaw"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(RandomYaw, UFoliageType), 0x0010000000000001, CPP_BOOL_PROPERTY_BITMASK(RandomYaw, UFoliageType), sizeof(uint8), false);
				UProperty* NewProp_AlignMaxAngle = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AlignMaxAngle"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(AlignMaxAngle, UFoliageType), 0x0010000000000001);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(AlignToNormal, UFoliageType, uint8);
				UProperty* NewProp_AlignToNormal = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AlignToNormal"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(AlignToNormal, UFoliageType), 0x0010000000000001, CPP_BOOL_PROPERTY_BITMASK(AlignToNormal, UFoliageType), sizeof(uint8), false);
				UProperty* NewProp_ZOffset = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ZOffset"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ZOffset, UFoliageType), 0x0010000000000001, Z_Construct_UScriptStruct_FFloatInterval());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(VertexColorMaskInvert_DEPRECATED, UFoliageType, uint8);
				UProperty* NewProp_VertexColorMaskInvert = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("VertexColorMaskInvert"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(VertexColorMaskInvert_DEPRECATED, UFoliageType), 0x0010000020000000, CPP_BOOL_PROPERTY_BITMASK(VertexColorMaskInvert_DEPRECATED, UFoliageType), sizeof(uint8), false);
				UProperty* NewProp_VertexColorMaskThreshold = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("VertexColorMaskThreshold"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(VertexColorMaskThreshold_DEPRECATED, UFoliageType), 0x0010000020000000);
				UProperty* NewProp_VertexColorMask = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("VertexColorMask"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(VertexColorMask_DEPRECATED, UFoliageType), 0x0010000020000000, Z_Construct_UEnum_Foliage_FoliageVertexColorMask());
				UProperty* NewProp_VertexColorMaskByChannel = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("VertexColorMaskByChannel"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(VertexColorMaskByChannel, UFoliageType), 0x0010040000000001, Z_Construct_UScriptStruct_FFoliageVertexColorChannelMask());
				NewProp_VertexColorMaskByChannel->ArrayDim = CPP_ARRAY_DIM(VertexColorMaskByChannel, UFoliageType);
				UProperty* NewProp_ScaleZ = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ScaleZ"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ScaleZ, UFoliageType), 0x0010000000000001, Z_Construct_UScriptStruct_FFloatInterval());
				UProperty* NewProp_ScaleY = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ScaleY"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ScaleY, UFoliageType), 0x0010000000000001, Z_Construct_UScriptStruct_FFloatInterval());
				UProperty* NewProp_ScaleX = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ScaleX"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ScaleX, UFoliageType), 0x0010000000000001, Z_Construct_UScriptStruct_FFloatInterval());
				UProperty* NewProp_Scaling = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Scaling"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(Scaling, UFoliageType), 0x0010000000000001, Z_Construct_UEnum_Foliage_EFoliageScaling());
				...
				UProperty* NewProp_Radius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Radius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Radius, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_DensityAdjustmentFactor = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DensityAdjustmentFactor"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(DensityAdjustmentFactor, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_Density = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Density"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Density, UFoliageType), 0x0010000000000001);
				UProperty* NewProp_UpdateGuid = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("UpdateGuid"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(UpdateGuid, UFoliageType), 0x0010000000000000, Z_Construct_UScriptStruct_FGuid());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UFoliageType> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				...
				MetaData->SetValue(NewProp_bEnableDensityScaling, TEXT("Category"), TEXT("Scalability"));
				MetaData->SetValue(NewProp_bEnableDensityScaling, TEXT("ModuleRelativePath"), TEXT("Public/FoliageType.h"));
				MetaData->SetValue(NewProp_bEnableDensityScaling, TEXT("ToolTip"), TEXT("Whether this foliage type should be affected by the Engine Scalability system's Foliage scalability setting.\nEnable for detail meshes that don't really affect the game. Disable for anything important.\nTypically, this will be enabled for small meshes without collision (e.g. grass) and disabled for large meshes with collision (e.g. trees)"));
				...
				MetaData->SetValue(NewProp_CustomDepthStencilValue, TEXT("Category"), TEXT("InstanceSettings"));
				...
				MetaData->SetValue(NewProp_CustomDepthStencilValue, TEXT("ModuleRelativePath"), TEXT("Public/FoliageType.h"));
				...
				MetaData->SetValue(NewProp_bRenderCustomDepth, TEXT("Category"), TEXT("InstanceSettings"));
				MetaData->SetValue(NewProp_bRenderCustomDepth, TEXT("DisplayName"), TEXT("Render CustomDepth Pass"));
				MetaData->SetValue(NewProp_bRenderCustomDepth, TEXT("ModuleRelativePath"), TEXT("Public/FoliageType.h"));
				MetaData->SetValue(NewProp_bRenderCustomDepth, TEXT("ToolTip"), TEXT("If true, the foliage will be rendered in the CustomDepth pass (usually used for outlines)"));
				MetaData->SetValue(NewProp_LightingChannels, TEXT("Category"), TEXT("InstanceSettings"));
				MetaData->SetValue(NewProp_LightingChannels, TEXT("ModuleRelativePath"), TEXT("Public/FoliageType.h"));
				MetaData->SetValue(NewProp_LightingChannels, TEXT("ToolTip"), TEXT("Lighting channels that placed foliage will be assigned. Lights with matching channels will affect the foliage.\nThese channels only apply to opaque materials, direct lighting, and dynamic lighting and shadowing."));
				...
				MetaData->SetValue(NewProp_bOverrideLightMapRes, TEXT("InlineEditConditionToggle"), TEXT(""));
				...
				MetaData->SetValue(NewProp_VertexColorMaskByChannel, TEXT("ArraySizeEnum"), TEXT("/Script/Foliage.EVertexColorMaskChannel"));
				MetaData->SetValue(NewProp_VertexColorMaskByChannel, TEXT("Category"), TEXT("Painting"));
				MetaData->SetValue(NewProp_VertexColorMaskByChannel, TEXT("HideBehind"), TEXT("VertexColorMask"));
				MetaData->SetValue(NewProp_VertexColorMaskByChannel, TEXT("ModuleRelativePath"), TEXT("Public/FoliageType.h"));
	...
	IMPLEMENT_CLASS(UFoliageType, 2121537698);
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_ComponentClass = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ComponentClass"), RF_Public|RF_Transient|RF_MarkAsNative) UClassProperty(CPP_PROPERTY_BASE(ComponentClass, UFoliageType_InstancedStaticMesh), 0x0014000000000001, Z_Construct_UClass_UFoliageInstancedStaticMeshComponent_NoRegister(), UClass::StaticClass());
				UProperty* NewProp_OverrideMaterials = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OverrideMaterials"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(OverrideMaterials, UFoliageType_InstancedStaticMesh), 0x0010040000000001);
				UProperty* NewProp_OverrideMaterials_Inner = new(EC_InternalUseOnlyConstructor, NewProp_OverrideMaterials, TEXT("OverrideMaterials"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UClass_UMaterialInterface_NoRegister());
				UProperty* NewProp_Mesh = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Mesh"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(Mesh, UFoliageType_InstancedStaticMesh), 0x0010000000000001, Z_Construct_UClass_UStaticMesh_NoRegister());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UFoliageType_InstancedStaticMesh> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UFoliageType_InstancedStaticMesh, 1543485429);
	...
	UClass* Z_Construct_UClass_AInstancedFoliageActor()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<AInstancedFoliageActor> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(AInstancedFoliageActor, 2677811240);
	...
	UFunction* Z_Construct_UFunction_AInteractiveFoliageActor_CapsuleTouched()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("CapsuleTouched"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x00480401, 65535, sizeof(InteractiveFoliageActor_eventCapsuleTouched_Parms));
			UProperty* NewProp_OverlapInfo = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("OverlapInfo"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(OverlapInfo, InteractiveFoliageActor_eventCapsuleTouched_Parms), 0x0010008008000182, Z_Construct_UScriptStruct_FHitResult());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bFromSweep, InteractiveFoliageActor_eventCapsuleTouched_Parms, bool);
			UProperty* NewProp_bFromSweep = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bFromSweep"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bFromSweep, InteractiveFoliageActor_eventCapsuleTouched_Parms), 0x0010000000000080, CPP_BOOL_PROPERTY_BITMASK(bFromSweep, InteractiveFoliageActor_eventCapsuleTouched_Parms), sizeof(bool), true);
			UProperty* NewProp_OtherBodyIndex = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("OtherBodyIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(OtherBodyIndex, InteractiveFoliageActor_eventCapsuleTouched_Parms), 0x0010000000000080);
			UProperty* NewProp_OtherComp = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("OtherComp"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(OtherComp, InteractiveFoliageActor_eventCapsuleTouched_Parms), 0x0010000000080080, Z_Construct_UClass_UPrimitiveComponent_NoRegister());
			UProperty* NewProp_Other = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Other"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(Other, InteractiveFoliageActor_eventCapsuleTouched_Parms), 0x0010000000000080, Z_Construct_UClass_AActor_NoRegister());
			UProperty* NewProp_OverlappedComp = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("OverlappedComp"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(OverlappedComp, InteractiveFoliageActor_eventCapsuleTouched_Parms), 0x0010000000080080, Z_Construct_UClass_UPrimitiveComponent_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			...
			MetaData->SetValue(NewProp_OverlapInfo, TEXT("NativeConst"), TEXT(""));
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_Mass = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Mass"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Mass, AInteractiveFoliageActor), 0x0010000000000000);
				UProperty* NewProp_MaxForce = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxForce"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxForce, AInteractiveFoliageActor), 0x0010000000000005);
				UProperty* NewProp_MaxTouchImpulse = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxTouchImpulse"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxTouchImpulse, AInteractiveFoliageActor), 0x0010000000000005);
				UProperty* NewProp_MaxDamageImpulse = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxDamageImpulse"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxDamageImpulse, AInteractiveFoliageActor), 0x0010000000000005);
				UProperty* NewProp_FoliageDamping = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FoliageDamping"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(FoliageDamping, AInteractiveFoliageActor), 0x0010000000000005);
				UProperty* NewProp_FoliageStiffnessQuadratic = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FoliageStiffnessQuadratic"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(FoliageStiffnessQuadratic, AInteractiveFoliageActor), 0x0010000000000005);
				UProperty* NewProp_FoliageStiffness = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FoliageStiffness"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(FoliageStiffness, AInteractiveFoliageActor), 0x0010000000000005);
				UProperty* NewProp_FoliageTouchImpulseScale = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FoliageTouchImpulseScale"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(FoliageTouchImpulseScale, AInteractiveFoliageActor), 0x0010000000000005);
				UProperty* NewProp_FoliageDamageImpulseScale = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FoliageDamageImpulseScale"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(FoliageDamageImpulseScale, AInteractiveFoliageActor), 0x0010000000000005);
				UProperty* NewProp_FoliagePosition = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FoliagePosition"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(FoliagePosition, AInteractiveFoliageActor), 0x0040000000002000, Z_Construct_UScriptStruct_FVector());
				UProperty* NewProp_FoliageForce = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FoliageForce"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(FoliageForce, AInteractiveFoliageActor), 0x0040000000002000, Z_Construct_UScriptStruct_FVector());
				UProperty* NewProp_FoliageVelocity = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FoliageVelocity"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(FoliageVelocity, AInteractiveFoliageActor), 0x0040000000002000, Z_Construct_UScriptStruct_FVector());
				UProperty* NewProp_TouchingActorEntryPosition = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("TouchingActorEntryPosition"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(TouchingActorEntryPosition, AInteractiveFoliageActor), 0x0040000000002000, Z_Construct_UScriptStruct_FVector());
				UProperty* NewProp_CapsuleComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CapsuleComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(CapsuleComponent, AInteractiveFoliageActor), 0x0040000000080008, Z_Construct_UClass_UCapsuleComponent_NoRegister());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AInteractiveFoliageActor_CapsuleTouched(), "CapsuleTouched"); // 1252447411
				static TCppClassTypeInfo<TCppClassTypeTraits<AInteractiveFoliageActor> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(AInteractiveFoliageActor, 2842833293);
	...
	UClass* Z_Construct_UClass_UInteractiveFoliageComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UInteractiveFoliageComponent> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("HideCategories"), TEXT("Object Object Activation Components|Activation Trigger"));
	...
	IMPLEMENT_CLASS(UInteractiveFoliageComponent, 3021653214);
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_ProceduralFoliageVolume = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ProceduralFoliageVolume"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(ProceduralFoliageVolume, AProceduralFoliageBlockingVolume), 0x0010000000000001, Z_Construct_UClass_AProceduralFoliageVolume_NoRegister());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<AProceduralFoliageBlockingVolume> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(AProceduralFoliageBlockingVolume, 2047568715);
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_ProceduralGuid = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ProceduralGuid"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ProceduralGuid, UProceduralFoliageComponent), 0x0040000000000000, Z_Construct_UScriptStruct_FGuid());
				UProperty* NewProp_SpawningVolume = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SpawningVolume"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(SpawningVolume, UProceduralFoliageComponent), 0x0040000000000000, Z_Construct_UClass_AVolume_NoRegister());
#if WITH_EDITORONLY_DATA
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bShowDebugTiles, UProceduralFoliageComponent, bool);
				UProperty* NewProp_bShowDebugTiles = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bShowDebugTiles"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bShowDebugTiles, UProceduralFoliageComponent), 0x0010000800000005, CPP_BOOL_PROPERTY_BITMASK(bShowDebugTiles, UProceduralFoliageComponent), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAllowFoliage, UProceduralFoliageComponent, bool);
				UProperty* NewProp_bAllowFoliage = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bAllowFoliage"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAllowFoliage, UProceduralFoliageComponent), 0x0010000800000005, CPP_BOOL_PROPERTY_BITMASK(bAllowFoliage, UProceduralFoliageComponent), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAllowTranslucent, UProceduralFoliageComponent, bool);
				UProperty* NewProp_bAllowTranslucent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bAllowTranslucent"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAllowTranslucent, UProceduralFoliageComponent), 0x0010000800000005, CPP_BOOL_PROPERTY_BITMASK(bAllowTranslucent, UProceduralFoliageComponent), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAllowStaticMesh, UProceduralFoliageComponent, bool);
				UProperty* NewProp_bAllowStaticMesh = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bAllowStaticMesh"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAllowStaticMesh, UProceduralFoliageComponent), 0x0010000800000005, CPP_BOOL_PROPERTY_BITMASK(bAllowStaticMesh, UProceduralFoliageComponent), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAllowBSP, UProceduralFoliageComponent, bool);
				UProperty* NewProp_bAllowBSP = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bAllowBSP"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAllowBSP, UProceduralFoliageComponent), 0x0010000800000005, CPP_BOOL_PROPERTY_BITMASK(bAllowBSP, UProceduralFoliageComponent), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAllowLandscape, UProceduralFoliageComponent, bool);
				UProperty* NewProp_bAllowLandscape = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bAllowLandscape"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAllowLandscape, UProceduralFoliageComponent), 0x0010000800000005, CPP_BOOL_PROPERTY_BITMASK(bAllowLandscape, UProceduralFoliageComponent), sizeof(bool), true);
#endif // WITH_EDITORONLY_DATA
				UProperty* NewProp_TileOverlap = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("TileOverlap"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(TileOverlap, UProceduralFoliageComponent), 0x0010000000000005);
				UProperty* NewProp_FoliageSpawner = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FoliageSpawner"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(FoliageSpawner, UProceduralFoliageComponent), 0x0010000000000005, Z_Construct_UClass_UProceduralFoliageSpawner_NoRegister());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UProceduralFoliageComponent> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				...
				MetaData->SetValue(NewProp_bAllowFoliage, TEXT("Category"), TEXT("ProceduralFoliage"));
				MetaData->SetValue(NewProp_bAllowFoliage, TEXT("ModuleRelativePath"), TEXT("Public/ProceduralFoliageComponent.h"));
				MetaData->SetValue(NewProp_bAllowFoliage, TEXT("ToolTip"), TEXT("Whether to place foliage on other blocking foliage geometry"));
				MetaData->SetValue(NewProp_bAllowTranslucent, TEXT("Category"), TEXT("ProceduralFoliage"));
				MetaData->SetValue(NewProp_bAllowTranslucent, TEXT("ModuleRelativePath"), TEXT("Public/ProceduralFoliageComponent.h"));
				MetaData->SetValue(NewProp_bAllowTranslucent, TEXT("ToolTip"), TEXT("Whether to place foliage on translucent geometry"));
				MetaData->SetValue(NewProp_bAllowStaticMesh, TEXT("Category"), TEXT("ProceduralFoliage"));
				MetaData->SetValue(NewProp_bAllowStaticMesh, TEXT("ModuleRelativePath"), TEXT("Public/ProceduralFoliageComponent.h"));
				MetaData->SetValue(NewProp_bAllowStaticMesh, TEXT("ToolTip"), TEXT("Whether to place foliage on StaticMesh"));
				MetaData->SetValue(NewProp_bAllowBSP, TEXT("Category"), TEXT("ProceduralFoliage"));
				MetaData->SetValue(NewProp_bAllowBSP, TEXT("ModuleRelativePath"), TEXT("Public/ProceduralFoliageComponent.h"));
				MetaData->SetValue(NewProp_bAllowBSP, TEXT("ToolTip"), TEXT("Whether to place foliage on BSP"));
				MetaData->SetValue(NewProp_bAllowLandscape, TEXT("Category"), TEXT("ProceduralFoliage"));
				MetaData->SetValue(NewProp_bAllowLandscape, TEXT("ModuleRelativePath"), TEXT("Public/ProceduralFoliageComponent.h"));
				MetaData->SetValue(NewProp_bAllowLandscape, TEXT("ToolTip"), TEXT("Whether to place foliage on landscape"));
	...
	IMPLEMENT_CLASS(UProceduralFoliageComponent, 4005667923);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESimulationQuery(ESimulationQuery_StaticEnum, TEXT("/Script/Foliage"), TEXT("ESimulationQuery"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_Foliage_ESimulationQuery()
	{
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ESimulationQuery"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESimulationQuery::CollisionOverlap"), 1);
			EnumNames.Emplace(TEXT("ESimulationQuery::ShadeOverlap"), 2);
			EnumNames.Emplace(TEXT("ESimulationQuery::AnyOverlap"), 3);
			EnumNames.Emplace(TEXT("ESimulationQuery::ESimulationQuery_MAX"), 4);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
			ReturnEnum->CppType = TEXT("ESimulationQuery::Type");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
	...
	uint32 Get_Z_Construct_UEnum_Foliage_ESimulationQuery_CRC() { return 4222930376U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESimulationOverlap(ESimulationOverlap_StaticEnum, TEXT("/Script/Foliage"), TEXT("ESimulationOverlap"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_Foliage_ESimulationOverlap()
	{
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ESimulationOverlap"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESimulationOverlap::CollisionOverlap"), 0);
			EnumNames.Emplace(TEXT("ESimulationOverlap::ShadeOverlap"), 1);
			EnumNames.Emplace(TEXT("ESimulationOverlap::None"), 2);
			EnumNames.Emplace(TEXT("ESimulationOverlap::ESimulationOverlap_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
			ReturnEnum->CppType = TEXT("ESimulationOverlap::Type");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("BlueprintType"), TEXT("true"));
			MetaData->SetValue(ReturnEnum, TEXT("CollisionOverlap.ToolTip"), TEXT("Instances overlap with collision"));
	...
	uint32 Get_Z_Construct_UEnum_Foliage_ESimulationOverlap_CRC() { return 3055798238U; }
...
static struct FScriptStruct_Foliage_StaticRegisterNativesFProceduralFoliageInstance
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FProceduralFoliageInstance()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ProceduralFoliageInstance"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FProceduralFoliageInstance>, EStructFlags(0x00000201));
			UProperty* NewProp_Type = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Type"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(Type, FProceduralFoliageInstance), 0x0010000000000000, Z_Construct_UClass_UFoliageType_InstancedStaticMesh_NoRegister());
			UProperty* NewProp_Scale = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Scale"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Scale, FProceduralFoliageInstance), 0x0010000000000000);
			UProperty* NewProp_Age = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Age"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Age, FProceduralFoliageInstance), 0x0010000000000005);
			UProperty* NewProp_Normal = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Normal"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Normal, FProceduralFoliageInstance), 0x0010000000000005, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_Rotation = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Rotation"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Rotation, FProceduralFoliageInstance), 0x0010000000000000, Z_Construct_UScriptStruct_FQuat());
			UProperty* NewProp_Location = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Location"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Location, FProceduralFoliageInstance), 0x0010000000000005, Z_Construct_UScriptStruct_FVector());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
	...
	uint32 Get_Z_Construct_UScriptStruct_FProceduralFoliageInstance_CRC() { return 3318375256U; }
...
static struct FScriptStruct_Foliage_StaticRegisterNativesFFoliageTypeObject
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FFoliageTypeObject()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FoliageTypeObject"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FFoliageTypeObject>, EStructFlags(0x00000201));
			UProperty* NewProp_Type = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Type"), RF_Public|RF_Transient|RF_MarkAsNative) UClassProperty(CPP_PROPERTY_BASE(Type_DEPRECATED, FFoliageTypeObject), 0x0044000020000000, Z_Construct_UClass_UFoliageType_InstancedStaticMesh_NoRegister(), UClass::StaticClass());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bIsAsset, FFoliageTypeObject, bool);
			UProperty* NewProp_bIsAsset = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bIsAsset"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bIsAsset, FFoliageTypeObject), 0x0040000000000000, CPP_BOOL_PROPERTY_BITMASK(bIsAsset, FFoliageTypeObject), sizeof(bool), true);
			UProperty* NewProp_TypeInstance = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TypeInstance"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(TypeInstance, FFoliageTypeObject), 0x0040000000002000, Z_Construct_UClass_UFoliageType_InstancedStaticMesh_NoRegister());
			UProperty* NewProp_FoliageTypeObject = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("FoliageTypeObject"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(FoliageTypeObject, FFoliageTypeObject), 0x0040000000000001, Z_Construct_UClass_UObject_NoRegister());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
	...
	uint32 Get_Z_Construct_UScriptStruct_FFoliageTypeObject_CRC() { return 1802354670U; }
	...
	UFunction* Z_Construct_UFunction_UProceduralFoliageSpawner_Simulate()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("Simulate"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(ProceduralFoliageSpawner_eventSimulate_Parms));
			UProperty* NewProp_NumSteps = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("NumSteps"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(NumSteps, ProceduralFoliageSpawner_eventSimulate_Parms), 0x0010000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				...
				UProperty* NewProp_bNeedsSimulation = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bNeedsSimulation"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bNeedsSimulation, UProceduralFoliageSpawner), 0x0040000000000000, CPP_BOOL_PROPERTY_BITMASK(bNeedsSimulation, UProceduralFoliageSpawner), sizeof(bool), true);
				UProperty* NewProp_FoliageTypes = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FoliageTypes"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(FoliageTypes, UProceduralFoliageSpawner), 0x0040000000000001);
				UProperty* NewProp_FoliageTypes_Inner = new(EC_InternalUseOnlyConstructor, NewProp_FoliageTypes, TEXT("FoliageTypes"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FFoliageTypeObject());
				UProperty* NewProp_MinimumQuadTreeSize = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MinimumQuadTreeSize"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MinimumQuadTreeSize, UProceduralFoliageSpawner), 0x0010000000000015);
				UProperty* NewProp_NumUniqueTiles = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("NumUniqueTiles"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(NumUniqueTiles, UProceduralFoliageSpawner), 0x0010000000000015);
				UProperty* NewProp_TileSize = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("TileSize"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(TileSize, UProceduralFoliageSpawner), 0x0010000000000015);
				UProperty* NewProp_RandomSeed = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("RandomSeed"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(RandomSeed, UProceduralFoliageSpawner), 0x0010000000000015);
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UProceduralFoliageSpawner_Simulate(), "Simulate"); // 1916069973
				static TCppClassTypeInfo<TCppClassTypeTraits<UProceduralFoliageSpawner> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				...
				MetaData->SetValue(NewProp_MinimumQuadTreeSize, TEXT("Category"), TEXT("ProceduralFoliageSimulation"));
				MetaData->SetValue(NewProp_MinimumQuadTreeSize, TEXT("ModuleRelativePath"), TEXT("Public/ProceduralFoliageSpawner.h"));
				MetaData->SetValue(NewProp_MinimumQuadTreeSize, TEXT("ToolTip"), TEXT("Minimum size of the quad tree used during the simulation. Reduce if too many instances are in splittable leaf quads (as warned in the log)."));
	...
	IMPLEMENT_CLASS(UProceduralFoliageSpawner, 3477530995);
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_InstancesArray = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("InstancesArray"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(InstancesArray, UProceduralFoliageTile), 0x0040000000000000);
				UProperty* NewProp_InstancesArray_Inner = new(EC_InternalUseOnlyConstructor, NewProp_InstancesArray, TEXT("InstancesArray"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FProceduralFoliageInstance());
				UProperty* NewProp_FoliageSpawner = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FoliageSpawner"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(FoliageSpawner, UProceduralFoliageTile), 0x0040000000000000, Z_Construct_UClass_UProceduralFoliageSpawner_NoRegister());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UProceduralFoliageTile> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				...
				MetaData->SetValue(NewProp_FoliageSpawner, TEXT("NativeConst"), TEXT(""));
#endif
			}
		}
		check(OuterClass->GetClass());
	...
	IMPLEMENT_CLASS(UProceduralFoliageTile, 2617694544);
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_ProceduralComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ProceduralComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(ProceduralComponent, AProceduralFoliageVolume), 0x00100000000a001d, Z_Construct_UClass_UProceduralFoliageComponent_NoRegister());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<AProceduralFoliageVolume> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(AProceduralFoliageVolume, 511572793);
	...
	UPackage* Z_Construct_UPackage__Script_Foliage()
	{
		...
		if (!ReturnPackage)
		{
			ReturnPackage = CastChecked<UPackage>(StaticFindObjectFast(UPackage::StaticClass(), nullptr, FName(TEXT("/Script/Foliage")), false, false));
