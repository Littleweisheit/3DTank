...
// Cross Module References
	...
	SLATECORE_API class UEnum* Z_Construct_UEnum_SlateCore_EFontLayoutMethod();
	...
	SLATECORE_API class UEnum* Z_Construct_UEnum_SlateCore_ENavigationGenesis();
	...
	UClass* Z_Construct_UClass_UFontBulkData()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UFontBulkData> > StaticCppClassTypeInfo;
	...
	IMPLEMENT_CLASS(UFontBulkData, 2581089807);
...
static UEnum* EFontLayoutMethod_StaticEnum()
{
	...
	if (!Singleton)
	{
		extern SLATECORE_API class UEnum* Z_Construct_UEnum_SlateCore_EFontLayoutMethod();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFontLayoutMethod(EFontLayoutMethod_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EFontLayoutMethod"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EFontLayoutMethod()
	{
		...
		extern uint32 Get_Z_Construct_UEnum_SlateCore_EFontLayoutMethod_CRC();
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EFontLayoutMethod"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EFontLayoutMethod::Metrics"), 0);
			EnumNames.Emplace(TEXT("EFontLayoutMethod::BoundingBox"), 1);
			EnumNames.Emplace(TEXT("EFontLayoutMethod::EFontLayoutMethod_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("EFontLayoutMethod");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("BoundingBox.ToolTip"), TEXT("Layout the font using the values from its bounding box. This typically yields a larger line height for fonts that have valid metrics, however it can also produce much better results for fonts that have broken or incorrect metrics."));
			MetaData->SetValue(ReturnEnum, TEXT("Metrics.ToolTip"), TEXT("Layout the font using the metrics data available in the font. This is typically the desired option, however some fonts have broken or incorrect metrics so may yield better results when using the bounding box values to layout the font."));
			MetaData->SetValue(ReturnEnum, TEXT("ModuleRelativePath"), TEXT("Public/Fonts/CompositeFont.h"));
#endif
		}
		return ReturnEnum;
	}
	uint32 Get_Z_Construct_UEnum_SlateCore_EFontLayoutMethod_CRC() { return 795650634U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFontLoadingPolicy(EFontLoadingPolicy_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EFontLoadingPolicy"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EFontLoadingPolicy()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EFontLoadingPolicy::LazyLoad"), 0);
			EnumNames.Emplace(TEXT("EFontLoadingPolicy::Stream"), 1);
			EnumNames.Emplace(TEXT("EFontLoadingPolicy::Inline"), 2);
			EnumNames.Emplace(TEXT("EFontLoadingPolicy::EFontLoadingPolicy_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EFontLoadingPolicy_CRC() { return 1130752627U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFontHinting(EFontHinting_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EFontHinting"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EFontHinting()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EFontHinting::Default"), 0);
			EnumNames.Emplace(TEXT("EFontHinting::Auto"), 1);
			EnumNames.Emplace(TEXT("EFontHinting::AutoLight"), 2);
			EnumNames.Emplace(TEXT("EFontHinting::Monochrome"), 3);
			EnumNames.Emplace(TEXT("EFontHinting::None"), 4);
			EnumNames.Emplace(TEXT("EFontHinting::EFontHinting_MAX"), 5);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EFontHinting_CRC() { return 700161108U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFFontData
{
	...
	UClass* Z_Construct_UClass_UFontFaceInterface()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<IFontFaceInterface> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UFontFaceInterface, 2985493141);
	...
	UClass* Z_Construct_UClass_UFontProviderInterface()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<IFontProviderInterface> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UFontProviderInterface, 2174016790);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESlateColorStylingMode(ESlateColorStylingMode_StaticEnum, TEXT("/Script/SlateCore"), TEXT("ESlateColorStylingMode"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_ESlateColorStylingMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESlateColorStylingMode::UseColor_Specified"), 0);
			EnumNames.Emplace(TEXT("ESlateColorStylingMode::UseColor_Specified_Link"), 1);
			EnumNames.Emplace(TEXT("ESlateColorStylingMode::UseColor_Foreground"), 2);
			EnumNames.Emplace(TEXT("ESlateColorStylingMode::UseColor_Foreground_Subdued"), 3);
			EnumNames.Emplace(TEXT("ESlateColorStylingMode::UseColor_MAX"), 4);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_ESlateColorStylingMode_CRC() { return 480997637U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFontFallback(EFontFallback_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EFontFallback"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EFontFallback()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EFontFallback::FF_NoFallback"), 0);
			EnumNames.Emplace(TEXT("EFontFallback::FF_LocalizedFallback"), 1);
			EnumNames.Emplace(TEXT("EFontFallback::FF_LastResortFallback"), 2);
			EnumNames.Emplace(TEXT("EFontFallback::FF_Max"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EFontFallback_CRC() { return 2113663376U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFSlateFontInfo
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSlateFontInfo()
	{
		...
		if (!ReturnStruct)
		{
			...
			MetaData->SetValue(NewProp_Size, TEXT("ToolTip"), TEXT("The font size is a measure in point values.  The conversion of points to Slate Units is done at 96 dpi.  So if\nyou're using a tool like Photoshop to prototype layouts and UI mock ups, be sure to change the default dpi\nmeasurements from 72 dpi to 96 dpi."));
	...
	uint32 Get_Z_Construct_UScriptStruct_FSlateFontInfo_CRC() { return 3441639674U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESelectInfo(ESelectInfo_StaticEnum, TEXT("/Script/SlateCore"), TEXT("ESelectInfo"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_ESelectInfo()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESelectInfo::OnKeyPress"), 0);
			EnumNames.Emplace(TEXT("ESelectInfo::OnNavigation"), 1);
			EnumNames.Emplace(TEXT("ESelectInfo::OnMouseClick"), 2);
			EnumNames.Emplace(TEXT("ESelectInfo::Direct"), 3);
			EnumNames.Emplace(TEXT("ESelectInfo::ESelectInfo_MAX"), 4);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_ESelectInfo_CRC() { return 2144981201U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ETextCommit(ETextCommit_StaticEnum, TEXT("/Script/SlateCore"), TEXT("ETextCommit"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_ETextCommit()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ETextCommit::Default"), 0);
			EnumNames.Emplace(TEXT("ETextCommit::OnEnter"), 1);
			EnumNames.Emplace(TEXT("ETextCommit::OnUserMovedFocus"), 2);
			EnumNames.Emplace(TEXT("ETextCommit::OnCleared"), 3);
			EnumNames.Emplace(TEXT("ETextCommit::ETextCommit_MAX"), 4);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_ETextCommit_CRC() { return 771818492U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EScrollDirection(EScrollDirection_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EScrollDirection"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EScrollDirection()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("Scroll_Down"), 0);
			EnumNames.Emplace(TEXT("Scroll_Up"), 1);
			EnumNames.Emplace(TEXT("Scroll_MAX"), 2);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EScrollDirection_CRC() { return 457469652U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EOrientation(EOrientation_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EOrientation"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EOrientation()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("Orient_Horizontal"), 0);
			EnumNames.Emplace(TEXT("Orient_Vertical"), 1);
			EnumNames.Emplace(TEXT("Orient_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Regular);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EOrientation_CRC() { return 2540559382U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EMenuPlacement(EMenuPlacement_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EMenuPlacement"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EMenuPlacement()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("MenuPlacement_BelowAnchor"), 0);
			EnumNames.Emplace(TEXT("MenuPlacement_CenteredBelowAnchor"), 1);
			EnumNames.Emplace(TEXT("MenuPlacement_BelowRightAnchor"), 2);
			EnumNames.Emplace(TEXT("MenuPlacement_ComboBox"), 3);
			EnumNames.Emplace(TEXT("MenuPlacement_ComboBoxRight"), 4);
			EnumNames.Emplace(TEXT("MenuPlacement_MenuRight"), 5);
			EnumNames.Emplace(TEXT("MenuPlacement_AboveAnchor"), 6);
			EnumNames.Emplace(TEXT("MenuPlacement_CenteredAboveAnchor"), 7);
			EnumNames.Emplace(TEXT("MenuPlacement_AboveRightAnchor"), 8);
			EnumNames.Emplace(TEXT("MenuPlacement_MenuLeft"), 9);
			EnumNames.Emplace(TEXT("MenuPlacement_Center"), 10);
			EnumNames.Emplace(TEXT("MenuPlacement_RightLeftCenter"), 11);
			EnumNames.Emplace(TEXT("MenuPlacement_MAX"), 12);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Regular);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EMenuPlacement_CRC() { return 2749946741U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EVerticalAlignment(EVerticalAlignment_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EVerticalAlignment"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EVerticalAlignment()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("VAlign_Fill"), 0);
			EnumNames.Emplace(TEXT("VAlign_Top"), 1);
			EnumNames.Emplace(TEXT("VAlign_Center"), 2);
			EnumNames.Emplace(TEXT("VAlign_Bottom"), 3);
			EnumNames.Emplace(TEXT("VAlign_MAX"), 4);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Regular);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EVerticalAlignment_CRC() { return 1612855571U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EHorizontalAlignment(EHorizontalAlignment_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EHorizontalAlignment"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EHorizontalAlignment()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("HAlign_Fill"), 0);
			EnumNames.Emplace(TEXT("HAlign_Left"), 1);
			EnumNames.Emplace(TEXT("HAlign_Center"), 2);
			EnumNames.Emplace(TEXT("HAlign_Right"), 3);
			EnumNames.Emplace(TEXT("HAlign_MAX"), 4);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Regular);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EHorizontalAlignment_CRC() { return 2961875669U; }
static UEnum* ENavigationGenesis_StaticEnum()
{
	...
	if (!Singleton)
	{
		extern SLATECORE_API class UEnum* Z_Construct_UEnum_SlateCore_ENavigationGenesis();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ENavigationGenesis(ENavigationGenesis_StaticEnum, TEXT("/Script/SlateCore"), TEXT("ENavigationGenesis"), false, nullptr, nullptr);
	...
	{
		UPackage* Outer=Z_Construct_UPackage__Script_SlateCore();
		extern uint32 Get_Z_Construct_UEnum_SlateCore_ENavigationGenesis_CRC();
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ENavigationGenesis"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ENavigationGenesis::Keyboard"), 0);
			EnumNames.Emplace(TEXT("ENavigationGenesis::Controller"), 1);
			EnumNames.Emplace(TEXT("ENavigationGenesis::User"), 2);
			EnumNames.Emplace(TEXT("ENavigationGenesis::ENavigationGenesis_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("ENavigationGenesis");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("Controller.ToolTip"), TEXT("Navigation caused by a Controller"));
			MetaData->SetValue(ReturnEnum, TEXT("Keyboard.ToolTip"), TEXT("Navigation caused by the Keyboard"));
			MetaData->SetValue(ReturnEnum, TEXT("ModuleRelativePath"), TEXT("Public/Types/SlateEnums.h"));
			MetaData->SetValue(ReturnEnum, TEXT("ToolTip"), TEXT("Enumerates the genesis of the navigation, where generated the navigation"));
			MetaData->SetValue(ReturnEnum, TEXT("User.ToolTip"), TEXT("Navigate caused by a user generated event (Users = WIdgets, Client Code, ...)"));
#endif
		}
		return ReturnEnum;
	}
	uint32 Get_Z_Construct_UEnum_SlateCore_ENavigationGenesis_CRC() { return 4291444698U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ENavigationSource(ENavigationSource_StaticEnum, TEXT("/Script/SlateCore"), TEXT("ENavigationSource"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_ENavigationSource()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ENavigationSource::FocusedWidget"), 0);
			EnumNames.Emplace(TEXT("ENavigationSource::WidgetUnderCursor"), 1);
			EnumNames.Emplace(TEXT("ENavigationSource::ENavigationSource_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			...
			MetaData->SetValue(ReturnEnum, TEXT("ModuleRelativePath"), TEXT("Public/Types/SlateEnums.h"));
			MetaData->SetValue(ReturnEnum, TEXT("ToolTip"), TEXT("Enumerates the source of the navigation"));
			MetaData->SetValue(ReturnEnum, TEXT("WidgetUnderCursor.ToolTip"), TEXT("Navigate from the widget under the cursor"));
#endif
		}
		return ReturnEnum;
	}
	uint32 Get_Z_Construct_UEnum_SlateCore_ENavigationSource_CRC() { return 3449552645U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EUINavigation(EUINavigation_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EUINavigation"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EUINavigation()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EUINavigation::Left"), 0);
			EnumNames.Emplace(TEXT("EUINavigation::Right"), 1);
			EnumNames.Emplace(TEXT("EUINavigation::Up"), 2);
			EnumNames.Emplace(TEXT("EUINavigation::Down"), 3);
			EnumNames.Emplace(TEXT("EUINavigation::Next"), 4);
			EnumNames.Emplace(TEXT("EUINavigation::Previous"), 5);
			EnumNames.Emplace(TEXT("EUINavigation::Num"), 6);
			EnumNames.Emplace(TEXT("EUINavigation::Invalid"), 7);
			EnumNames.Emplace(TEXT("EUINavigation::EUINavigation_MAX"), 8);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("EUINavigation");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("BlueprintType"), TEXT("true"));
			MetaData->SetValue(ReturnEnum, TEXT("Invalid.Hidden"), TEXT(""));
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EUINavigation_CRC() { return 2843388900U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EButtonPressMethod(EButtonPressMethod_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EButtonPressMethod"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EButtonPressMethod()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EButtonPressMethod::DownAndUp"), 0);
			EnumNames.Emplace(TEXT("EButtonPressMethod::ButtonPress"), 1);
			EnumNames.Emplace(TEXT("EButtonPressMethod::ButtonRelease"), 2);
			EnumNames.Emplace(TEXT("EButtonPressMethod::EButtonPressMethod_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EButtonPressMethod_CRC() { return 2754260746U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EButtonTouchMethod(EButtonTouchMethod_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EButtonTouchMethod"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EButtonTouchMethod()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EButtonTouchMethod::DownAndUp"), 0);
			EnumNames.Emplace(TEXT("EButtonTouchMethod::PreciseTap"), 1);
			EnumNames.Emplace(TEXT("EButtonTouchMethod::EButtonTouchMethod_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EButtonTouchMethod_CRC() { return 1870334221U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EButtonClickMethod(EButtonClickMethod_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EButtonClickMethod"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EButtonClickMethod()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EButtonClickMethod::DownAndUp"), 0);
			EnumNames.Emplace(TEXT("EButtonClickMethod::MouseDown"), 1);
			EnumNames.Emplace(TEXT("EButtonClickMethod::MouseUp"), 2);
			EnumNames.Emplace(TEXT("EButtonClickMethod::PreciseClick"), 3);
			EnumNames.Emplace(TEXT("EButtonClickMethod::EButtonClickMethod_MAX"), 4);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EButtonClickMethod_CRC() { return 1487978558U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESlateBrushImageType(ESlateBrushImageType_StaticEnum, TEXT("/Script/SlateCore"), TEXT("ESlateBrushImageType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_ESlateBrushImageType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESlateBrushImageType::NoImage"), 0);
			EnumNames.Emplace(TEXT("ESlateBrushImageType::FullColor"), 1);
			EnumNames.Emplace(TEXT("ESlateBrushImageType::Linear"), 2);
			EnumNames.Emplace(TEXT("ESlateBrushImageType::ESlateBrushImageType_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_ESlateBrushImageType_CRC() { return 3456331383U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESlateBrushMirrorType(ESlateBrushMirrorType_StaticEnum, TEXT("/Script/SlateCore"), TEXT("ESlateBrushMirrorType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_ESlateBrushMirrorType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESlateBrushMirrorType::NoMirror"), 0);
			EnumNames.Emplace(TEXT("ESlateBrushMirrorType::Horizontal"), 1);
			EnumNames.Emplace(TEXT("ESlateBrushMirrorType::Vertical"), 2);
			EnumNames.Emplace(TEXT("ESlateBrushMirrorType::Both"), 3);
			EnumNames.Emplace(TEXT("ESlateBrushMirrorType::ESlateBrushMirrorType_MAX"), 4);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_ESlateBrushMirrorType_CRC() { return 1736358863U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESlateBrushTileType(ESlateBrushTileType_StaticEnum, TEXT("/Script/SlateCore"), TEXT("ESlateBrushTileType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_ESlateBrushTileType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESlateBrushTileType::NoTile"), 0);
			EnumNames.Emplace(TEXT("ESlateBrushTileType::Horizontal"), 1);
			EnumNames.Emplace(TEXT("ESlateBrushTileType::Vertical"), 2);
			EnumNames.Emplace(TEXT("ESlateBrushTileType::Both"), 3);
			EnumNames.Emplace(TEXT("ESlateBrushTileType::ESlateBrushTileType_MAX"), 4);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_ESlateBrushTileType_CRC() { return 2525458044U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESlateBrushDrawType(ESlateBrushDrawType_StaticEnum, TEXT("/Script/SlateCore"), TEXT("ESlateBrushDrawType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_ESlateBrushDrawType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESlateBrushDrawType::NoDrawType"), 0);
			EnumNames.Emplace(TEXT("ESlateBrushDrawType::Box"), 1);
			EnumNames.Emplace(TEXT("ESlateBrushDrawType::Border"), 2);
			EnumNames.Emplace(TEXT("ESlateBrushDrawType::Image"), 3);
			EnumNames.Emplace(TEXT("ESlateBrushDrawType::ESlateBrushDrawType_MAX"), 4);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_ESlateBrushDrawType_CRC() { return 319602940U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ECheckBoxState(ECheckBoxState_StaticEnum, TEXT("/Script/SlateCore"), TEXT("ECheckBoxState"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_ECheckBoxState()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ECheckBoxState::Unchecked"), 0);
			EnumNames.Emplace(TEXT("ECheckBoxState::Checked"), 1);
			EnumNames.Emplace(TEXT("ECheckBoxState::Undetermined"), 2);
			EnumNames.Emplace(TEXT("ECheckBoxState::ECheckBoxState_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_ECheckBoxState_CRC() { return 1445767112U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESlateCheckBoxType(ESlateCheckBoxType_StaticEnum, TEXT("/Script/SlateCore"), TEXT("ESlateCheckBoxType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_ESlateCheckBoxType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESlateCheckBoxType::CheckBox"), 0);
			EnumNames.Emplace(TEXT("ESlateCheckBoxType::ToggleButton"), 1);
			EnumNames.Emplace(TEXT("ESlateCheckBoxType::ESlateCheckBoxType_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_ESlateCheckBoxType_CRC() { return 842317688U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EConsumeMouseWheel(EConsumeMouseWheel_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EConsumeMouseWheel"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EConsumeMouseWheel()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EConsumeMouseWheel::WhenScrollingPossible"), 0);
			EnumNames.Emplace(TEXT("EConsumeMouseWheel::Always"), 1);
			EnumNames.Emplace(TEXT("EConsumeMouseWheel::Never"), 2);
			EnumNames.Emplace(TEXT("EConsumeMouseWheel::EConsumeMouseWheel_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EConsumeMouseWheel_CRC() { return 1681821929U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFWindowStyle
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FWindowStyle()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_BackgroundColor = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("BackgroundColor"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(BackgroundColor, FWindowStyle), 0x0010000000000005, Z_Construct_UScriptStruct_FSlateColor());
			...
			MetaData->SetValue(NewProp_BackgroundColor, TEXT("ToolTip"), TEXT("Color used to draw the window background"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FWindowStyle_CRC() { return 2670808025U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFCheckBoxStyle
{
	...
	UClass* Z_Construct_UClass_USlateTypes()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<USlateTypes> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(USlateTypes, 1004980630);
	...
	UClass* Z_Construct_UClass_USlateWidgetStyleContainerInterface()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<ISlateWidgetStyleContainerInterface> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(USlateWidgetStyleContainerInterface, 1036283171);
	...
	UClass* Z_Construct_UClass_USlateWidgetStyleContainerBase()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<USlateWidgetStyleContainerBase> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
	...
	IMPLEMENT_CLASS(USlateWidgetStyleContainerBase, 922027893);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<USlateWidgetStyleAsset> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(USlateWidgetStyleAsset, 300408760);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ETextShapingMethod(ETextShapingMethod_StaticEnum, TEXT("/Script/SlateCore"), TEXT("ETextShapingMethod"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_ETextShapingMethod()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ETextShapingMethod::Auto"), 0);
			EnumNames.Emplace(TEXT("ETextShapingMethod::KerningOnly"), 1);
			EnumNames.Emplace(TEXT("ETextShapingMethod::FullShaping"), 2);
			EnumNames.Emplace(TEXT("ETextShapingMethod::ETextShapingMethod_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_ETextShapingMethod_CRC() { return 925522852U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFocusCause(EFocusCause_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EFocusCause"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EFocusCause()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EFocusCause::Mouse"), 0);
			EnumNames.Emplace(TEXT("EFocusCause::Navigation"), 1);
			EnumNames.Emplace(TEXT("EFocusCause::SetDirectly"), 2);
			EnumNames.Emplace(TEXT("EFocusCause::Cleared"), 3);
			EnumNames.Emplace(TEXT("EFocusCause::OtherWidgetLostFocus"), 4);
			EnumNames.Emplace(TEXT("EFocusCause::WindowActivate"), 5);
			EnumNames.Emplace(TEXT("EFocusCause::EFocusCause_MAX"), 6);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EFocusCause_CRC() { return 549832206U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EUINavigationRule(EUINavigationRule_StaticEnum, TEXT("/Script/SlateCore"), TEXT("EUINavigationRule"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_SlateCore_EUINavigationRule()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EUINavigationRule::Escape"), 0);
			EnumNames.Emplace(TEXT("EUINavigationRule::Explicit"), 1);
			EnumNames.Emplace(TEXT("EUINavigationRule::Wrap"), 2);
			EnumNames.Emplace(TEXT("EUINavigationRule::Stop"), 3);
			EnumNames.Emplace(TEXT("EUINavigationRule::Custom"), 4);
			EnumNames.Emplace(TEXT("EUINavigationRule::Invalid"), 5);
			EnumNames.Emplace(TEXT("EUINavigationRule::EUINavigationRule_MAX"), 6);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EUINavigationRule_CRC() { return 4086081643U; }
	UPackage* Z_Construct_UPackage__Script_SlateCore()
	{
		static UPackage* ReturnPackage = nullptr;
		if (!ReturnPackage)
		{
			ReturnPackage = CastChecked<UPackage>(StaticFindObjectFast(UPackage::StaticClass(), nullptr, FName(TEXT("/Script/SlateCore")), false, false));
