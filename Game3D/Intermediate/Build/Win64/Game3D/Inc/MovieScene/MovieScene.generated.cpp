...
// Cross Module References
	...
	MOVIESCENE_API class UEnum* Z_Construct_UEnum_MovieScene_EMovieSceneObjectBindingSpace();
	...
	MOVIESCENE_API class UFunction* Z_Construct_UFunction_UMovieSceneSequencePlayer_GetBoundObjects();
	...
	MOVIESCENE_API class UClass* Z_Construct_UClass_UMovieSceneSegmentCompilerTestTrack_NoRegister();
	MOVIESCENE_API class UClass* Z_Construct_UClass_UMovieSceneSegmentCompilerTestTrack();
	MOVIESCENE_API class UClass* Z_Construct_UClass_UMovieSceneSegmentCompilerTestSection_NoRegister();
	MOVIESCENE_API class UClass* Z_Construct_UClass_UMovieSceneSegmentCompilerTestSection();
	...
	MOVIESCENE_API class UEnum* Z_Construct_UEnum_MovieScene_ESectionEvaluationFlags();
	...
	MOVIESCENE_API class UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneTemplateGenerationLedger();
	MOVIESCENE_API class UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneTrackIdentifiers();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESpawnOwnership(ESpawnOwnership_StaticEnum, TEXT("/Script/MovieScene"), TEXT("ESpawnOwnership"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_MovieScene_ESpawnOwnership()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Emplace(TEXT("ESpawnOwnership::InnerSequence"), 0);
			EnumNames.Emplace(TEXT("ESpawnOwnership::MasterSequence"), 1);
			EnumNames.Emplace(TEXT("ESpawnOwnership::External"), 2);
			EnumNames.Emplace(TEXT("ESpawnOwnership::ESpawnOwnership_MAX"), 3);
	...
	uint32 Get_Z_Construct_UEnum_MovieScene_ESpawnOwnership_CRC() { return 3499800224U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneSignedObject> > StaticCppClassTypeInfo;
	...
	IMPLEMENT_CLASS(UMovieSceneSignedObject, 2652243590);
...
static UEnum* EMovieSceneObjectBindingSpace_StaticEnum()
{
	...
	if (!Singleton)
	{
		extern MOVIESCENE_API class UEnum* Z_Construct_UEnum_MovieScene_EMovieSceneObjectBindingSpace();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EMovieSceneObjectBindingSpace(EMovieSceneObjectBindingSpace_StaticEnum, TEXT("/Script/MovieScene"), TEXT("EMovieSceneObjectBindingSpace"), false, nullptr, nullptr);
	...
	{
		UPackage* Outer=Z_Construct_UPackage__Script_MovieScene();
		extern uint32 Get_Z_Construct_UEnum_MovieScene_EMovieSceneObjectBindingSpace_CRC();
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EMovieSceneObjectBindingSpace"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EMovieSceneObjectBindingSpace::Local"), 0);
			EnumNames.Emplace(TEXT("EMovieSceneObjectBindingSpace::Root"), 1);
			EnumNames.Emplace(TEXT("EMovieSceneObjectBindingSpace::EMovieSceneObjectBindingSpace_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("EMovieSceneObjectBindingSpace");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("Local.ToolTip"), TEXT("The object binding sequence ID resolves from a local sequence (ie, it may need to accumulate a parent sequence ID before it resolves correctly)"));
			MetaData->SetValue(ReturnEnum, TEXT("ModuleRelativePath"), TEXT("Public/MovieSceneObjectBindingID.h"));
			MetaData->SetValue(ReturnEnum, TEXT("Root.ToolTip"), TEXT("The object binding sequence ID resolves from the root of the sequence"));
			MetaData->SetValue(ReturnEnum, TEXT("ToolTip"), TEXT("Enumeration specifying how a movie scene object binding ID relates to the sequence"));
#endif
		}
		return ReturnEnum;
	}
	uint32 Get_Z_Construct_UEnum_MovieScene_EMovieSceneObjectBindingSpace_CRC() { return 3830633380U; }
class UScriptStruct* FMovieSceneObjectBindingID::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MOVIESCENE_API class UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneObjectBindingID();
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneObjectBindingID
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneObjectBindingID()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("MovieSceneObjectBindingID"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FMovieSceneObjectBindingID>, EStructFlags(0x00000001));
			UProperty* NewProp_Guid = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Guid"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Guid, FMovieSceneObjectBindingID), 0x0040000000000001, Z_Construct_UScriptStruct_FGuid());
			UProperty* NewProp_Space = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Space"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(Space, FMovieSceneObjectBindingID), 0x0040000000000000, Z_Construct_UEnum_MovieScene_EMovieSceneObjectBindingSpace());
			...
			UProperty* NewProp_SequenceID = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("SequenceID"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(SequenceID, FMovieSceneObjectBindingID), 0x0040000000000000);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("BlueprintType"), TEXT("true"));
			MetaData->SetValue(ReturnStruct, TEXT("HasNativeMake"), TEXT(""));
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/MovieSceneObjectBindingID.h"));
			MetaData->SetValue(ReturnStruct, TEXT("ToolTip"), TEXT("Persistent identifier to a specific object binding within a sequence hierarchy."));
			MetaData->SetValue(NewProp_Guid, TEXT("Category"), TEXT("Binding"));
			MetaData->SetValue(NewProp_Guid, TEXT("ModuleRelativePath"), TEXT("Public/MovieSceneObjectBindingID.h"));
			MetaData->SetValue(NewProp_Guid, TEXT("ToolTip"), TEXT("Identifier for the object binding within the sequence"));
			MetaData->SetValue(NewProp_Space, TEXT("ModuleRelativePath"), TEXT("Public/MovieSceneObjectBindingID.h"));
			MetaData->SetValue(NewProp_Space, TEXT("ToolTip"), TEXT("The binding's resolution space"));
			MetaData->SetValue(NewProp_SequenceID, TEXT("ModuleRelativePath"), TEXT("Public/MovieSceneObjectBindingID.h"));
			MetaData->SetValue(NewProp_SequenceID, TEXT("ToolTip"), TEXT("Sequence ID stored as an int32 so that it can be used in the blueprint VM"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_CRC() { return 619715019U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieScene> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UMovieScene, 4264696904);
	...
	UClass* Z_Construct_UClass_UMovieSceneBindingOverridesInterface()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<IMovieSceneBindingOverridesInterface> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UMovieSceneBindingOverridesInterface, 2748961276);
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneBindingOverrideData
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneBindingOverrideData()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_ObjectBindingId = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("ObjectBindingId"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ObjectBindingId, FMovieSceneBindingOverrideData), 0x0010000000000001, Z_Construct_UScriptStruct_FMovieSceneObjectBindingID());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneBindingOverrideData_CRC() { return 3460682453U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneBindingOverrides> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
	...
	IMPLEMENT_CLASS(UMovieSceneBindingOverrides, 2488439655);
	...
	UClass* Z_Construct_UClass_UMovieSceneBindingOwnerInterface()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<IMovieSceneBindingOwnerInterface> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UMovieSceneBindingOwnerInterface, 551998304);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneFolder> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UMovieSceneFolder, 1020993033);
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSequencePlaybackSettings
{
	...
	UFunction* Z_Construct_UFunction_UMovieSceneSequencePlayer_GetBoundObjects()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetBoundObjects"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(MovieSceneSequencePlayer_eventGetBoundObjects_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(ReturnValue, MovieSceneSequencePlayer_eventGetBoundObjects_Parms), 0x0010000000000580);
			UProperty* NewProp_ReturnValue_Inner = new(EC_InternalUseOnlyConstructor, NewProp_ReturnValue, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UClass_UObject_NoRegister());
			UProperty* NewProp_ObjectBinding = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ObjectBinding"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ObjectBinding, MovieSceneSequencePlayer_eventGetBoundObjects_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FMovieSceneObjectBindingID());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Game|Cinematic"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Public/MovieSceneSequencePlayer.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Retrieve all objects currently bound to the specified binding identifier"));
#endif
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_UMovieSceneSequencePlayer()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->LinkChild(Z_Construct_UFunction_UMovieSceneSequencePlayer_GetBoundObjects());
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UMovieSceneSequencePlayer_GetBoundObjects(), "GetBoundObjects"); // 1999720613
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneSequencePlayer> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UMovieSceneSequencePlayer, 2080161422);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EMovieSceneKeyInterpolation(EMovieSceneKeyInterpolation_StaticEnum, TEXT("/Script/MovieScene"), TEXT("EMovieSceneKeyInterpolation"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_MovieScene_EMovieSceneKeyInterpolation()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EMovieSceneKeyInterpolation::Auto"), 0);
			EnumNames.Emplace(TEXT("EMovieSceneKeyInterpolation::User"), 1);
			EnumNames.Emplace(TEXT("EMovieSceneKeyInterpolation::Break"), 2);
			EnumNames.Emplace(TEXT("EMovieSceneKeyInterpolation::Linear"), 3);
			EnumNames.Emplace(TEXT("EMovieSceneKeyInterpolation::Constant"), 4);
			EnumNames.Emplace(TEXT("EMovieSceneKeyInterpolation::EMovieSceneKeyInterpolation_MAX"), 5);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_MovieScene_EMovieSceneKeyInterpolation_CRC() { return 2878911479U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EMovieSceneCompletionMode(EMovieSceneCompletionMode_StaticEnum, TEXT("/Script/MovieScene"), TEXT("EMovieSceneCompletionMode"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_MovieScene_EMovieSceneCompletionMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EMovieSceneCompletionMode::KeepState"), 0);
			EnumNames.Emplace(TEXT("EMovieSceneCompletionMode::RestoreState"), 1);
			EnumNames.Emplace(TEXT("EMovieSceneCompletionMode::EMovieSceneCompletionMode_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_MovieScene_EMovieSceneCompletionMode_CRC() { return 2553236358U; }
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_PostRollTime = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("PostRollTime"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(PostRollTime, UMovieSceneSection), 0x0040040000000001);
				UProperty* NewProp_PreRollTime = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("PreRollTime"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(PreRollTime, UMovieSceneSection), 0x0040040000000001);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneSection> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				...
				MetaData->SetValue(NewProp_PostRollTime, TEXT("Category"), TEXT("Section"));
				MetaData->SetValue(NewProp_PostRollTime, TEXT("ModuleRelativePath"), TEXT("Public/MovieSceneSection.h"));
				MetaData->SetValue(NewProp_PostRollTime, TEXT("ToolTip"), TEXT("The amount of time to continue 'postrolling' this section for after evaluation has ended."));
				MetaData->SetValue(NewProp_PostRollTime, TEXT("UIMin"), TEXT("0"));
				MetaData->SetValue(NewProp_PostRollTime, TEXT("Units"), TEXT("s"));
				MetaData->SetValue(NewProp_PreRollTime, TEXT("Category"), TEXT("Section"));
				MetaData->SetValue(NewProp_PreRollTime, TEXT("ModuleRelativePath"), TEXT("Public/MovieSceneSection.h"));
				MetaData->SetValue(NewProp_PreRollTime, TEXT("ToolTip"), TEXT("The amount of time to prepare this section for evaluation before it actually starts."));
				MetaData->SetValue(NewProp_PreRollTime, TEXT("UIMin"), TEXT("0"));
				MetaData->SetValue(NewProp_PreRollTime, TEXT("Units"), TEXT("s"));
	...
	IMPLEMENT_CLASS(UMovieSceneSection, 3047848707);
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneTrackCompilationParams
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneTrackCompilationParams()
	{
		...
		if (!ReturnStruct)
		{
			...
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bDuringBlueprintCompile, FMovieSceneTrackCompilationParams, bool);
			UProperty* NewProp_bDuringBlueprintCompile = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bDuringBlueprintCompile"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bDuringBlueprintCompile, FMovieSceneTrackCompilationParams), 0x0010000000000000, CPP_BOOL_PROPERTY_BITMASK(bDuringBlueprintCompile, FMovieSceneTrackCompilationParams), sizeof(bool), true);
			...
			MetaData->SetValue(NewProp_bDuringBlueprintCompile, TEXT("ModuleRelativePath"), TEXT("Public/MovieSceneTrack.h"));
			MetaData->SetValue(NewProp_bDuringBlueprintCompile, TEXT("ToolTip"), TEXT("Whether we're generating during a blueprint compile. As such, UObject types may not have been fully loaded."));
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneTrackCompilationParams_CRC() { return 1701970416U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneTrack> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UMovieSceneTrack, 290270451);
	...
	UClass* Z_Construct_UClass_UMovieSceneSegmentCompilerTestTrack()
	{
		...
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage__Script_MovieScene();
			OuterClass = UMovieSceneSegmentCompilerTestTrack::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				UObjectForceRegistration(OuterClass);
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_SectionArray = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SectionArray"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(SectionArray, UMovieSceneSegmentCompilerTestTrack), 0x0010008000000008);
				UProperty* NewProp_SectionArray_Inner = new(EC_InternalUseOnlyConstructor, NewProp_SectionArray, TEXT("SectionArray"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000080008, Z_Construct_UClass_UMovieSceneSection_NoRegister());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bHighPassFilter, UMovieSceneSegmentCompilerTestTrack, bool);
				UProperty* NewProp_bHighPassFilter = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bHighPassFilter"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bHighPassFilter, UMovieSceneSegmentCompilerTestTrack), 0x0010000000000000, CPP_BOOL_PROPERTY_BITMASK(bHighPassFilter, UMovieSceneSegmentCompilerTestTrack), sizeof(bool), true);
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneSegmentCompilerTestTrack> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("Tests/MovieSceneSegmentCompilerTests.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("Private/Tests/MovieSceneSegmentCompilerTests.h"));
				MetaData->SetValue(NewProp_SectionArray, TEXT("EditInline"), TEXT("true"));
				MetaData->SetValue(NewProp_SectionArray, TEXT("ModuleRelativePath"), TEXT("Private/Tests/MovieSceneSegmentCompilerTests.h"));
				MetaData->SetValue(NewProp_bHighPassFilter, TEXT("ModuleRelativePath"), TEXT("Private/Tests/MovieSceneSegmentCompilerTests.h"));
#endif
			}
		}
		check(OuterClass->GetClass());
	...
	IMPLEMENT_CLASS(UMovieSceneSegmentCompilerTestTrack, 3291988401);
	...
	UClass* Z_Construct_UClass_UMovieSceneSegmentCompilerTestSection()
	{
		...
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage__Script_MovieScene();
			OuterClass = UMovieSceneSegmentCompilerTestSection::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				UObjectForceRegistration(OuterClass);
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneSegmentCompilerTestSection> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UMovieSceneSegmentCompilerTestSection, 1411643565);
...
static UEnum* ESectionEvaluationFlags_StaticEnum()
{
	...
	if (!Singleton)
	{
		extern MOVIESCENE_API class UEnum* Z_Construct_UEnum_MovieScene_ESectionEvaluationFlags();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESectionEvaluationFlags(ESectionEvaluationFlags_StaticEnum, TEXT("/Script/MovieScene"), TEXT("ESectionEvaluationFlags"), false, nullptr, nullptr);
	...
	{
		UPackage* Outer=Z_Construct_UPackage__Script_MovieScene();
		extern uint32 Get_Z_Construct_UEnum_MovieScene_ESectionEvaluationFlags_CRC();
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ESectionEvaluationFlags"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESectionEvaluationFlags::None"), 0);
			EnumNames.Emplace(TEXT("ESectionEvaluationFlags::PreRoll"), 1);
			EnumNames.Emplace(TEXT("ESectionEvaluationFlags::PostRoll"), 2);
			EnumNames.Emplace(TEXT("ESectionEvaluationFlags::ESectionEvaluationFlags_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("ESectionEvaluationFlags");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneSegment.h"));
			MetaData->SetValue(ReturnEnum, TEXT("None.ToolTip"), TEXT("No special flags - normal evaluation"));
			MetaData->SetValue(ReturnEnum, TEXT("PostRoll.ToolTip"), TEXT("Segment resides inside the 'post-roll' time for the section"));
			MetaData->SetValue(ReturnEnum, TEXT("PreRoll.ToolTip"), TEXT("Segment resides inside the 'pre-roll' time for the section"));
			MetaData->SetValue(ReturnEnum, TEXT("ToolTip"), TEXT("Enumeration specifying how to evaluate a particular section when inside a segment"));
#endif
		}
		return ReturnEnum;
	}
	uint32 Get_Z_Construct_UEnum_MovieScene_ESectionEvaluationFlags_CRC() { return 1374883969U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSegment
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneSegment()
	{
		...
		if (!ReturnStruct)
		{
			...
			MetaData->SetValue(ReturnStruct, TEXT("ToolTip"), TEXT("Information about a single segment of an evaluation track"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSegment_CRC() { return 381158857U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFSectionEvaluationData
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSectionEvaluationData()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_Flags = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Flags"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(Flags, FSectionEvaluationData), 0x0010000000000000, Z_Construct_UEnum_MovieScene_ESectionEvaluationFlags());
			UProperty* NewProp_Flags_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_Flags, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			...
			MetaData->SetValue(NewProp_Flags, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneSegment.h"));
			MetaData->SetValue(NewProp_Flags, TEXT("ToolTip"), TEXT("Additional flags for evaluating this section"));
			...
			MetaData->SetValue(NewProp_ImplIndex, TEXT("ToolTip"), TEXT("The implementation index we should evaluate (index into FMovieSceneEvaluationTrack::ChildTemplates)"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FSectionEvaluationData_CRC() { return 2429942539U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EEvaluationMethod(EEvaluationMethod_StaticEnum, TEXT("/Script/MovieScene"), TEXT("EEvaluationMethod"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_MovieScene_EEvaluationMethod()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EEvaluationMethod::Static"), 0);
			EnumNames.Emplace(TEXT("EEvaluationMethod::Swept"), 1);
			EnumNames.Emplace(TEXT("EEvaluationMethod::EEvaluationMethod_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_MovieScene_EEvaluationMethod_CRC() { return 2287511102U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSectionParameters
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneSectionParameters()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_PostrollTime = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("PostrollTime"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(PostrollTime_DEPRECATED, FMovieSceneSectionParameters), 0x0010000020000000);
			UProperty* NewProp_PrerollTime = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("PrerollTime"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(PrerollTime_DEPRECATED, FMovieSceneSectionParameters), 0x0010000020000000);
			UProperty* NewProp_HierarchicalBias = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("HierarchicalBias"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(HierarchicalBias, FMovieSceneSectionParameters), 0x0010000000000001);
			...
			MetaData->SetValue(NewProp_HierarchicalBias, TEXT("Category"), TEXT("Sequence"));
			MetaData->SetValue(NewProp_HierarchicalBias, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneSectionParameters.h"));
			MetaData->SetValue(NewProp_HierarchicalBias, TEXT("ToolTip"), TEXT("Hierachical bias. Higher bias will take precedence."));
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSectionParameters_CRC() { return 2051657619U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSubSequenceData
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneSubSequenceData()
	{
		...
		if (!ReturnStruct)
		{
...
#endif // WITH_EDITORONLY_DATA
			UProperty* NewProp_HierarchicalBias = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("HierarchicalBias"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(HierarchicalBias, FMovieSceneSubSequenceData), 0x0010000000000000);
			UProperty* NewProp_PostRollRange = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("PostRollRange"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(PostRollRange, FMovieSceneSubSequenceData), 0x0010000000000000, Z_Construct_UScriptStruct_FFloatRange());
			UProperty* NewProp_PreRollRange = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("PreRollRange"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(PreRollRange, FMovieSceneSubSequenceData), 0x0010000000000000, Z_Construct_UScriptStruct_FFloatRange());
			...
			UProperty* NewProp_SequenceKeyObject = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("SequenceKeyObject"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(SequenceKeyObject, FMovieSceneSubSequenceData), 0x0010000000000000, Z_Construct_UClass_UObject_NoRegister());
			...
			MetaData->SetValue(NewProp_HierarchicalBias, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneSequenceHierarchy.h"));
			MetaData->SetValue(NewProp_HierarchicalBias, TEXT("ToolTip"), TEXT("The accumulated hierarchical bias of this sequence. Higher bias will take precedence"));
			MetaData->SetValue(NewProp_PostRollRange, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneSequenceHierarchy.h"));
			MetaData->SetValue(NewProp_PostRollRange, TEXT("ToolTip"), TEXT("The sequence postroll range considering the start offset"));
			MetaData->SetValue(NewProp_PreRollRange, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneSequenceHierarchy.h"));
			MetaData->SetValue(NewProp_PreRollRange, TEXT("ToolTip"), TEXT("The sequence preroll range considering the start offset"));
			...
			MetaData->SetValue(NewProp_SequenceKeyObject, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneSequenceHierarchy.h"));
			MetaData->SetValue(NewProp_SequenceKeyObject, TEXT("NativeConst"), TEXT(""));
			MetaData->SetValue(NewProp_SequenceKeyObject, TEXT("ToolTip"), TEXT("The key object that the sub section uses. Usually either the sequence or the section."));
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSubSequenceData_CRC() { return 295741236U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneEvaluationTemplate
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_TemplateLedger = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TemplateLedger"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(TemplateLedger, FMovieSceneEvaluationTemplate), 0x0040000000000000, Z_Construct_UScriptStruct_FMovieSceneTemplateGenerationLedger());
			...
			MetaData->SetValue(NewProp_TemplateLedger, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneEvaluationTemplate.h"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate_CRC() { return 3886165479U; }
class UScriptStruct* FMovieSceneTemplateGenerationLedger::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MOVIESCENE_API class UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneTemplateGenerationLedger();
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneTemplateGenerationLedger
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneTemplateGenerationLedger()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("MovieSceneTemplateGenerationLedger"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FMovieSceneTemplateGenerationLedger>, EStructFlags(0x00000001));
			UProperty* NewProp_TrackSignatureToTrackIdentifier = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TrackSignatureToTrackIdentifier"), RF_Public|RF_Transient|RF_MarkAsNative) UMapProperty(CPP_PROPERTY_BASE(TrackSignatureToTrackIdentifier, FMovieSceneTemplateGenerationLedger), 0x0010000000000000);
			UProperty* NewProp_TrackSignatureToTrackIdentifier_Key_KeyProp = new(EC_InternalUseOnlyConstructor, NewProp_TrackSignatureToTrackIdentifier, TEXT("TrackSignatureToTrackIdentifier_Key"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FGuid());
			UProperty* NewProp_TrackSignatureToTrackIdentifier_ValueProp = new(EC_InternalUseOnlyConstructor, NewProp_TrackSignatureToTrackIdentifier, TEXT("TrackSignatureToTrackIdentifier"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 1, 0x0000000000000000, Z_Construct_UScriptStruct_FMovieSceneTrackIdentifiers());
			UProperty* NewProp_TrackReferenceCounts = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TrackReferenceCounts"), RF_Public|RF_Transient|RF_MarkAsNative) UMapProperty(CPP_PROPERTY_BASE(TrackReferenceCounts, FMovieSceneTemplateGenerationLedger), 0x0010000000000000);
			UProperty* NewProp_TrackReferenceCounts_Key_KeyProp = new(EC_InternalUseOnlyConstructor, NewProp_TrackReferenceCounts, TEXT("TrackReferenceCounts_Key"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FMovieSceneTrackIdentifier());
			UProperty* NewProp_TrackReferenceCounts_ValueProp = new(EC_InternalUseOnlyConstructor, NewProp_TrackReferenceCounts, TEXT("TrackReferenceCounts"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(FObjectInitializer(), EC_CppProperty, 1, 0x0000000000000000);
			UProperty* NewProp_LastTrackIdentifier = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("LastTrackIdentifier"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(LastTrackIdentifier, FMovieSceneTemplateGenerationLedger), 0x0010000000000000, Z_Construct_UScriptStruct_FMovieSceneTrackIdentifier());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneEvaluationTemplate.h"));
			MetaData->SetValue(NewProp_TrackSignatureToTrackIdentifier, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneEvaluationTemplate.h"));
			MetaData->SetValue(NewProp_TrackSignatureToTrackIdentifier, TEXT("ToolTip"), TEXT("Map of track signature to array of track identifiers that it created"));
			MetaData->SetValue(NewProp_TrackReferenceCounts, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneEvaluationTemplate.h"));
			MetaData->SetValue(NewProp_TrackReferenceCounts, TEXT("ToolTip"), TEXT("Map of track identifiers to number of references within th template (generally 1, maybe >1 for shared tracks)"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneTemplateGenerationLedger_CRC() { return 2401785141U; }
class UScriptStruct* FMovieSceneTrackIdentifiers::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern MOVIESCENE_API class UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneTrackIdentifiers();
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneTrackIdentifiers
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneTrackIdentifiers()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("MovieSceneTrackIdentifiers"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FMovieSceneTrackIdentifiers>, EStructFlags(0x00000001));
			UProperty* NewProp_Data = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Data"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(Data, FMovieSceneTrackIdentifiers), 0x0010000000000000);
			UProperty* NewProp_Data_Inner = new(EC_InternalUseOnlyConstructor, NewProp_Data, TEXT("Data"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FMovieSceneTrackIdentifier());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneEvaluationTemplate.h"));
			MetaData->SetValue(NewProp_Data, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieSceneEvaluationTemplate.h"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneTrackIdentifiers_CRC() { return 625185719U; }
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				...
				UProperty* NewProp_InstancedSubSequenceEvaluationTemplates = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("InstancedSubSequenceEvaluationTemplates"), RF_Public|RF_Transient|RF_MarkAsNative) UMapProperty(CPP_PROPERTY_BASE(InstancedSubSequenceEvaluationTemplates, UMovieSceneSequence), 0x0010000000000000);
				UProperty* NewProp_InstancedSubSequenceEvaluationTemplates_Key_KeyProp = new(EC_InternalUseOnlyConstructor, NewProp_InstancedSubSequenceEvaluationTemplates, TEXT("InstancedSubSequenceEvaluationTemplates_Key"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UClass_UObject_NoRegister());
				UProperty* NewProp_InstancedSubSequenceEvaluationTemplates_ValueProp = new(EC_InternalUseOnlyConstructor, NewProp_InstancedSubSequenceEvaluationTemplates, TEXT("InstancedSubSequenceEvaluationTemplates"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 1, 0x0000000000000000, Z_Construct_UScriptStruct_FCachedMovieSceneEvaluationTemplate());
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneSequence> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				...
				MetaData->SetValue(NewProp_InstancedSubSequenceEvaluationTemplates, TEXT("ModuleRelativePath"), TEXT("Public/MovieSceneSequence.h"));
	...
	IMPLEMENT_CLASS(UMovieSceneSequence, 2791891520);
...
#endif // WITH_EDITORONLY_DATA
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneNameableTrack> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UMovieSceneNameableTrack, 4030537291);
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieScenePropertySectionData
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieScenePropertySectionData()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_NotifyFunctionName = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("NotifyFunctionName"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(NotifyFunctionName, FMovieScenePropertySectionData), 0x0040000000000000);
			...
			MetaData->SetValue(NewProp_NotifyFunctionName, TEXT("ModuleRelativePath"), TEXT("Public/Evaluation/MovieScenePropertyTemplate.h"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieScenePropertySectionData_CRC() { return 2460392317U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneKeyStruct
{
	...
	UPackage* Z_Construct_UPackage__Script_MovieScene()
	{
		...
		if (!ReturnPackage)
		{
			ReturnPackage = CastChecked<UPackage>(StaticFindObjectFast(UPackage::StaticClass(), nullptr, FName(TEXT("/Script/MovieScene")), false, false));
