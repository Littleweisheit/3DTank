...
static struct FScriptStruct_MovieSceneCapture_StaticRegisterNativesFCaptureResolution
{
	...
	UClass* Z_Construct_UClass_UMovieSceneCaptureInterface()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<IMovieSceneCaptureInterface> > StaticCppClassTypeInfo;
	...
	IMPLEMENT_CLASS(UMovieSceneCaptureInterface, 688938538);
	...
	UClass* Z_Construct_UClass_UMovieSceneCaptureProtocolSettings()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneCaptureProtocolSettings> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UMovieSceneCaptureProtocolSettings, 4011633588);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneCapture> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
	...
	IMPLEMENT_CLASS(UMovieSceneCapture, 2725336918);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UAutomatedLevelSequenceCapture> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UAutomatedLevelSequenceCapture, 2834051713);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->ClassConfigName = FName(TEXT("EditorPerProjectUserSettings"));
				static TCppClassTypeInfo<TCppClassTypeTraits<ULevelCapture> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(ULevelCapture, 2616652876);
	...
	UClass* Z_Construct_UClass_UMovieSceneCaptureEnvironment()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneCaptureEnvironment> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UMovieSceneCaptureEnvironment, 871798044);
	...
	UClass* Z_Construct_UClass_UFrameGrabberProtocolSettings()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UFrameGrabberProtocolSettings> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UFrameGrabberProtocolSettings, 207827223);
	...
	UClass* Z_Construct_UClass_UBmpImageCaptureSettings()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->ClassConfigName = FName(TEXT("EditorPerProjectUserSettings"));
				static TCppClassTypeInfo<TCppClassTypeTraits<UBmpImageCaptureSettings> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UBmpImageCaptureSettings, 3556315306);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->ClassConfigName = FName(TEXT("EditorPerProjectUserSettings"));
				static TCppClassTypeInfo<TCppClassTypeTraits<UImageCaptureSettings> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UImageCaptureSettings, 2072298890);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EHDRCaptureGamut(EHDRCaptureGamut_StaticEnum, TEXT("/Script/MovieSceneCapture"), TEXT("EHDRCaptureGamut"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_MovieSceneCapture_EHDRCaptureGamut()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Emplace(TEXT("HCGM_Rec709"), 0);
			EnumNames.Emplace(TEXT("HCGM_P3DCI"), 1);
			EnumNames.Emplace(TEXT("HCGM_Rec2020"), 2);
			EnumNames.Emplace(TEXT("HCGM_ACES"), 3);
			EnumNames.Emplace(TEXT("HCGM_ACEScg"), 4);
			EnumNames.Emplace(TEXT("HCGM_MAX"), 5);
	...
	uint32 Get_Z_Construct_UEnum_MovieSceneCapture_EHDRCaptureGamut_CRC() { return 3519156613U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->ClassConfigName = FName(TEXT("EditorPerProjectUserSettings"));
				static TCppClassTypeInfo<TCppClassTypeTraits<UCompositionGraphCaptureSettings> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UCompositionGraphCaptureSettings, 2759667669);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->ClassConfigName = FName(TEXT("EditorPerProjectUserSettings"));
				static TCppClassTypeInfo<TCppClassTypeTraits<UVideoCaptureSettings> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UVideoCaptureSettings, 1199123620);
	...
	UPackage* Z_Construct_UPackage__Script_MovieSceneCapture()
	{
		...
		if (!ReturnPackage)
		{
			ReturnPackage = CastChecked<UPackage>(StaticFindObjectFast(UPackage::StaticClass(), nullptr, FName(TEXT("/Script/MovieSceneCapture")), false, false));
