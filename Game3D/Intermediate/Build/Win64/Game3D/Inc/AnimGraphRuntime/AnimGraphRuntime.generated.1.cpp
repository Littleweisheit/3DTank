...
// Cross Module References
	...
	ENGINE_API class UScriptStruct* Z_Construct_UScriptStruct_FAxis();
	ENGINE_API class UEnum* Z_Construct_UEnum_Engine_EAxisOption();
	...
	ANIMGRAPHRUNTIME_API class UClass* Z_Construct_UClass_UAnimNotify_PlayMontageNotify_NoRegister();
	ANIMGRAPHRUNTIME_API class UClass* Z_Construct_UClass_UAnimNotify_PlayMontageNotify();
	ANIMGRAPHRUNTIME_API class UClass* Z_Construct_UClass_UAnimNotify_PlayMontageNotifyWindow_NoRegister();
	ANIMGRAPHRUNTIME_API class UClass* Z_Construct_UClass_UAnimNotify_PlayMontageNotifyWindow();
	...
	ANIMGRAPHRUNTIME_API class UFunction* Z_Construct_UFunction_UKismetAnimationLibrary_K2_LookAt();
	ANIMGRAPHRUNTIME_API class UFunction* Z_Construct_UFunction_UKismetAnimationLibrary_K2_TwoBoneIK();
	ANIMGRAPHRUNTIME_API class UClass* Z_Construct_UClass_UKismetAnimationLibrary_NoRegister();
	ANIMGRAPHRUNTIME_API class UClass* Z_Construct_UClass_UKismetAnimationLibrary();
	ANIMGRAPHRUNTIME_API class UFunction* Z_Construct_UDelegateFunction_AnimGraphRuntime_OnMontagePlayDelegate__DelegateSignature();
	ANIMGRAPHRUNTIME_API class UFunction* Z_Construct_UFunction_UPlayMontageCallbackProxy_CreateProxyObjectForPlayMontage();
	ANIMGRAPHRUNTIME_API class UFunction* Z_Construct_UFunction_UPlayMontageCallbackProxy_OnMontageBlendingOut();
	ANIMGRAPHRUNTIME_API class UFunction* Z_Construct_UFunction_UPlayMontageCallbackProxy_OnMontageEnded();
	ANIMGRAPHRUNTIME_API class UFunction* Z_Construct_UFunction_UPlayMontageCallbackProxy_OnNotifyBeginReceived();
	ANIMGRAPHRUNTIME_API class UFunction* Z_Construct_UFunction_UPlayMontageCallbackProxy_OnNotifyEndReceived();
	ANIMGRAPHRUNTIME_API class UClass* Z_Construct_UClass_UPlayMontageCallbackProxy_NoRegister();
	ANIMGRAPHRUNTIME_API class UClass* Z_Construct_UClass_UPlayMontageCallbackProxy();
	...
	ANIMGRAPHRUNTIME_API class UEnum* Z_Construct_UEnum_AnimGraphRuntime_ERBFDistanceMethod();
	ANIMGRAPHRUNTIME_API class UEnum* Z_Construct_UEnum_AnimGraphRuntime_ERBFFunctionType();
	ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FRBFParams();
	ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FRBFTarget();
	ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FRBFEntry();
	ANIMGRAPHRUNTIME_API class UEnum* Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverOutput();
	ANIMGRAPHRUNTIME_API class UEnum* Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverSource();
	...
	ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FPoseDriverTarget();
	ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FPoseDriverTransform();
	...
	ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength();
	ANIMGRAPHRUNTIME_API class UEnum* Z_Construct_UEnum_AnimGraphRuntime_ESplineBoneAxis();
	ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_SplineIK();
	ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FSplineIKCachedBoneData();
	...
	UClass* Z_Construct_UClass_UAnimNotify_PlayMontageNotify()
	{
		...
		if (!OuterClass)
		{
			...
			OuterClass = UAnimNotify_PlayMontageNotify::StaticClass();
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_NotifyName = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("NotifyName"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(NotifyName, UAnimNotify_PlayMontageNotify), 0x0020080000000015);
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UAnimNotify_PlayMontageNotify> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("DisplayName"), TEXT("Montage Notify"));
				MetaData->SetValue(OuterClass, TEXT("HideCategories"), TEXT("Object Object"));
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("AnimNotifies/AnimNotify_PlayMontageNotify.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("Public/AnimNotifies/AnimNotify_PlayMontageNotify.h"));
				MetaData->SetValue(OuterClass, TEXT("ToolTip"), TEXT("UAnimNotify_PlayMontageNotify"));
				MetaData->SetValue(NewProp_NotifyName, TEXT("Category"), TEXT("Notify"));
				MetaData->SetValue(NewProp_NotifyName, TEXT("ModuleRelativePath"), TEXT("Public/AnimNotifies/AnimNotify_PlayMontageNotify.h"));
				MetaData->SetValue(NewProp_NotifyName, TEXT("ToolTip"), TEXT("Name of notify that is passed to the PlayMontage K2Node."));
#endif
			}
		}
	...
	IMPLEMENT_CLASS(UAnimNotify_PlayMontageNotify, 3697242801);
	...
	UClass* Z_Construct_UClass_UAnimNotify_PlayMontageNotifyWindow()
	{
		...
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage__Script_AnimGraphRuntime();
			OuterClass = UAnimNotify_PlayMontageNotifyWindow::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				UObjectForceRegistration(OuterClass);
				OuterClass->ClassFlags |= 0x20093080;
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_NotifyName = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("NotifyName"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(NotifyName, UAnimNotify_PlayMontageNotifyWindow), 0x0020080000000015);
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				static TCppClassTypeInfo<TCppClassTypeTraits<UAnimNotify_PlayMontageNotifyWindow> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("DisplayName"), TEXT("Montage Notify Window"));
				MetaData->SetValue(OuterClass, TEXT("HideCategories"), TEXT("Object Object"));
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("AnimNotifies/AnimNotify_PlayMontageNotify.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("Public/AnimNotifies/AnimNotify_PlayMontageNotify.h"));
				MetaData->SetValue(OuterClass, TEXT("ToolTip"), TEXT("UAnimNotify_PlayMontageNotifyWindow"));
				MetaData->SetValue(NewProp_NotifyName, TEXT("Category"), TEXT("Notify"));
				MetaData->SetValue(NewProp_NotifyName, TEXT("ModuleRelativePath"), TEXT("Public/AnimNotifies/AnimNotify_PlayMontageNotify.h"));
				MetaData->SetValue(NewProp_NotifyName, TEXT("ToolTip"), TEXT("Name of notify that is passed to ability."));
#endif
			}
		}
		check(OuterClass->GetClass());
	...
	IMPLEMENT_CLASS(UAnimNotify_PlayMontageNotifyWindow, 1293483848);
	...
	UClass* Z_Construct_UClass_UAnimSequencerInstance()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UAnimSequencerInstance> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UAnimSequencerInstance, 3750648838);
	...
	UFunction* Z_Construct_UFunction_UKismetAnimationLibrary_K2_LookAt()
	{
		...
		UObject* Outer=Z_Construct_UClass_UKismetAnimationLibrary();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("K2_LookAt"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x14C22401, 65535, sizeof(KismetAnimationLibrary_eventK2_LookAt_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ReturnValue, KismetAnimationLibrary_eventK2_LookAt_Parms), 0x0010000000000580, Z_Construct_UScriptStruct_FTransform());
			UProperty* NewProp_ClampConeInDegree = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ClampConeInDegree"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ClampConeInDegree, KismetAnimationLibrary_eventK2_LookAt_Parms), 0x0010000000000080);
			UProperty* NewProp_UpVector = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("UpVector"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(UpVector, KismetAnimationLibrary_eventK2_LookAt_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FVector());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bUseUpVector, KismetAnimationLibrary_eventK2_LookAt_Parms, bool);
			UProperty* NewProp_bUseUpVector = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bUseUpVector"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bUseUpVector, KismetAnimationLibrary_eventK2_LookAt_Parms), 0x0010000000000080, CPP_BOOL_PROPERTY_BITMASK(bUseUpVector, KismetAnimationLibrary_eventK2_LookAt_Parms), sizeof(bool), true);
			UProperty* NewProp_LookAtVector = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("LookAtVector"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(LookAtVector, KismetAnimationLibrary_eventK2_LookAt_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_TargetPosition = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("TargetPosition"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(TargetPosition, KismetAnimationLibrary_eventK2_LookAt_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_CurrentTransform = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("CurrentTransform"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(CurrentTransform, KismetAnimationLibrary_eventK2_LookAt_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FTransform());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("bUseUpVector"), TEXT("false"));
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Animation"));
			MetaData->SetValue(ReturnFunction, TEXT("DisplayName"), TEXT("Look At"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Public/KismetAnimationLibrary.h"));
			MetaData->SetValue(NewProp_TargetPosition, TEXT("NativeConst"), TEXT(""));
			MetaData->SetValue(NewProp_CurrentTransform, TEXT("NativeConst"), TEXT(""));
#endif
		}
	...
	UFunction* Z_Construct_UFunction_UKismetAnimationLibrary_K2_TwoBoneIK()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("K2_TwoBoneIK"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x14C22401, 65535, sizeof(KismetAnimationLibrary_eventK2_TwoBoneIK_Parms));
			UProperty* NewProp_MaxStretchScale = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("MaxStretchScale"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxStretchScale, KismetAnimationLibrary_eventK2_TwoBoneIK_Parms), 0x0010000000000080);
			UProperty* NewProp_StartStretchRatio = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("StartStretchRatio"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(StartStretchRatio, KismetAnimationLibrary_eventK2_TwoBoneIK_Parms), 0x0010000000000080);
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAllowStretching, KismetAnimationLibrary_eventK2_TwoBoneIK_Parms, bool);
			UProperty* NewProp_bAllowStretching = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bAllowStretching"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAllowStretching, KismetAnimationLibrary_eventK2_TwoBoneIK_Parms), 0x0010000000000080, CPP_BOOL_PROPERTY_BITMASK(bAllowStretching, KismetAnimationLibrary_eventK2_TwoBoneIK_Parms), sizeof(bool), true);
			UProperty* NewProp_OutEndPos = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("OutEndPos"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(OutEndPos, KismetAnimationLibrary_eventK2_TwoBoneIK_Parms), 0x0010000000000180, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_OutJointPos = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("OutJointPos"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(OutJointPos, KismetAnimationLibrary_eventK2_TwoBoneIK_Parms), 0x0010000000000180, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_Effector = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Effector"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Effector, KismetAnimationLibrary_eventK2_TwoBoneIK_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_JointTarget = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("JointTarget"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(JointTarget, KismetAnimationLibrary_eventK2_TwoBoneIK_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_EndPos = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("EndPos"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(EndPos, KismetAnimationLibrary_eventK2_TwoBoneIK_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_JointPos = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("JointPos"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(JointPos, KismetAnimationLibrary_eventK2_TwoBoneIK_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_RootPos = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("RootPos"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(RootPos, KismetAnimationLibrary_eventK2_TwoBoneIK_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FVector());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("bAllowStretching"), TEXT("false"));
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Animation"));
			MetaData->SetValue(ReturnFunction, TEXT("DisplayName"), TEXT("Two Bone IK"));
			MetaData->SetValue(ReturnFunction, TEXT("MaxStretchScale"), TEXT("1.2"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Public/KismetAnimationLibrary.h"));
			MetaData->SetValue(ReturnFunction, TEXT("StartStretchRatio"), TEXT("1.0"));
			MetaData->SetValue(NewProp_Effector, TEXT("NativeConst"), TEXT(""));
			MetaData->SetValue(NewProp_JointTarget, TEXT("NativeConst"), TEXT(""));
			MetaData->SetValue(NewProp_EndPos, TEXT("NativeConst"), TEXT(""));
			MetaData->SetValue(NewProp_JointPos, TEXT("NativeConst"), TEXT(""));
			MetaData->SetValue(NewProp_RootPos, TEXT("NativeConst"), TEXT(""));
#endif
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_UKismetAnimationLibrary()
	{
		...
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage__Script_AnimGraphRuntime();
			OuterClass = UKismetAnimationLibrary::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				UObjectForceRegistration(OuterClass);
				OuterClass->ClassFlags |= 0x20100080;

				OuterClass->LinkChild(Z_Construct_UFunction_UKismetAnimationLibrary_K2_LookAt());
				OuterClass->LinkChild(Z_Construct_UFunction_UKismetAnimationLibrary_K2_TwoBoneIK());

				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UKismetAnimationLibrary_K2_LookAt(), "K2_LookAt"); // 284932550
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UKismetAnimationLibrary_K2_TwoBoneIK(), "K2_TwoBoneIK"); // 3626801924
				static TCppClassTypeInfo<TCppClassTypeTraits<UKismetAnimationLibrary> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("KismetAnimationLibrary.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("Public/KismetAnimationLibrary.h"));
#endif
			}
		}
		check(OuterClass->GetClass());
	...
	IMPLEMENT_CLASS(UKismetAnimationLibrary, 753352427);
	...
	UFunction* Z_Construct_UDelegateFunction_AnimGraphRuntime_OnMontagePlayDelegate__DelegateSignature()
	{
		...
		UObject* Outer=Z_Construct_UPackage__Script_AnimGraphRuntime();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("OnMontagePlayDelegate__DelegateSignature"), RF_Public|RF_Transient|RF_MarkAsNative) UDelegateFunction(FObjectInitializer(), NULL, 0x00130000, 65535, sizeof(_Script_AnimGraphRuntime_eventOnMontagePlayDelegate_Parms));
			UProperty* NewProp_NotifyName = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("NotifyName"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(NotifyName, _Script_AnimGraphRuntime_eventOnMontagePlayDelegate_Parms), 0x0010000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Public/PlayMontageCallbackProxy.h"));
#endif
		}
		return ReturnFunction;
	}
	...
	UFunction* Z_Construct_UFunction_UPlayMontageCallbackProxy_CreateProxyObjectForPlayMontage()
	{
		...
		UObject* Outer=Z_Construct_UClass_UPlayMontageCallbackProxy();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("CreateProxyObjectForPlayMontage"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(PlayMontageCallbackProxy_eventCreateProxyObjectForPlayMontage_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(ReturnValue, PlayMontageCallbackProxy_eventCreateProxyObjectForPlayMontage_Parms), 0x0010000000000580, Z_Construct_UClass_UPlayMontageCallbackProxy_NoRegister());
			UProperty* NewProp_StartingSection = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("StartingSection"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(StartingSection, PlayMontageCallbackProxy_eventCreateProxyObjectForPlayMontage_Parms), 0x0010000000000080);
			UProperty* NewProp_StartingPosition = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("StartingPosition"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(StartingPosition, PlayMontageCallbackProxy_eventCreateProxyObjectForPlayMontage_Parms), 0x0010000000000080);
			UProperty* NewProp_PlayRate = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("PlayRate"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(PlayRate, PlayMontageCallbackProxy_eventCreateProxyObjectForPlayMontage_Parms), 0x0010000000000080);
			UProperty* NewProp_MontageToPlay = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("MontageToPlay"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(MontageToPlay, PlayMontageCallbackProxy_eventCreateProxyObjectForPlayMontage_Parms), 0x0010000000000080, Z_Construct_UClass_UAnimMontage_NoRegister());
			UProperty* NewProp_InSkeletalMeshComponent = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("InSkeletalMeshComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(InSkeletalMeshComponent, PlayMontageCallbackProxy_eventCreateProxyObjectForPlayMontage_Parms), 0x0010000000080080, Z_Construct_UClass_USkeletalMeshComponent_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			...
			MetaData->SetValue(ReturnFunction, TEXT("CPP_Default_StartingPosition"), TEXT("0.000000"));
			MetaData->SetValue(ReturnFunction, TEXT("CPP_Default_StartingSection"), TEXT("None"));
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Public/PlayMontageCallbackProxy.h"));
			MetaData->SetValue(ReturnFunction, TEXT("ToolTip"), TEXT("Called to perform the query internally"));
			MetaData->SetValue(NewProp_InSkeletalMeshComponent, TEXT("EditInline"), TEXT("true"));
#endif
		}
		return ReturnFunction;
	}
	UFunction* Z_Construct_UFunction_UPlayMontageCallbackProxy_OnMontageBlendingOut()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("OnMontageBlendingOut"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x00080401, 65535, sizeof(PlayMontageCallbackProxy_eventOnMontageBlendingOut_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bInterrupted, PlayMontageCallbackProxy_eventOnMontageBlendingOut_Parms, bool);
			UProperty* NewProp_bInterrupted = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bInterrupted"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bInterrupted, PlayMontageCallbackProxy_eventOnMontageBlendingOut_Parms), 0x0010000000000080, CPP_BOOL_PROPERTY_BITMASK(bInterrupted, PlayMontageCallbackProxy_eventOnMontageBlendingOut_Parms), sizeof(bool), true);
			UProperty* NewProp_Montage = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Montage"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(Montage, PlayMontageCallbackProxy_eventOnMontageBlendingOut_Parms), 0x0010000000000080, Z_Construct_UClass_UAnimMontage_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UPlayMontageCallbackProxy_OnMontageEnded()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("OnMontageEnded"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x00080401, 65535, sizeof(PlayMontageCallbackProxy_eventOnMontageEnded_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bInterrupted, PlayMontageCallbackProxy_eventOnMontageEnded_Parms, bool);
			UProperty* NewProp_bInterrupted = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bInterrupted"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bInterrupted, PlayMontageCallbackProxy_eventOnMontageEnded_Parms), 0x0010000000000080, CPP_BOOL_PROPERTY_BITMASK(bInterrupted, PlayMontageCallbackProxy_eventOnMontageEnded_Parms), sizeof(bool), true);
			UProperty* NewProp_Montage = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Montage"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(Montage, PlayMontageCallbackProxy_eventOnMontageEnded_Parms), 0x0010000000000080, Z_Construct_UClass_UAnimMontage_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UPlayMontageCallbackProxy_OnNotifyBeginReceived()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("OnNotifyBeginReceived"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x00480401, 65535, sizeof(PlayMontageCallbackProxy_eventOnNotifyBeginReceived_Parms));
			UProperty* NewProp_BranchingPointNotifyPayload = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("BranchingPointNotifyPayload"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(BranchingPointNotifyPayload, PlayMontageCallbackProxy_eventOnNotifyBeginReceived_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FBranchingPointNotifyPayload());
			UProperty* NewProp_NotifyName = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("NotifyName"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(NotifyName, PlayMontageCallbackProxy_eventOnNotifyBeginReceived_Parms), 0x0010000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Public/PlayMontageCallbackProxy.h"));
			MetaData->SetValue(NewProp_BranchingPointNotifyPayload, TEXT("NativeConst"), TEXT(""));
#endif
		}
		return ReturnFunction;
	}
	UFunction* Z_Construct_UFunction_UPlayMontageCallbackProxy_OnNotifyEndReceived()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("OnNotifyEndReceived"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x00480401, 65535, sizeof(PlayMontageCallbackProxy_eventOnNotifyEndReceived_Parms));
			UProperty* NewProp_BranchingPointNotifyPayload = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("BranchingPointNotifyPayload"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(BranchingPointNotifyPayload, PlayMontageCallbackProxy_eventOnNotifyEndReceived_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FBranchingPointNotifyPayload());
			UProperty* NewProp_NotifyName = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("NotifyName"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(NotifyName, PlayMontageCallbackProxy_eventOnNotifyEndReceived_Parms), 0x0010000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_UPlayMontageCallbackProxy()
	{
		...
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage__Script_AnimGraphRuntime();
			OuterClass = UPlayMontageCallbackProxy::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				UObjectForceRegistration(OuterClass);
				OuterClass->ClassFlags |= 0x20880080;

				OuterClass->LinkChild(Z_Construct_UFunction_UPlayMontageCallbackProxy_CreateProxyObjectForPlayMontage());
				OuterClass->LinkChild(Z_Construct_UFunction_UPlayMontageCallbackProxy_OnMontageBlendingOut());
				OuterClass->LinkChild(Z_Construct_UFunction_UPlayMontageCallbackProxy_OnMontageEnded());
				OuterClass->LinkChild(Z_Construct_UFunction_UPlayMontageCallbackProxy_OnNotifyBeginReceived());
				OuterClass->LinkChild(Z_Construct_UFunction_UPlayMontageCallbackProxy_OnNotifyEndReceived());

PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_OnNotifyEnd = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnNotifyEnd"), RF_Public|RF_Transient|RF_MarkAsNative) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnNotifyEnd, UPlayMontageCallbackProxy), 0x0010000010080000, Z_Construct_UDelegateFunction_AnimGraphRuntime_OnMontagePlayDelegate__DelegateSignature());
				UProperty* NewProp_OnNotifyBegin = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnNotifyBegin"), RF_Public|RF_Transient|RF_MarkAsNative) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnNotifyBegin, UPlayMontageCallbackProxy), 0x0010000010080000, Z_Construct_UDelegateFunction_AnimGraphRuntime_OnMontagePlayDelegate__DelegateSignature());
				UProperty* NewProp_OnInterrupted = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnInterrupted"), RF_Public|RF_Transient|RF_MarkAsNative) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnInterrupted, UPlayMontageCallbackProxy), 0x0010000010080000, Z_Construct_UDelegateFunction_AnimGraphRuntime_OnMontagePlayDelegate__DelegateSignature());
				UProperty* NewProp_OnBlendOut = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnBlendOut"), RF_Public|RF_Transient|RF_MarkAsNative) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnBlendOut, UPlayMontageCallbackProxy), 0x0010000010080000, Z_Construct_UDelegateFunction_AnimGraphRuntime_OnMontagePlayDelegate__DelegateSignature());
				UProperty* NewProp_OnCompleted = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnCompleted"), RF_Public|RF_Transient|RF_MarkAsNative) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnCompleted, UPlayMontageCallbackProxy), 0x0010000010080000, Z_Construct_UDelegateFunction_AnimGraphRuntime_OnMontagePlayDelegate__DelegateSignature());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UPlayMontageCallbackProxy_CreateProxyObjectForPlayMontage(), "CreateProxyObjectForPlayMontage"); // 1585221710
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UPlayMontageCallbackProxy_OnMontageBlendingOut(), "OnMontageBlendingOut"); // 498520838
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UPlayMontageCallbackProxy_OnMontageEnded(), "OnMontageEnded"); // 1152363641
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UPlayMontageCallbackProxy_OnNotifyBeginReceived(), "OnNotifyBeginReceived"); // 3552214555
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UPlayMontageCallbackProxy_OnNotifyEndReceived(), "OnNotifyEndReceived"); // 1062463993
				static TCppClassTypeInfo<TCppClassTypeTraits<UPlayMontageCallbackProxy> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("PlayMontageCallbackProxy.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("Public/PlayMontageCallbackProxy.h"));
				MetaData->SetValue(NewProp_OnNotifyEnd, TEXT("ModuleRelativePath"), TEXT("Public/PlayMontageCallbackProxy.h"));
				MetaData->SetValue(NewProp_OnNotifyBegin, TEXT("ModuleRelativePath"), TEXT("Public/PlayMontageCallbackProxy.h"));
				MetaData->SetValue(NewProp_OnInterrupted, TEXT("ModuleRelativePath"), TEXT("Public/PlayMontageCallbackProxy.h"));
				MetaData->SetValue(NewProp_OnInterrupted, TEXT("ToolTip"), TEXT("Called when Montage has been interrupted (or failed to play)"));
				MetaData->SetValue(NewProp_OnBlendOut, TEXT("ModuleRelativePath"), TEXT("Public/PlayMontageCallbackProxy.h"));
				MetaData->SetValue(NewProp_OnBlendOut, TEXT("ToolTip"), TEXT("Called when Montage starts blending out and is not interrupted"));
				MetaData->SetValue(NewProp_OnCompleted, TEXT("ModuleRelativePath"), TEXT("Public/PlayMontageCallbackProxy.h"));
				MetaData->SetValue(NewProp_OnCompleted, TEXT("ToolTip"), TEXT("Called when Montage finished playing and wasn't interrupted"));
#endif
			}
		}
		check(OuterClass->GetClass());
	...
	IMPLEMENT_CLASS(UPlayMontageCallbackProxy, 1559375352);
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_BlendSpacePlayer
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_BlendSpacePlayer()
	{
		...
		if (!ReturnStruct)
		{
			...
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bResetPlayTimeWhenBlendSpaceChanges, FAnimNode_BlendSpacePlayer, bool);
			UProperty* NewProp_bResetPlayTimeWhenBlendSpaceChanges = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bResetPlayTimeWhenBlendSpaceChanges"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bResetPlayTimeWhenBlendSpaceChanges, FAnimNode_BlendSpacePlayer), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bResetPlayTimeWhenBlendSpaceChanges, FAnimNode_BlendSpacePlayer), sizeof(bool), true);
			...
			MetaData->SetValue(NewProp_bResetPlayTimeWhenBlendSpaceChanges, TEXT("Category"), TEXT("Settings"));
			MetaData->SetValue(NewProp_bResetPlayTimeWhenBlendSpaceChanges, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_BlendSpacePlayer.h"));
			MetaData->SetValue(NewProp_bResetPlayTimeWhenBlendSpaceChanges, TEXT("PinHiddenByDefault"), TEXT(""));
			MetaData->SetValue(NewProp_bResetPlayTimeWhenBlendSpaceChanges, TEXT("ToolTip"), TEXT("Whether we should reset the current play time when the blend space changes"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_BlendSpacePlayer_CRC() { return 709829075U; }
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_AimOffsetLookAt
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_PivotSocketLocalTransform = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("PivotSocketLocalTransform"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(PivotSocketLocalTransform, FAnimNode_AimOffsetLookAt), 0x0010000000000000, Z_Construct_UScriptStruct_FTransform());
			UProperty* NewProp_PivotSocketBoneReference = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("PivotSocketBoneReference"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(PivotSocketBoneReference, FAnimNode_AimOffsetLookAt), 0x0010000000000000, Z_Construct_UScriptStruct_FBoneReference());
			UProperty* NewProp_SocketLocalTransform = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("SocketLocalTransform"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(SocketLocalTransform, FAnimNode_AimOffsetLookAt), 0x0010000000000000, Z_Construct_UScriptStruct_FTransform());
			UProperty* NewProp_SocketBoneReference = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("SocketBoneReference"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(SocketBoneReference, FAnimNode_AimOffsetLookAt), 0x0010000000000000, Z_Construct_UScriptStruct_FBoneReference());
			...
			UProperty* NewProp_PivotSocketName = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("PivotSocketName"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(PivotSocketName, FAnimNode_AimOffsetLookAt), 0x0010000000000005);
			...
			MetaData->SetValue(ReturnStruct, TEXT("ToolTip"), TEXT("@TODO: Comment"));
			MetaData->SetValue(NewProp_PivotSocketLocalTransform, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_AimOffsetLookAt.h"));
			MetaData->SetValue(NewProp_PivotSocketBoneReference, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_AimOffsetLookAt.h"));
			MetaData->SetValue(NewProp_SocketLocalTransform, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_AimOffsetLookAt.h"));
			MetaData->SetValue(NewProp_SocketBoneReference, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_AimOffsetLookAt.h"));
			...
			MetaData->SetValue(NewProp_PivotSocketName, TEXT("Category"), TEXT("LookAt"));
			MetaData->SetValue(NewProp_PivotSocketName, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_AimOffsetLookAt.h"));
			MetaData->SetValue(NewProp_PivotSocketName, TEXT("PinHiddenByDefault"), TEXT(""));
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_CRC() { return 1078478384U; }
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_LayeredBoneBlend
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_LayeredBoneBlend()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_VirtualBoneGuid = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("VirtualBoneGuid"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(VirtualBoneGuid, FAnimNode_LayeredBoneBlend), 0x0020080000000000, Z_Construct_UScriptStruct_FGuid());
			UProperty* NewProp_SkeletonGuid = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("SkeletonGuid"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(SkeletonGuid, FAnimNode_LayeredBoneBlend), 0x0020080000000000, Z_Construct_UScriptStruct_FGuid());
			UProperty* NewProp_PerBoneBlendWeights = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("PerBoneBlendWeights"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(PerBoneBlendWeights, FAnimNode_LayeredBoneBlend), 0x0020080000000000);
			UProperty* NewProp_PerBoneBlendWeights_Inner = new(EC_InternalUseOnlyConstructor, NewProp_PerBoneBlendWeights, TEXT("PerBoneBlendWeights"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FPerBoneBlendWeight());
			...
			MetaData->SetValue(NewProp_VirtualBoneGuid, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_LayeredBoneBlend.h"));
			MetaData->SetValue(NewProp_SkeletonGuid, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_LayeredBoneBlend.h"));
			MetaData->SetValue(NewProp_PerBoneBlendWeights, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_LayeredBoneBlend.h"));
			MetaData->SetValue(NewProp_PerBoneBlendWeights, TEXT("ToolTip"), TEXT("This is buffer to serialize blend weight data for each joints\nThis has to save with the corresponding SkeletopnGuid\nIf not, it will rebuild in run-time"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_LayeredBoneBlend_CRC() { return 1674837798U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EModifyCurveApplyMode(EModifyCurveApplyMode_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("EModifyCurveApplyMode"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_EModifyCurveApplyMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Emplace(TEXT("EModifyCurveApplyMode::Add"), 0);
			EnumNames.Emplace(TEXT("EModifyCurveApplyMode::Scale"), 1);
			EnumNames.Emplace(TEXT("EModifyCurveApplyMode::Blend"), 2);
			EnumNames.Emplace(TEXT("EModifyCurveApplyMode::EModifyCurveApplyMode_MAX"), 3);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EModifyCurveApplyMode_CRC() { return 624074743U; }
...
static UEnum* ERBFDistanceMethod_StaticEnum()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UEnum* Z_Construct_UEnum_AnimGraphRuntime_ERBFDistanceMethod();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ERBFDistanceMethod(ERBFDistanceMethod_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("ERBFDistanceMethod"), false, nullptr, nullptr);
	...
	{
		UPackage* Outer=Z_Construct_UPackage__Script_AnimGraphRuntime();
		extern uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_ERBFDistanceMethod_CRC();
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ERBFDistanceMethod"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ERBFDistanceMethod::Euclidean"), 0);
			EnumNames.Emplace(TEXT("ERBFDistanceMethod::Quaternion"), 1);
			EnumNames.Emplace(TEXT("ERBFDistanceMethod::SwingAngle"), 2);
			EnumNames.Emplace(TEXT("ERBFDistanceMethod::ERBFDistanceMethod_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("ERBFDistanceMethod");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("Euclidean.ToolTip"), TEXT("Standard n-dimensional distance measure"));
			MetaData->SetValue(ReturnEnum, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(ReturnEnum, TEXT("Quaternion.ToolTip"), TEXT("Treat inputs as quaternion"));
			MetaData->SetValue(ReturnEnum, TEXT("SwingAngle.ToolTip"), TEXT("Treat inputs as quaternion, and find distance between rotated TwistAxis direction"));
			MetaData->SetValue(ReturnEnum, TEXT("ToolTip"), TEXT("Method for determining distance from input to targets"));
#endif
		}
		return ReturnEnum;
	}
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_ERBFDistanceMethod_CRC() { return 3141898310U; }
static UEnum* ERBFFunctionType_StaticEnum()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UEnum* Z_Construct_UEnum_AnimGraphRuntime_ERBFFunctionType();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ERBFFunctionType(ERBFFunctionType_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("ERBFFunctionType"), false, nullptr, nullptr);
	...
	{
		UPackage* Outer=Z_Construct_UPackage__Script_AnimGraphRuntime();
		extern uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_ERBFFunctionType_CRC();
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ERBFFunctionType"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ERBFFunctionType::Gaussian"), 0);
			EnumNames.Emplace(TEXT("ERBFFunctionType::Exponential"), 1);
			EnumNames.Emplace(TEXT("ERBFFunctionType::Linear"), 2);
			EnumNames.Emplace(TEXT("ERBFFunctionType::Cubic"), 3);
			EnumNames.Emplace(TEXT("ERBFFunctionType::Quintic"), 4);
			EnumNames.Emplace(TEXT("ERBFFunctionType::ERBFFunctionType_MAX"), 5);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("ERBFFunctionType");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(ReturnEnum, TEXT("ToolTip"), TEXT("Function to use for each target falloff"));
#endif
		}
		return ReturnEnum;
	}
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_ERBFFunctionType_CRC() { return 2916557999U; }
class UScriptStruct* FRBFParams::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FRBFParams();
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFRBFParams
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FRBFParams()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("RBFParams"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FRBFParams>, EStructFlags(0x00000201));
			UProperty* NewProp_WeightThreshold = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("WeightThreshold"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(WeightThreshold, FRBFParams), 0x0010000000000001);
			UProperty* NewProp_TwistAxis = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TwistAxis"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(TwistAxis, FRBFParams), 0x0010000000000001, Z_Construct_UEnum_Engine_EBoneAxis());
			UProperty* NewProp_DistanceMethod = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("DistanceMethod"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(DistanceMethod, FRBFParams), 0x0010000000000001, Z_Construct_UEnum_AnimGraphRuntime_ERBFDistanceMethod());
			UProperty* NewProp_DistanceMethod_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_DistanceMethod, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			UProperty* NewProp_Function = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Function"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(Function, FRBFParams), 0x0010000000000001, Z_Construct_UEnum_AnimGraphRuntime_ERBFFunctionType());
			UProperty* NewProp_Function_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_Function, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			UProperty* NewProp_Radius = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Radius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Radius, FRBFParams), 0x0010000000000001);
			UProperty* NewProp_TargetDimensions = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TargetDimensions"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(TargetDimensions, FRBFParams), 0x0010000000000000);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(ReturnStruct, TEXT("ToolTip"), TEXT("Parameters used by RBF solver"));
			MetaData->SetValue(NewProp_WeightThreshold, TEXT("Category"), TEXT("RBFData"));
			MetaData->SetValue(NewProp_WeightThreshold, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(NewProp_WeightThreshold, TEXT("ToolTip"), TEXT("Weight below which we shouldn't bother returning a contribution from a target"));
			MetaData->SetValue(NewProp_TwistAxis, TEXT("Category"), TEXT("RBFData"));
			MetaData->SetValue(NewProp_TwistAxis, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(NewProp_TwistAxis, TEXT("ToolTip"), TEXT("Axis to use when DistanceMethod is SwingAngle"));
			MetaData->SetValue(NewProp_DistanceMethod, TEXT("Category"), TEXT("RBFData"));
			MetaData->SetValue(NewProp_DistanceMethod, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(NewProp_Function, TEXT("Category"), TEXT("RBFData"));
			MetaData->SetValue(NewProp_Function, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(NewProp_Radius, TEXT("Category"), TEXT("RBFData"));
			MetaData->SetValue(NewProp_Radius, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(NewProp_Radius, TEXT("ToolTip"), TEXT("Default radius for each target, scaled by per-Target ScaleFactor"));
			MetaData->SetValue(NewProp_TargetDimensions, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(NewProp_TargetDimensions, TEXT("ToolTip"), TEXT("How many dimensions input data has"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FRBFParams_CRC() { return 3962259575U; }
class UScriptStruct* FRBFTarget::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FRBFTarget();
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFRBFTarget
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FRBFTarget()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("RBFTarget"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), Z_Construct_UScriptStruct_FRBFEntry(), new UScriptStruct::TCppStructOps<FRBFTarget>, EStructFlags(0x00000201));
			UProperty* NewProp_CustomCurve = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("CustomCurve"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(CustomCurve, FRBFTarget), 0x0010000000000001, Z_Construct_UScriptStruct_FRichCurve());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bApplyCustomCurve, FRBFTarget, bool);
			UProperty* NewProp_bApplyCustomCurve = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bApplyCustomCurve"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bApplyCustomCurve, FRBFTarget), 0x0010000000000001, CPP_BOOL_PROPERTY_BITMASK(bApplyCustomCurve, FRBFTarget), sizeof(bool), true);
			UProperty* NewProp_ScaleFactor = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("ScaleFactor"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ScaleFactor, FRBFTarget), 0x0010000000000001);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(ReturnStruct, TEXT("ToolTip"), TEXT("Data about a particular target in the RBF, including scaling factor"));
			MetaData->SetValue(NewProp_CustomCurve, TEXT("Category"), TEXT("RBFData"));
			MetaData->SetValue(NewProp_CustomCurve, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(NewProp_CustomCurve, TEXT("ToolTip"), TEXT("Custom curve to apply to activation of this target, if bApplyCustomCurve is true"));
			MetaData->SetValue(NewProp_bApplyCustomCurve, TEXT("Category"), TEXT("RBFData"));
			MetaData->SetValue(NewProp_bApplyCustomCurve, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(NewProp_bApplyCustomCurve, TEXT("ToolTip"), TEXT("Whether we want to apply an additional custom curve when activating this target"));
			MetaData->SetValue(NewProp_ScaleFactor, TEXT("Category"), TEXT("RBFData"));
			MetaData->SetValue(NewProp_ScaleFactor, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(NewProp_ScaleFactor, TEXT("ToolTip"), TEXT("How large to scale"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FRBFTarget_CRC() { return 491931292U; }
class UScriptStruct* FRBFEntry::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FRBFEntry();
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFRBFEntry
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FRBFEntry()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("RBFEntry"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FRBFEntry>, EStructFlags(0x00000201));
			UProperty* NewProp_Values = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Values"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(Values, FRBFEntry), 0x0010000000000001);
			...
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(ReturnStruct, TEXT("ToolTip"), TEXT("Struct storing a particular entry within the RBF"));
			MetaData->SetValue(NewProp_Values, TEXT("Category"), TEXT("RBFData"));
			MetaData->SetValue(NewProp_Values, TEXT("ModuleRelativePath"), TEXT("Public/RBF/RBFSolver.h"));
			MetaData->SetValue(NewProp_Values, TEXT("ToolTip"), TEXT("Set of values for this target, size must be TargetDimensions"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FRBFEntry_CRC() { return 996516277U; }
static UEnum* EPoseDriverOutput_StaticEnum()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UEnum* Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverOutput();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EPoseDriverOutput(EPoseDriverOutput_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("EPoseDriverOutput"), false, nullptr, nullptr);
	...
	{
		UPackage* Outer=Z_Construct_UPackage__Script_AnimGraphRuntime();
		extern uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverOutput_CRC();
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EPoseDriverOutput"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EPoseDriverOutput::DrivePoses"), 0);
			EnumNames.Emplace(TEXT("EPoseDriverOutput::DriveCurves"), 1);
			EnumNames.Emplace(TEXT("EPoseDriverOutput::EPoseDriverOutput_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("EPoseDriverOutput");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("DriveCurves.ToolTip"), TEXT("Use the target's DrivenName to drive curves"));
			MetaData->SetValue(ReturnEnum, TEXT("DrivePoses.ToolTip"), TEXT("Use target's DrivenName to drive poses from the assigned PoseAsset"));
			MetaData->SetValue(ReturnEnum, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(ReturnEnum, TEXT("ToolTip"), TEXT("Options for what PoseDriver should be driving"));
#endif
		}
		return ReturnEnum;
	}
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverOutput_CRC() { return 3205800432U; }
static UEnum* EPoseDriverSource_StaticEnum()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UEnum* Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverSource();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EPoseDriverSource(EPoseDriverSource_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("EPoseDriverSource"), false, nullptr, nullptr);
	...
	{
		UPackage* Outer=Z_Construct_UPackage__Script_AnimGraphRuntime();
		extern uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverSource_CRC();
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EPoseDriverSource"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EPoseDriverSource::Rotation"), 0);
			EnumNames.Emplace(TEXT("EPoseDriverSource::Translation"), 1);
			EnumNames.Emplace(TEXT("EPoseDriverSource::EPoseDriverSource_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("EPoseDriverSource");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(ReturnEnum, TEXT("Rotation.ToolTip"), TEXT("Drive using rotation"));
			MetaData->SetValue(ReturnEnum, TEXT("ToolTip"), TEXT("Transform aspect used to drive interpolation"));
			MetaData->SetValue(ReturnEnum, TEXT("Translation.ToolTip"), TEXT("Driver using translation"));
#endif
		}
		return ReturnEnum;
	}
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverSource_CRC() { return 2099794630U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EPoseDriverType(EPoseDriverType_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("EPoseDriverType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EPoseDriverType::SwingAndTwist"), 0);
			EnumNames.Emplace(TEXT("EPoseDriverType::SwingOnly"), 1);
			EnumNames.Emplace(TEXT("EPoseDriverType::Translation"), 2);
			EnumNames.Emplace(TEXT("EPoseDriverType::EPoseDriverType_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverType_CRC() { return 1295685064U; }
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_PoseDriver
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_PoseDriver()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_RadialScaling = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RadialScaling"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(RadialScaling_DEPRECATED, FAnimNode_PoseDriver), 0x0010000020000000);
			UProperty* NewProp_Type = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Type"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(Type_DEPRECATED, FAnimNode_PoseDriver), 0x0010000020000000, Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverType());
			...
			UProperty* NewProp_TwistAxis = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TwistAxis"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(TwistAxis_DEPRECATED, FAnimNode_PoseDriver), 0x0010000020000000, Z_Construct_UEnum_Engine_EBoneAxis());
			UProperty* NewProp_SourceBone = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("SourceBone"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(SourceBone_DEPRECATED, FAnimNode_PoseDriver), 0x0010000020000000, Z_Construct_UScriptStruct_FBoneReference());
			UProperty* NewProp_PoseTargets = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("PoseTargets"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(PoseTargets, FAnimNode_PoseDriver), 0x0010000000000001);
			UProperty* NewProp_PoseTargets_Inner = new(EC_InternalUseOnlyConstructor, NewProp_PoseTargets, TEXT("PoseTargets"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FPoseDriverTarget());
			UProperty* NewProp_DriveOutput = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("DriveOutput"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(DriveOutput, FAnimNode_PoseDriver), 0x0010000000000001, Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverOutput());
			UProperty* NewProp_DriveOutput_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_DriveOutput, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			UProperty* NewProp_DriveSource = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("DriveSource"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(DriveSource, FAnimNode_PoseDriver), 0x0010000000000001, Z_Construct_UEnum_AnimGraphRuntime_EPoseDriverSource());
			UProperty* NewProp_DriveSource_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_DriveSource, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			UProperty* NewProp_RBFParams = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RBFParams"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(RBFParams, FAnimNode_PoseDriver), 0x0010000000000001, Z_Construct_UScriptStruct_FRBFParams());
			UProperty* NewProp_EvalSpaceBone = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("EvalSpaceBone"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(EvalSpaceBone, FAnimNode_PoseDriver), 0x0010000000000001, Z_Construct_UScriptStruct_FBoneReference());
			UProperty* NewProp_OnlyDriveBones = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("OnlyDriveBones"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(OnlyDriveBones, FAnimNode_PoseDriver), 0x0010000000000001);
			UProperty* NewProp_OnlyDriveBones_Inner = new(EC_InternalUseOnlyConstructor, NewProp_OnlyDriveBones, TEXT("OnlyDriveBones"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FBoneReference());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bOnlyDriveSelectedBones, FAnimNode_PoseDriver, bool);
			UProperty* NewProp_bOnlyDriveSelectedBones = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bOnlyDriveSelectedBones"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bOnlyDriveSelectedBones, FAnimNode_PoseDriver), 0x0010000000000001, CPP_BOOL_PROPERTY_BITMASK(bOnlyDriveSelectedBones, FAnimNode_PoseDriver), sizeof(bool), true);
			UProperty* NewProp_SourceBones = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("SourceBones"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(SourceBones, FAnimNode_PoseDriver), 0x0010000000000001);
			UProperty* NewProp_SourceBones_Inner = new(EC_InternalUseOnlyConstructor, NewProp_SourceBones, TEXT("SourceBones"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FBoneReference());
			...
			MetaData->SetValue(NewProp_SourceBone, TEXT("ToolTip"), TEXT("Deprecated"));
			MetaData->SetValue(NewProp_PoseTargets, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_PoseTargets, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_PoseTargets, TEXT("ToolTip"), TEXT("Targets used to compare with current pose and drive morphs/poses"));
			MetaData->SetValue(NewProp_DriveOutput, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_DriveOutput, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_DriveOutput, TEXT("ToolTip"), TEXT("Whether we should drive poses or curves"));
			MetaData->SetValue(NewProp_DriveSource, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_DriveSource, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_DriveSource, TEXT("ToolTip"), TEXT("Which part of the transform is read"));
			MetaData->SetValue(NewProp_RBFParams, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_RBFParams, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_RBFParams, TEXT("ShowOnlyInnerProperties"), TEXT(""));
			MetaData->SetValue(NewProp_RBFParams, TEXT("ToolTip"), TEXT("Parameters used by RBF solver"));
			MetaData->SetValue(NewProp_EvalSpaceBone, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_EvalSpaceBone, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_EvalSpaceBone, TEXT("ToolTip"), TEXT("Optional other bone space to use when reading SourceBone transform.\nIf not specified, we just use local space of SourceBone (ie relative to parent bone)"));
			MetaData->SetValue(NewProp_OnlyDriveBones, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_OnlyDriveBones, TEXT("EditCondition"), TEXT("bOnlyDriveSelectedBones"));
			MetaData->SetValue(NewProp_OnlyDriveBones, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_OnlyDriveBones, TEXT("ToolTip"), TEXT("If bFilterDrivenBones is specified, only these bones will be modified by this node"));
			MetaData->SetValue(NewProp_bOnlyDriveSelectedBones, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_bOnlyDriveSelectedBones, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_bOnlyDriveSelectedBones, TEXT("ToolTip"), TEXT("If we should filter bones to be driven using the DrivenBonesFilter array"));
			MetaData->SetValue(NewProp_SourceBones, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_SourceBones, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_SourceBones, TEXT("ToolTip"), TEXT("Bone to use for driving parameters based on its orientation"));
			MetaData->SetValue(NewProp_SourcePose, TEXT("Category"), TEXT("Links"));
			MetaData->SetValue(NewProp_SourcePose, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_SourcePose, TEXT("ToolTip"), TEXT("Bones to use for driving parameters based on their transform"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_PoseDriver_CRC() { return 1924109322U; }
class UScriptStruct* FPoseDriverTarget::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FPoseDriverTarget();
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFPoseDriverTarget
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FPoseDriverTarget()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PoseDriverTarget"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FPoseDriverTarget>, EStructFlags(0x00000201));
			UProperty* NewProp_DrivenName = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("DrivenName"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(DrivenName, FPoseDriverTarget), 0x0010000000000001);
			UProperty* NewProp_CustomCurve = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("CustomCurve"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(CustomCurve, FPoseDriverTarget), 0x0010000000000001, Z_Construct_UScriptStruct_FRichCurve());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bApplyCustomCurve, FPoseDriverTarget, bool);
			UProperty* NewProp_bApplyCustomCurve = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bApplyCustomCurve"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bApplyCustomCurve, FPoseDriverTarget), 0x0010000000000001, CPP_BOOL_PROPERTY_BITMASK(bApplyCustomCurve, FPoseDriverTarget), sizeof(bool), true);
			UProperty* NewProp_TargetScale = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TargetScale"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(TargetScale, FPoseDriverTarget), 0x0010000000000001);
			UProperty* NewProp_TargetRotation = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TargetRotation"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(TargetRotation, FPoseDriverTarget), 0x0010000000000001, Z_Construct_UScriptStruct_FRotator());
			UProperty* NewProp_BoneTransforms = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("BoneTransforms"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(BoneTransforms, FPoseDriverTarget), 0x0010000000000001);
			UProperty* NewProp_BoneTransforms_Inner = new(EC_InternalUseOnlyConstructor, NewProp_BoneTransforms, TEXT("BoneTransforms"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FPoseDriverTransform());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(ReturnStruct, TEXT("ToolTip"), TEXT("Information about each target in the PoseDriver"));
			MetaData->SetValue(NewProp_DrivenName, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_DrivenName, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_DrivenName, TEXT("ToolTip"), TEXT("Name of item to drive - depends on DriveOutput setting.\nIf DriveOutput is DrivePoses, this should be the name of a pose in the assigned PoseAsset\nIf DriveOutput is DriveCurves, this is the name of the curve (morph target, material param etc) to drive"));
			MetaData->SetValue(NewProp_CustomCurve, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_CustomCurve, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_CustomCurve, TEXT("ToolTip"), TEXT("Custom curve mapping to apply if bApplyCustomCurve is true"));
			MetaData->SetValue(NewProp_bApplyCustomCurve, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_bApplyCustomCurve, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_bApplyCustomCurve, TEXT("ToolTip"), TEXT("If we should apply a custom curve mapping to how this target activates"));
			MetaData->SetValue(NewProp_TargetScale, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_TargetScale, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_TargetScale, TEXT("ToolTip"), TEXT("Scale applied to this target's function - a larger value will activate this target sooner"));
			MetaData->SetValue(NewProp_TargetRotation, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_TargetRotation, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_TargetRotation, TEXT("ToolTip"), TEXT("Rotation of this target"));
			MetaData->SetValue(NewProp_BoneTransforms, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_BoneTransforms, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_BoneTransforms, TEXT("ToolTip"), TEXT("Translation of this target"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FPoseDriverTarget_CRC() { return 3390713711U; }
class UScriptStruct* FPoseDriverTransform::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FPoseDriverTransform();
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFPoseDriverTransform
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FPoseDriverTransform()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PoseDriverTransform"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FPoseDriverTransform>, EStructFlags(0x00000001));
			UProperty* NewProp_TargetRotation = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TargetRotation"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(TargetRotation, FPoseDriverTransform), 0x0010000000000001, Z_Construct_UScriptStruct_FRotator());
			UProperty* NewProp_TargetTranslation = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TargetTranslation"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(TargetTranslation, FPoseDriverTransform), 0x0010000000000001, Z_Construct_UScriptStruct_FVector());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(ReturnStruct, TEXT("ToolTip"), TEXT("Translation and rotation for a particular bone at a particular target"));
			MetaData->SetValue(NewProp_TargetRotation, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_TargetRotation, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_TargetRotation, TEXT("ToolTip"), TEXT("Rotation of this target"));
			MetaData->SetValue(NewProp_TargetTranslation, TEXT("Category"), TEXT("PoseDriver"));
			MetaData->SetValue(NewProp_TargetTranslation, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_PoseDriver.h"));
			MetaData->SetValue(NewProp_TargetTranslation, TEXT("ToolTip"), TEXT("Translation of this target"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FPoseDriverTransform_CRC() { return 583347452U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESnapshotSourceMode(ESnapshotSourceMode_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("ESnapshotSourceMode"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_ESnapshotSourceMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESnapshotSourceMode::NamedSnapshot"), 0);
			EnumNames.Emplace(TEXT("ESnapshotSourceMode::SnapshotPin"), 1);
			EnumNames.Emplace(TEXT("ESnapshotSourceMode::ESnapshotSourceMode_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_ESnapshotSourceMode_CRC() { return 596173522U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ERefPoseType(ERefPoseType_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("ERefPoseType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_ERefPoseType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EIT_LocalSpace"), 0);
			EnumNames.Emplace(TEXT("EIT_Additive"), 1);
			EnumNames.Emplace(TEXT("EIT_MAX"), 2);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_ERefPoseType_CRC() { return 75191715U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESequenceEvalReinit(ESequenceEvalReinit_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("ESequenceEvalReinit"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_ESequenceEvalReinit()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESequenceEvalReinit::NoReset"), 0);
			EnumNames.Emplace(TEXT("ESequenceEvalReinit::StartPosition"), 1);
			EnumNames.Emplace(TEXT("ESequenceEvalReinit::ExplicitTime"), 2);
			EnumNames.Emplace(TEXT("ESequenceEvalReinit::ESequenceEvalReinit_MAX"), 3);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_ESequenceEvalReinit_CRC() { return 1312722032U; }
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_SequenceEvaluator
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_SequenceEvaluator()
	{
		...
		if (!ReturnStruct)
		{
			...
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bShouldLoop, FAnimNode_SequenceEvaluator, bool);
			UProperty* NewProp_bShouldLoop = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bShouldLoop"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bShouldLoop, FAnimNode_SequenceEvaluator), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bShouldLoop, FAnimNode_SequenceEvaluator), sizeof(bool), true);
			...
			MetaData->SetValue(NewProp_bShouldLoop, TEXT("Category"), TEXT("Settings"));
			MetaData->SetValue(NewProp_bShouldLoop, TEXT("ModuleRelativePath"), TEXT("Public/AnimNodes/AnimNode_SequenceEvaluator.h"));
			MetaData->SetValue(NewProp_bShouldLoop, TEXT("PinHiddenByDefault"), TEXT(""));
			MetaData->SetValue(NewProp_bShouldLoop, TEXT("ToolTip"), TEXT("This only works if bTeleportToExplicitTime is false OR this node is set to use SyncGroup"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_SequenceEvaluator_CRC() { return 4910458U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESphericalLimitType(ESphericalLimitType_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("ESphericalLimitType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_ESphericalLimitType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESphericalLimitType::Inner"), 0);
			EnumNames.Emplace(TEXT("ESphericalLimitType::Outer"), 1);
			EnumNames.Emplace(TEXT("ESphericalLimitType::ESphericalLimitType_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_ESphericalLimitType_CRC() { return 104605414U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_AnimPhysSimSpaceType(AnimPhysSimSpaceType_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("AnimPhysSimSpaceType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_AnimPhysSimSpaceType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("AnimPhysSimSpaceType::Component"), 0);
			EnumNames.Emplace(TEXT("AnimPhysSimSpaceType::Actor"), 1);
			EnumNames.Emplace(TEXT("AnimPhysSimSpaceType::World"), 2);
			EnumNames.Emplace(TEXT("AnimPhysSimSpaceType::RootRelative"), 3);
			EnumNames.Emplace(TEXT("AnimPhysSimSpaceType::BoneRelative"), 4);
			EnumNames.Emplace(TEXT("AnimPhysSimSpaceType::AnimPhysSimSpaceType_MAX"), 5);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_AnimPhysSimSpaceType_CRC() { return 2697371195U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_AnimPhysLinearConstraintType(AnimPhysLinearConstraintType_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("AnimPhysLinearConstraintType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_AnimPhysLinearConstraintType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("AnimPhysLinearConstraintType::Free"), 0);
			EnumNames.Emplace(TEXT("AnimPhysLinearConstraintType::Limited"), 1);
			EnumNames.Emplace(TEXT("AnimPhysLinearConstraintType::AnimPhysLinearConstraintType_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_AnimPhysLinearConstraintType_CRC() { return 2713938653U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_AnimPhysAngularConstraintType(AnimPhysAngularConstraintType_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("AnimPhysAngularConstraintType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_AnimPhysAngularConstraintType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("AnimPhysAngularConstraintType::Angular"), 0);
			EnumNames.Emplace(TEXT("AnimPhysAngularConstraintType::Cone"), 1);
			EnumNames.Emplace(TEXT("AnimPhysAngularConstraintType::AnimPhysAngularConstraintType_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_AnimPhysAngularConstraintType_CRC() { return 3223473395U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EDrivenDestinationMode(EDrivenDestinationMode_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("EDrivenDestinationMode"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_EDrivenDestinationMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EDrivenDestinationMode::Bone"), 0);
			EnumNames.Emplace(TEXT("EDrivenDestinationMode::MorphTarget"), 1);
			EnumNames.Emplace(TEXT("EDrivenDestinationMode::MaterialParameter"), 2);
			EnumNames.Emplace(TEXT("EDrivenDestinationMode::EDrivenDestinationMode_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EDrivenDestinationMode_CRC() { return 2481386661U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EDrivenBoneModificationMode(EDrivenBoneModificationMode_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("EDrivenBoneModificationMode"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_EDrivenBoneModificationMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EDrivenBoneModificationMode::AddToInput"), 0);
			EnumNames.Emplace(TEXT("EDrivenBoneModificationMode::ReplaceComponent"), 1);
			EnumNames.Emplace(TEXT("EDrivenBoneModificationMode::AddToRefPose"), 2);
			EnumNames.Emplace(TEXT("EDrivenBoneModificationMode::EDrivenBoneModificationMode_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EDrivenBoneModificationMode_CRC() { return 2552008966U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EComponentType(EComponentType_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("EComponentType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_EComponentType()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EComponentType::None"), 0);
			EnumNames.Emplace(TEXT("EComponentType::TranslationX"), 1);
			EnumNames.Emplace(TEXT("EComponentType::TranslationY"), 2);
			EnumNames.Emplace(TEXT("EComponentType::TranslationZ"), 3);
			EnumNames.Emplace(TEXT("EComponentType::RotationX"), 4);
			EnumNames.Emplace(TEXT("EComponentType::RotationY"), 5);
			EnumNames.Emplace(TEXT("EComponentType::RotationZ"), 6);
			EnumNames.Emplace(TEXT("EComponentType::Scale"), 7);
			EnumNames.Emplace(TEXT("EComponentType::ScaleX"), 8);
			EnumNames.Emplace(TEXT("EComponentType::ScaleY"), 9);
			EnumNames.Emplace(TEXT("EComponentType::ScaleZ"), 10);
			EnumNames.Emplace(TEXT("EComponentType::EComponentType_MAX"), 11);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EComponentType_CRC() { return 3098649666U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_CopyBoneDeltaMode(CopyBoneDeltaMode_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("CopyBoneDeltaMode"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_CopyBoneDeltaMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("CopyBoneDeltaMode::Accumulate"), 0);
			EnumNames.Emplace(TEXT("CopyBoneDeltaMode::Copy"), 1);
			EnumNames.Emplace(TEXT("CopyBoneDeltaMode::CopyBoneDeltaMode_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_CopyBoneDeltaMode_CRC() { return 418236691U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EInterpolationBlend(EInterpolationBlend_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("EInterpolationBlend"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_EInterpolationBlend()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EInterpolationBlend::Linear"), 0);
			EnumNames.Emplace(TEXT("EInterpolationBlend::Cubic"), 1);
			EnumNames.Emplace(TEXT("EInterpolationBlend::Sinusoidal"), 2);
			EnumNames.Emplace(TEXT("EInterpolationBlend::EaseInOutExponent2"), 3);
			EnumNames.Emplace(TEXT("EInterpolationBlend::EaseInOutExponent3"), 4);
			EnumNames.Emplace(TEXT("EInterpolationBlend::EaseInOutExponent4"), 5);
			EnumNames.Emplace(TEXT("EInterpolationBlend::EaseInOutExponent5"), 6);
			EnumNames.Emplace(TEXT("EInterpolationBlend::MAX"), 7);
			EnumNames.Emplace(TEXT("EInterpolationBlend::EInterpolationBlend_MAX"), 8);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EInterpolationBlend_CRC() { return 2750932588U; }
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_LookAt
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_LookAt()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_LookUp_Axis = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("LookUp_Axis"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(LookUp_Axis, FAnimNode_LookAt), 0x0010000000000005, Z_Construct_UScriptStruct_FAxis());
			UProperty* NewProp_CustomLookUpAxis = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("CustomLookUpAxis"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(CustomLookUpAxis_DEPRECATED, FAnimNode_LookAt), 0x0010000020000000, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_LookUpAxis = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("LookUpAxis"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(LookUpAxis_DEPRECATED, FAnimNode_LookAt), 0x0010000020000000, Z_Construct_UEnum_Engine_EAxisOption());
			...
			UProperty* NewProp_LookAt_Axis = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("LookAt_Axis"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(LookAt_Axis, FAnimNode_LookAt), 0x0010000000000005, Z_Construct_UScriptStruct_FAxis());
			UProperty* NewProp_CustomLookAtAxis = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("CustomLookAtAxis"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(CustomLookAtAxis_DEPRECATED, FAnimNode_LookAt), 0x0010000020000000, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_LookAtAxis = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("LookAtAxis"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(LookAtAxis_DEPRECATED, FAnimNode_LookAt), 0x0010000020000000, Z_Construct_UEnum_Engine_EAxisOption());
			...
			MetaData->SetValue(NewProp_LookUp_Axis, TEXT("Category"), TEXT("SkeletalControl"));
			MetaData->SetValue(NewProp_LookUp_Axis, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_LookAt.h"));
			MetaData->SetValue(NewProp_CustomLookUpAxis, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_LookAt.h"));
			MetaData->SetValue(NewProp_CustomLookUpAxis, TEXT("ToolTip"), TEXT("Custom look up axis in local space. Only used if LookUpAxis==EAxisOption::Custom"));
			...
			MetaData->SetValue(NewProp_LookAt_Axis, TEXT("Category"), TEXT("SkeletalControl"));
			MetaData->SetValue(NewProp_LookAt_Axis, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_LookAt.h"));
			MetaData->SetValue(NewProp_CustomLookAtAxis, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_LookAt.h"));
			MetaData->SetValue(NewProp_CustomLookAtAxis, TEXT("ToolTip"), TEXT("Custom look up axis in local space. Only used if LookAtAxis==EAxisOption::Custom"));
			...
			MetaData->SetValue(NewProp_LookAtLocation, TEXT("ToolTip"), TEXT("Target Offset. It's in world space if LookAtBone is empty or it is based on LookAtBone or LookAtSocket in their local space"));
			...
			MetaData->SetValue(NewProp_LookAtSocket, TEXT("ToolTip"), TEXT("Target socket to look at. Used if LookAtBone is empty. - You can use  LookAtLocation if you need offset from this point. That location will be used in their local space. *"));
			...
			MetaData->SetValue(NewProp_LookAtBone, TEXT("ToolTip"), TEXT("Target Bone to look at - You can use  LookAtLocation if you need offset from this point. That location will be used in their local space. *"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_LookAt_CRC() { return 3267379921U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EBoneModificationMode(EBoneModificationMode_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("EBoneModificationMode"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_AnimGraphRuntime_EBoneModificationMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("BMM_Ignore"), 0);
			EnumNames.Emplace(TEXT("BMM_Replace"), 1);
			EnumNames.Emplace(TEXT("BMM_Additive"), 2);
			EnumNames.Emplace(TEXT("BMM_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Regular);
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EBoneModificationMode_CRC() { return 2311330160U; }
...
class UScriptStruct* FAnimNode_ScaleChainLength::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength();
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_ScaleChainLength
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("AnimNode_ScaleChainLength"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), Z_Construct_UScriptStruct_FAnimNode_Base(), new UScriptStruct::TCppStructOps<FAnimNode_ScaleChainLength>, EStructFlags(0x00000201));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bBoneIndicesCached, FAnimNode_ScaleChainLength, bool);
			UProperty* NewProp_bBoneIndicesCached = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bBoneIndicesCached"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bBoneIndicesCached, FAnimNode_ScaleChainLength), 0x0010000000002000, CPP_BOOL_PROPERTY_BITMASK(bBoneIndicesCached, FAnimNode_ScaleChainLength), sizeof(bool), true);
			UProperty* NewProp_AlphaScaleBias = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("AlphaScaleBias"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(AlphaScaleBias, FAnimNode_ScaleChainLength), 0x0010000000000005, Z_Construct_UScriptStruct_FInputScaleBias());
			UProperty* NewProp_Alpha = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Alpha"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Alpha, FAnimNode_ScaleChainLength), 0x0010000000000005);
			UProperty* NewProp_TargetLocation = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TargetLocation"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(TargetLocation, FAnimNode_ScaleChainLength), 0x0010000000000005, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_ChainEndBone = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("ChainEndBone"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ChainEndBone, FAnimNode_ScaleChainLength), 0x0010000000000005, Z_Construct_UScriptStruct_FBoneReference());
			UProperty* NewProp_ChainStartBone = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("ChainStartBone"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ChainStartBone, FAnimNode_ScaleChainLength), 0x0010000000000005, Z_Construct_UScriptStruct_FBoneReference());
			UProperty* NewProp_DefaultChainLength = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("DefaultChainLength"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(DefaultChainLength, FAnimNode_ScaleChainLength), 0x0010000000000005);
			UProperty* NewProp_InputPose = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("InputPose"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(InputPose, FAnimNode_ScaleChainLength), 0x0010000000000005, Z_Construct_UScriptStruct_FPoseLink());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_ScaleChainLength.h"));
			MetaData->SetValue(NewProp_bBoneIndicesCached, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_ScaleChainLength.h"));
			MetaData->SetValue(NewProp_AlphaScaleBias, TEXT("Category"), TEXT("Settings"));
			MetaData->SetValue(NewProp_AlphaScaleBias, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_ScaleChainLength.h"));
			MetaData->SetValue(NewProp_Alpha, TEXT("Category"), TEXT("Settings"));
			MetaData->SetValue(NewProp_Alpha, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_ScaleChainLength.h"));
			MetaData->SetValue(NewProp_Alpha, TEXT("PinShownByDefault"), TEXT(""));
			MetaData->SetValue(NewProp_TargetLocation, TEXT("Category"), TEXT("ScaleChainLength"));
			MetaData->SetValue(NewProp_TargetLocation, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_ScaleChainLength.h"));
			MetaData->SetValue(NewProp_TargetLocation, TEXT("PinShownByDefault"), TEXT(""));
			MetaData->SetValue(NewProp_ChainEndBone, TEXT("Category"), TEXT("ScaleChainLength"));
			MetaData->SetValue(NewProp_ChainEndBone, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_ScaleChainLength.h"));
			MetaData->SetValue(NewProp_ChainStartBone, TEXT("Category"), TEXT("ScaleChainLength"));
			MetaData->SetValue(NewProp_ChainStartBone, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_ScaleChainLength.h"));
			MetaData->SetValue(NewProp_DefaultChainLength, TEXT("Category"), TEXT("ScaleChainLength"));
			MetaData->SetValue(NewProp_DefaultChainLength, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_ScaleChainLength.h"));
			MetaData->SetValue(NewProp_DefaultChainLength, TEXT("PinHiddenByDefault"), TEXT(""));
			MetaData->SetValue(NewProp_DefaultChainLength, TEXT("ToolTip"), TEXT("Default chain length, as animated."));
			MetaData->SetValue(NewProp_InputPose, TEXT("Category"), TEXT("Links"));
			MetaData->SetValue(NewProp_InputPose, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_ScaleChainLength.h"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_CRC() { return 2181263719U; }
static UEnum* ESplineBoneAxis_StaticEnum()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UEnum* Z_Construct_UEnum_AnimGraphRuntime_ESplineBoneAxis();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESplineBoneAxis(ESplineBoneAxis_StaticEnum, TEXT("/Script/AnimGraphRuntime"), TEXT("ESplineBoneAxis"), false, nullptr, nullptr);
	...
	{
		UPackage* Outer=Z_Construct_UPackage__Script_AnimGraphRuntime();
		extern uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_ESplineBoneAxis_CRC();
		...
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ESplineBoneAxis"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESplineBoneAxis::X"), 1);
			EnumNames.Emplace(TEXT("ESplineBoneAxis::Y"), 2);
			EnumNames.Emplace(TEXT("ESplineBoneAxis::Z"), 3);
			EnumNames.Emplace(TEXT("ESplineBoneAxis::ESplineBoneAxis_MAX"), 4);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("ESplineBoneAxis");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(ReturnEnum, TEXT("ToolTip"), TEXT("The different axes we can align our bones to.\nNote that the values are set to match up with EAxis (but without 'None')"));
#endif
		}
		return ReturnEnum;
	}
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_ESplineBoneAxis_CRC() { return 1427860342U; }
class UScriptStruct* FAnimNode_SplineIK::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_SplineIK();
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_SplineIK
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_SplineIK()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("AnimNode_SplineIK"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), Z_Construct_UScriptStruct_FAnimNode_SkeletalControlBase(), new UScriptStruct::TCppStructOps<FAnimNode_SplineIK>, EStructFlags(0x00000201));
			UProperty* NewProp_CachedOffsetRotations = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("CachedOffsetRotations"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(CachedOffsetRotations, FAnimNode_SplineIK), 0x0040000000000000);
			UProperty* NewProp_CachedOffsetRotations_Inner = new(EC_InternalUseOnlyConstructor, NewProp_CachedOffsetRotations, TEXT("CachedOffsetRotations"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FQuat());
			UProperty* NewProp_CachedBoneLengths = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("CachedBoneLengths"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(CachedBoneLengths, FAnimNode_SplineIK), 0x0040000000000000);
			UProperty* NewProp_CachedBoneLengths_Inner = new(EC_InternalUseOnlyConstructor, NewProp_CachedBoneLengths, TEXT("CachedBoneLengths"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			UProperty* NewProp_CachedBoneReferences = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("CachedBoneReferences"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(CachedBoneReferences, FAnimNode_SplineIK), 0x0040000000000000);
			UProperty* NewProp_CachedBoneReferences_Inner = new(EC_InternalUseOnlyConstructor, NewProp_CachedBoneReferences, TEXT("CachedBoneReferences"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FSplineIKCachedBoneData());
			UProperty* NewProp_OriginalSplineLength = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("OriginalSplineLength"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(OriginalSplineLength, FAnimNode_SplineIK), 0x0040000000000000);
			UProperty* NewProp_BoneSpline = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("BoneSpline"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(BoneSpline, FAnimNode_SplineIK), 0x0040000000000000, Z_Construct_UScriptStruct_FSplineCurves());
			UProperty* NewProp_Offset = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Offset"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Offset, FAnimNode_SplineIK), 0x0010000000000005);
			UProperty* NewProp_Stretch = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Stretch"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Stretch, FAnimNode_SplineIK), 0x0010000000000005);
			UProperty* NewProp_TwistBlend = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TwistBlend"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(TwistBlend, FAnimNode_SplineIK), 0x0010000000000005, Z_Construct_UScriptStruct_FAlphaBlend());
			UProperty* NewProp_TwistEnd = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TwistEnd"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(TwistEnd, FAnimNode_SplineIK), 0x0010000000000005);
			UProperty* NewProp_TwistStart = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("TwistStart"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(TwistStart, FAnimNode_SplineIK), 0x0010000000000005);
			UProperty* NewProp_Roll = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Roll"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Roll, FAnimNode_SplineIK), 0x0010000000000005);
			UProperty* NewProp_ControlPoints = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("ControlPoints"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(ControlPoints, FAnimNode_SplineIK), 0x0010000000000045);
			UProperty* NewProp_ControlPoints_Inner = new(EC_InternalUseOnlyConstructor, NewProp_ControlPoints, TEXT("ControlPoints"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FTransform());
			UProperty* NewProp_PointCount = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("PointCount"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(PointCount, FAnimNode_SplineIK), 0x0010000000000005);
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAutoCalculateSpline, FAnimNode_SplineIK, bool);
			UProperty* NewProp_bAutoCalculateSpline = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bAutoCalculateSpline"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAutoCalculateSpline, FAnimNode_SplineIK), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bAutoCalculateSpline, FAnimNode_SplineIK), sizeof(bool), true);
			UProperty* NewProp_BoneAxis = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("BoneAxis"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(BoneAxis, FAnimNode_SplineIK), 0x0010000000000005, Z_Construct_UEnum_AnimGraphRuntime_ESplineBoneAxis());
			UProperty* NewProp_BoneAxis_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_BoneAxis, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
			UProperty* NewProp_EndBone = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("EndBone"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(EndBone, FAnimNode_SplineIK), 0x0010000000000005, Z_Construct_UScriptStruct_FBoneReference());
			UProperty* NewProp_StartBone = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("StartBone"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(StartBone, FAnimNode_SplineIK), 0x0010000000000005, Z_Construct_UScriptStruct_FBoneReference());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_CachedOffsetRotations, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_CachedOffsetRotations, TEXT("ToolTip"), TEXT("Cached bone offset rotations. Same size as CachedBoneReferences"));
			MetaData->SetValue(NewProp_CachedBoneLengths, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_CachedBoneLengths, TEXT("ToolTip"), TEXT("Cached bone lengths. Same size as CachedBoneReferences"));
			MetaData->SetValue(NewProp_CachedBoneReferences, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_CachedBoneReferences, TEXT("ToolTip"), TEXT("Cached data for bones in the IK chain, from start to end"));
			MetaData->SetValue(NewProp_OriginalSplineLength, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_OriginalSplineLength, TEXT("ToolTip"), TEXT("Cached spline length from when the spline was originally applied to the skeleton"));
			MetaData->SetValue(NewProp_BoneSpline, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_BoneSpline, TEXT("ToolTip"), TEXT("Spline we maintain internally"));
			MetaData->SetValue(NewProp_Offset, TEXT("Category"), TEXT("Parameters"));
			MetaData->SetValue(NewProp_Offset, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_Offset, TEXT("PinHiddenByDefault"), TEXT(""));
			MetaData->SetValue(NewProp_Offset, TEXT("ToolTip"), TEXT("The distance along the spline from the start from which bones are constrained"));
			MetaData->SetValue(NewProp_Stretch, TEXT("Category"), TEXT("Parameters"));
			MetaData->SetValue(NewProp_Stretch, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_Stretch, TEXT("PinHiddenByDefault"), TEXT(""));
			MetaData->SetValue(NewProp_Stretch, TEXT("ToolTip"), TEXT("The maximum stretch allowed when fitting bones to the spline. 0.0 means bones do not stretch their length,\n1.0 means bones stretch to the length of the spline"));
			MetaData->SetValue(NewProp_TwistBlend, TEXT("Category"), TEXT("Parameters"));
			MetaData->SetValue(NewProp_TwistBlend, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_TwistBlend, TEXT("ToolTip"), TEXT("How to interpolate twist along the length of the spline"));
			MetaData->SetValue(NewProp_TwistEnd, TEXT("Category"), TEXT("Parameters"));
			MetaData->SetValue(NewProp_TwistEnd, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_TwistEnd, TEXT("PinHiddenByDefault"), TEXT(""));
			MetaData->SetValue(NewProp_TwistEnd, TEXT("ToolTip"), TEXT("The twist of the end bone. Twist is interpolated along the spline according to Twist Blend."));
			MetaData->SetValue(NewProp_TwistStart, TEXT("Category"), TEXT("Parameters"));
			MetaData->SetValue(NewProp_TwistStart, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_TwistStart, TEXT("PinHiddenByDefault"), TEXT(""));
			MetaData->SetValue(NewProp_TwistStart, TEXT("ToolTip"), TEXT("The twist of the start bone. Twist is interpolated along the spline according to Twist Blend."));
			MetaData->SetValue(NewProp_Roll, TEXT("Category"), TEXT("Parameters"));
			MetaData->SetValue(NewProp_Roll, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_Roll, TEXT("PinHiddenByDefault"), TEXT(""));
			MetaData->SetValue(NewProp_Roll, TEXT("ToolTip"), TEXT("Overall roll of the spline, applied on top of other rotations along the direction of the spline"));
			MetaData->SetValue(NewProp_ControlPoints, TEXT("Category"), TEXT("Parameters"));
			MetaData->SetValue(NewProp_ControlPoints, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_ControlPoints, TEXT("PinHiddenByDefault"), TEXT(""));
			MetaData->SetValue(NewProp_ControlPoints, TEXT("ToolTip"), TEXT("Transforms applied to spline points *"));
			MetaData->SetValue(NewProp_PointCount, TEXT("Category"), TEXT("Parameters"));
			MetaData->SetValue(NewProp_PointCount, TEXT("ClampMin"), TEXT("2"));
			MetaData->SetValue(NewProp_PointCount, TEXT("EditCondition"), TEXT("!bAutoCalculateSpline"));
			MetaData->SetValue(NewProp_PointCount, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_PointCount, TEXT("ToolTip"), TEXT("The number of points in the spline if we are not auto-calculating"));
			MetaData->SetValue(NewProp_PointCount, TEXT("UIMin"), TEXT("2"));
			MetaData->SetValue(NewProp_bAutoCalculateSpline, TEXT("Category"), TEXT("Parameters"));
			MetaData->SetValue(NewProp_bAutoCalculateSpline, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_bAutoCalculateSpline, TEXT("ToolTip"), TEXT("The number of points in the spline if we are specifying it directly"));
			MetaData->SetValue(NewProp_BoneAxis, TEXT("Category"), TEXT("Parameters"));
			MetaData->SetValue(NewProp_BoneAxis, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_BoneAxis, TEXT("ToolTip"), TEXT("Axis of the controlled bone (ie the direction of the spline) to use as the direction for the curve."));
			MetaData->SetValue(NewProp_EndBone, TEXT("Category"), TEXT("Parameters"));
			MetaData->SetValue(NewProp_EndBone, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_EndBone, TEXT("ToolTip"), TEXT("Name of bone at the end of the spline chain. Bones after this will not be altered by the controller."));
			MetaData->SetValue(NewProp_StartBone, TEXT("Category"), TEXT("Parameters"));
			MetaData->SetValue(NewProp_StartBone, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_StartBone, TEXT("ToolTip"), TEXT("Name of root bone from which the spline extends *"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_SplineIK_CRC() { return 1517820947U; }
class UScriptStruct* FSplineIKCachedBoneData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ANIMGRAPHRUNTIME_API class UScriptStruct* Z_Construct_UScriptStruct_FSplineIKCachedBoneData();
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFSplineIKCachedBoneData
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSplineIKCachedBoneData()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SplineIKCachedBoneData"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FSplineIKCachedBoneData>, EStructFlags(0x00000001));
			UProperty* NewProp_RefSkeletonIndex = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefSkeletonIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(RefSkeletonIndex, FSplineIKCachedBoneData), 0x0010000000000000);
			UProperty* NewProp_Bone = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Bone"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Bone, FSplineIKCachedBoneData), 0x0010000000000000, Z_Construct_UScriptStruct_FBoneReference());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(ReturnStruct, TEXT("ToolTip"), TEXT("Data cached per bone in the chain"));
			MetaData->SetValue(NewProp_RefSkeletonIndex, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_RefSkeletonIndex, TEXT("ToolTip"), TEXT("Index of the bone in the reference skeleton"));
			MetaData->SetValue(NewProp_Bone, TEXT("ModuleRelativePath"), TEXT("Public/BoneControllers/AnimNode_SplineIK.h"));
			MetaData->SetValue(NewProp_Bone, TEXT("ToolTip"), TEXT("The bone we refer to"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FSplineIKCachedBoneData_CRC() { return 615378356U; }
