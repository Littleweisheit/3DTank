...
#define Engine_Source_Runtime_Engine_Classes_AI_Navigation_NavigationSystem_h_154_RPC_WRAPPERS \
 ...
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=UNavigationSystem::K2_GetRandomPointInNavigableRadius(Z_Param_WorldContext,Z_Param_Out_Origin,Z_Param_Out_RandomLocation,Z_Param_Radius,Z_Param_NavData,Z_Param_FilterClass); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=UNavigationSystem::K2_GetRandomReachablePointInRadius(Z_Param_WorldContext,Z_Param_Out_Origin,Z_Param_Out_RandomLocation,Z_Param_Radius,Z_Param_NavData,Z_Param_FilterClass); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(bool*)Z_Param__Result=UNavigationSystem::K2_ProjectPointToNavigation(Z_Param_WorldContext,Z_Param_Out_Point,Z_Param_Out_ProjectedLocation,Z_Param_NavData,Z_Param_FilterClass,Z_Param_QueryExtent); \
		P_NATIVE_END; \
	} \
 \
