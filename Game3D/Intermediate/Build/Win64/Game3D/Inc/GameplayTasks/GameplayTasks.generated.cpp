...
// Cross Module References
	...
	GAMEPLAYTASKS_API class UFunction* Z_Construct_UDelegateFunction_UGameplayTask_TimeLimitedExecution_TaskFinishDelegate__DelegateSignature();
	GAMEPLAYTASKS_API class UClass* Z_Construct_UClass_UGameplayTask_TimeLimitedExecution_NoRegister();
	GAMEPLAYTASKS_API class UClass* Z_Construct_UClass_UGameplayTask_TimeLimitedExecution();
	...
	UClass* Z_Construct_UClass_UGameplayTaskOwnerInterface()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<IGameplayTaskOwnerInterface> > StaticCppClassTypeInfo;
	...
	IMPLEMENT_CLASS(UGameplayTaskOwnerInterface, 2747367848);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ETaskResourceOverlapPolicy(ETaskResourceOverlapPolicy_StaticEnum, TEXT("/Script/GameplayTasks"), TEXT("ETaskResourceOverlapPolicy"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_GameplayTasks_ETaskResourceOverlapPolicy()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Emplace(TEXT("ETaskResourceOverlapPolicy::StartOnTop"), 0);
			EnumNames.Emplace(TEXT("ETaskResourceOverlapPolicy::StartAtEnd"), 1);
			EnumNames.Emplace(TEXT("ETaskResourceOverlapPolicy::ETaskResourceOverlapPolicy_MAX"), 2);
	...
	uint32 Get_Z_Construct_UEnum_GameplayTasks_ETaskResourceOverlapPolicy_CRC() { return 2144530588U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EGameplayTaskState(EGameplayTaskState_StaticEnum, TEXT("/Script/GameplayTasks"), TEXT("EGameplayTaskState"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_GameplayTasks_EGameplayTaskState()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EGameplayTaskState::Uninitialized"), 0);
			EnumNames.Emplace(TEXT("EGameplayTaskState::AwaitingActivation"), 1);
			EnumNames.Emplace(TEXT("EGameplayTaskState::Paused"), 2);
			EnumNames.Emplace(TEXT("EGameplayTaskState::Active"), 3);
			EnumNames.Emplace(TEXT("EGameplayTaskState::Finished"), 4);
			EnumNames.Emplace(TEXT("EGameplayTaskState::EGameplayTaskState_MAX"), 5);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_GameplayTasks_EGameplayTaskState_CRC() { return 3144596467U; }
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				...
				UProperty* NewProp_ResourceOverlapPolicy = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ResourceOverlapPolicy"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(ResourceOverlapPolicy, UGameplayTask), 0x0020080000004000, Z_Construct_UEnum_GameplayTasks_ETaskResourceOverlapPolicy());
				UProperty* NewProp_ResourceOverlapPolicy_Underlying = new(EC_InternalUseOnlyConstructor, NewProp_ResourceOverlapPolicy, TEXT("UnderlyingType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UGameplayTask> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				...
				MetaData->SetValue(NewProp_ResourceOverlapPolicy, TEXT("ModuleRelativePath"), TEXT("Classes/GameplayTask.h"));
	...
	IMPLEMENT_CLASS(UGameplayTask, 2305692936);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->ClassConfigName = FName(TEXT("Game"));
				static TCppClassTypeInfo<TCppClassTypeTraits<UGameplayTaskResource> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UGameplayTaskResource, 202610209);
	...
	UClass* Z_Construct_UClass_UGameplayTask_ClaimResource()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->ClassConfigName = FName(TEXT("Game"));
				static TCppClassTypeInfo<TCppClassTypeTraits<UGameplayTask_ClaimResource> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UGameplayTask_ClaimResource, 445301266);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				OuterClass->ClassConfigName = FName(TEXT("Game"));
				static TCppClassTypeInfo<TCppClassTypeTraits<UGameplayTask_SpawnActor> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UGameplayTask_SpawnActor, 2738481220);
	...
	{
		UObject* Outer=Z_Construct_UClass_UGameplayTask_TimeLimitedExecution();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("TaskFinishDelegate__DelegateSignature"), RF_Public|RF_Transient|RF_MarkAsNative) UDelegateFunction(FObjectInitializer(), NULL, 0x00130000, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnFunction, TEXT("ModuleRelativePath"), TEXT("Classes/Tasks/GameplayTask_TimeLimitedExecution.h"));
#endif
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_UGameplayTask_TimeLimitedExecution()
	{
		...
		if (!OuterClass)
		{
			Z_Construct_UClass_UGameplayTask();
			Z_Construct_UPackage__Script_GameplayTasks();
			OuterClass = UGameplayTask_TimeLimitedExecution::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				UObjectForceRegistration(OuterClass);
				OuterClass->ClassFlags |= 0x20880084;

				OuterClass->LinkChild(Z_Construct_UDelegateFunction_UGameplayTask_TimeLimitedExecution_TaskFinishDelegate__DelegateSignature());

PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_OnTimeExpired = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnTimeExpired"), RF_Public|RF_Transient|RF_MarkAsNative) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnTimeExpired, UGameplayTask_TimeLimitedExecution), 0x0010000010080000, Z_Construct_UDelegateFunction_UGameplayTask_TimeLimitedExecution_TaskFinishDelegate__DelegateSignature());
				UProperty* NewProp_OnFinished = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnFinished"), RF_Public|RF_Transient|RF_MarkAsNative) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnFinished, UGameplayTask_TimeLimitedExecution), 0x0010000010080000, Z_Construct_UDelegateFunction_UGameplayTask_TimeLimitedExecution_TaskFinishDelegate__DelegateSignature());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UDelegateFunction_UGameplayTask_TimeLimitedExecution_TaskFinishDelegate__DelegateSignature(), "TaskFinishDelegate__DelegateSignature"); // 3463750739
				OuterClass->ClassConfigName = FName(TEXT("Game"));
				static TCppClassTypeInfo<TCppClassTypeTraits<UGameplayTask_TimeLimitedExecution> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("Tasks/GameplayTask_TimeLimitedExecution.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("Classes/Tasks/GameplayTask_TimeLimitedExecution.h"));
				MetaData->SetValue(OuterClass, TEXT("ObjectInitializerConstructorDeclared"), TEXT(""));
				MetaData->SetValue(OuterClass, TEXT("ToolTip"), TEXT("Adds time limit for running a child task\n- child task needs to be created with UGameplayTask_TimeLimitedExecution passed as TaskOwner\n- activations are tied together and when either UGameplayTask_TimeLimitedExecution or child task is activated, other one starts as well\n- OnFinished and OnTimeExpired are mutually exclusive"));
				MetaData->SetValue(NewProp_OnTimeExpired, TEXT("ModuleRelativePath"), TEXT("Classes/Tasks/GameplayTask_TimeLimitedExecution.h"));
				MetaData->SetValue(NewProp_OnTimeExpired, TEXT("ToolTip"), TEXT("called when time runs out"));
				MetaData->SetValue(NewProp_OnFinished, TEXT("ModuleRelativePath"), TEXT("Classes/Tasks/GameplayTask_TimeLimitedExecution.h"));
				MetaData->SetValue(NewProp_OnFinished, TEXT("ToolTip"), TEXT("called when child task finishes execution before time runs out"));
#endif
			}
		}
		check(OuterClass->GetClass());
	...
	IMPLEMENT_CLASS(UGameplayTask_TimeLimitedExecution, 404446651);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				OuterClass->ClassConfigName = FName(TEXT("Game"));
				static TCppClassTypeInfo<TCppClassTypeTraits<UGameplayTask_WaitDelay> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	IMPLEMENT_CLASS(UGameplayTask_WaitDelay, 1501635492);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EGameplayTaskRunResult(EGameplayTaskRunResult_StaticEnum, TEXT("/Script/GameplayTasks"), TEXT("EGameplayTaskRunResult"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_GameplayTasks_EGameplayTaskRunResult()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EGameplayTaskRunResult::Error"), 0);
			EnumNames.Emplace(TEXT("EGameplayTaskRunResult::Failed"), 1);
			EnumNames.Emplace(TEXT("EGameplayTaskRunResult::Success_Paused"), 2);
			EnumNames.Emplace(TEXT("EGameplayTaskRunResult::Success_Active"), 3);
			EnumNames.Emplace(TEXT("EGameplayTaskRunResult::Success_Finished"), 4);
			EnumNames.Emplace(TEXT("EGameplayTaskRunResult::EGameplayTaskRunResult_MAX"), 5);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_GameplayTasks_EGameplayTaskRunResult_CRC() { return 602881570U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UGameplayTasksComponent> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
	...
	IMPLEMENT_CLASS(UGameplayTasksComponent, 307915210);
	...
	UPackage* Z_Construct_UPackage__Script_GameplayTasks()
	{
		...
		if (!ReturnPackage)
		{
			ReturnPackage = CastChecked<UPackage>(StaticFindObjectFast(UPackage::StaticClass(), nullptr, FName(TEXT("/Script/GameplayTasks")), false, false));
			...
			Z_Construct_UDelegateFunction_UGameplayTask_TimeLimitedExecution_TaskFinishDelegate__DelegateSignature();
