...
void EmptyLinkFunctionForGeneratedCode1CoreUObject() {}
	...
	COREUOBJECT_API class UEnum* Z_Construct_UEnum_CoreUObject_EAutomationEventType();
	...
	COREUOBJECT_API class UScriptStruct* Z_Construct_UScriptStruct_FPrimaryAssetType();
...
static UEnum* EAutomationEventType_StaticEnum()
{
	...
	if (!Singleton)
	{
		extern COREUOBJECT_API class UEnum* Z_Construct_UEnum_CoreUObject_EAutomationEventType();
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EAutomationEventType(EAutomationEventType_StaticEnum, TEXT("/Script/CoreUObject"), TEXT("EAutomationEventType"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_CoreUObject_EAutomationEventType()
	{
		...
		extern uint32 Get_Z_Construct_UEnum_CoreUObject_EAutomationEventType_CRC();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EAutomationEventType"), 0, Get_Z_Construct_UEnum_CoreUObject_EAutomationEventType_CRC(), false);
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EAutomationEventType"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EAutomationEventType::Info"), 0);
			EnumNames.Emplace(TEXT("EAutomationEventType::Warning"), 1);
			EnumNames.Emplace(TEXT("EAutomationEventType::Error"), 2);
			EnumNames.Emplace(TEXT("EAutomationEventType::EAutomationEventType_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
			ReturnEnum->CppType = TEXT("EAutomationEventType");
#if WITH_METADATA
			UMetaData* MetaData = ReturnEnum->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnEnum, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
			MetaData->SetValue(ReturnEnum, TEXT("ToolTip"), TEXT("Automation"));
#endif
		}
		return ReturnEnum;
	}
	uint32 Get_Z_Construct_UEnum_CoreUObject_EAutomationEventType_CRC() { return 137170982U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ERangeBoundTypes(ERangeBoundTypes_StaticEnum, TEXT("/Script/CoreUObject"), TEXT("ERangeBoundTypes"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_CoreUObject_ERangeBoundTypes()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ERangeBoundTypes::Exclusive"), 0);
			EnumNames.Emplace(TEXT("ERangeBoundTypes::Inclusive"), 1);
			EnumNames.Emplace(TEXT("ERangeBoundTypes::Open"), 2);
			EnumNames.Emplace(TEXT("ERangeBoundTypes::ERangeBoundTypes_MAX"), 3);
	...
	uint32 Get_Z_Construct_UEnum_CoreUObject_ERangeBoundTypes_CRC() { return 3514697286U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EUnit(EUnit_StaticEnum, TEXT("/Script/CoreUObject"), TEXT("EUnit"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_CoreUObject_EUnit()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EUnit::Micrometers"), 0);
			EnumNames.Emplace(TEXT("EUnit::Millimeters"), 1);
			EnumNames.Emplace(TEXT("EUnit::Centimeters"), 2);
			EnumNames.Emplace(TEXT("EUnit::Meters"), 3);
			EnumNames.Emplace(TEXT("EUnit::Kilometers"), 4);
			EnumNames.Emplace(TEXT("EUnit::Inches"), 5);
			EnumNames.Emplace(TEXT("EUnit::Feet"), 6);
			EnumNames.Emplace(TEXT("EUnit::Yards"), 7);
			EnumNames.Emplace(TEXT("EUnit::Miles"), 8);
			EnumNames.Emplace(TEXT("EUnit::Lightyears"), 9);
			EnumNames.Emplace(TEXT("EUnit::Degrees"), 10);
			EnumNames.Emplace(TEXT("EUnit::Radians"), 11);
			EnumNames.Emplace(TEXT("EUnit::MetersPerSecond"), 12);
			EnumNames.Emplace(TEXT("EUnit::KilometersPerHour"), 13);
			EnumNames.Emplace(TEXT("EUnit::MilesPerHour"), 14);
			EnumNames.Emplace(TEXT("EUnit::Celsius"), 15);
			EnumNames.Emplace(TEXT("EUnit::Farenheit"), 16);
			EnumNames.Emplace(TEXT("EUnit::Kelvin"), 17);
			EnumNames.Emplace(TEXT("EUnit::Micrograms"), 18);
			EnumNames.Emplace(TEXT("EUnit::Milligrams"), 19);
			EnumNames.Emplace(TEXT("EUnit::Grams"), 20);
			EnumNames.Emplace(TEXT("EUnit::Kilograms"), 21);
			EnumNames.Emplace(TEXT("EUnit::MetricTons"), 22);
			EnumNames.Emplace(TEXT("EUnit::Ounces"), 23);
			EnumNames.Emplace(TEXT("EUnit::Pounds"), 24);
			EnumNames.Emplace(TEXT("EUnit::Stones"), 25);
			EnumNames.Emplace(TEXT("EUnit::Newtons"), 26);
			EnumNames.Emplace(TEXT("EUnit::PoundsForce"), 27);
			EnumNames.Emplace(TEXT("EUnit::KilogramsForce"), 28);
			EnumNames.Emplace(TEXT("EUnit::Hertz"), 29);
			EnumNames.Emplace(TEXT("EUnit::Kilohertz"), 30);
			EnumNames.Emplace(TEXT("EUnit::Megahertz"), 31);
			EnumNames.Emplace(TEXT("EUnit::Gigahertz"), 32);
			EnumNames.Emplace(TEXT("EUnit::RevolutionsPerMinute"), 33);
			EnumNames.Emplace(TEXT("EUnit::Bytes"), 34);
			EnumNames.Emplace(TEXT("EUnit::Kilobytes"), 35);
			EnumNames.Emplace(TEXT("EUnit::Megabytes"), 36);
			EnumNames.Emplace(TEXT("EUnit::Gigabytes"), 37);
			EnumNames.Emplace(TEXT("EUnit::Terabytes"), 38);
			EnumNames.Emplace(TEXT("EUnit::Lumens"), 39);
			EnumNames.Emplace(TEXT("EUnit::Milliseconds"), 40);
			EnumNames.Emplace(TEXT("EUnit::Seconds"), 41);
			EnumNames.Emplace(TEXT("EUnit::Minutes"), 42);
			EnumNames.Emplace(TEXT("EUnit::Hours"), 43);
			EnumNames.Emplace(TEXT("EUnit::Days"), 44);
			EnumNames.Emplace(TEXT("EUnit::Months"), 45);
			EnumNames.Emplace(TEXT("EUnit::Years"), 46);
			EnumNames.Emplace(TEXT("EUnit::Multiplier"), 47);
			EnumNames.Emplace(TEXT("EUnit::Unspecified"), 48);
			EnumNames.Emplace(TEXT("EUnit::EUnit_MAX"), 49);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::EnumClass);
	...
	uint32 Get_Z_Construct_UEnum_CoreUObject_EUnit_CRC() { return 3409795473U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EMouseCursor(EMouseCursor_StaticEnum, TEXT("/Script/CoreUObject"), TEXT("EMouseCursor"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_CoreUObject_EMouseCursor()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EMouseCursor::None"), 0);
			EnumNames.Emplace(TEXT("EMouseCursor::Default"), 1);
			EnumNames.Emplace(TEXT("EMouseCursor::TextEditBeam"), 2);
			EnumNames.Emplace(TEXT("EMouseCursor::ResizeLeftRight"), 3);
			EnumNames.Emplace(TEXT("EMouseCursor::ResizeUpDown"), 4);
			EnumNames.Emplace(TEXT("EMouseCursor::ResizeSouthEast"), 5);
			EnumNames.Emplace(TEXT("EMouseCursor::ResizeSouthWest"), 6);
			EnumNames.Emplace(TEXT("EMouseCursor::CardinalCross"), 7);
			EnumNames.Emplace(TEXT("EMouseCursor::Crosshairs"), 8);
			EnumNames.Emplace(TEXT("EMouseCursor::Hand"), 9);
			EnumNames.Emplace(TEXT("EMouseCursor::GrabHand"), 10);
			EnumNames.Emplace(TEXT("EMouseCursor::GrabHandClosed"), 11);
			EnumNames.Emplace(TEXT("EMouseCursor::SlashedCircle"), 12);
			EnumNames.Emplace(TEXT("EMouseCursor::EyeDropper"), 13);
			EnumNames.Emplace(TEXT("EMouseCursor::EMouseCursor_MAX"), 14);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_CoreUObject_EMouseCursor_CRC() { return 4228133283U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EPixelFormat(EPixelFormat_StaticEnum, TEXT("/Script/CoreUObject"), TEXT("EPixelFormat"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_CoreUObject_EPixelFormat()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("PF_Unknown"), 0);
			EnumNames.Emplace(TEXT("PF_A32B32G32R32F"), 1);
			EnumNames.Emplace(TEXT("PF_B8G8R8A8"), 2);
			EnumNames.Emplace(TEXT("PF_G8"), 3);
			EnumNames.Emplace(TEXT("PF_G16"), 4);
			EnumNames.Emplace(TEXT("PF_DXT1"), 5);
			EnumNames.Emplace(TEXT("PF_DXT3"), 6);
			EnumNames.Emplace(TEXT("PF_DXT5"), 7);
			EnumNames.Emplace(TEXT("PF_UYVY"), 8);
			EnumNames.Emplace(TEXT("PF_FloatRGB"), 9);
			EnumNames.Emplace(TEXT("PF_FloatRGBA"), 10);
			EnumNames.Emplace(TEXT("PF_DepthStencil"), 11);
			EnumNames.Emplace(TEXT("PF_ShadowDepth"), 12);
			EnumNames.Emplace(TEXT("PF_R32_FLOAT"), 13);
			EnumNames.Emplace(TEXT("PF_G16R16"), 14);
			EnumNames.Emplace(TEXT("PF_G16R16F"), 15);
			EnumNames.Emplace(TEXT("PF_G16R16F_FILTER"), 16);
			EnumNames.Emplace(TEXT("PF_G32R32F"), 17);
			EnumNames.Emplace(TEXT("PF_A2B10G10R10"), 18);
			EnumNames.Emplace(TEXT("PF_A16B16G16R16"), 19);
			EnumNames.Emplace(TEXT("PF_D24"), 20);
			EnumNames.Emplace(TEXT("PF_R16F"), 21);
			EnumNames.Emplace(TEXT("PF_R16F_FILTER"), 22);
			EnumNames.Emplace(TEXT("PF_BC5"), 23);
			EnumNames.Emplace(TEXT("PF_V8U8"), 24);
			EnumNames.Emplace(TEXT("PF_A1"), 25);
			EnumNames.Emplace(TEXT("PF_FloatR11G11B10"), 26);
			EnumNames.Emplace(TEXT("PF_A8"), 27);
			EnumNames.Emplace(TEXT("PF_R32_UINT"), 28);
			EnumNames.Emplace(TEXT("PF_R32_SINT"), 29);
			EnumNames.Emplace(TEXT("PF_PVRTC2"), 30);
			EnumNames.Emplace(TEXT("PF_PVRTC4"), 31);
			EnumNames.Emplace(TEXT("PF_R16_UINT"), 32);
			EnumNames.Emplace(TEXT("PF_R16_SINT"), 33);
			EnumNames.Emplace(TEXT("PF_R16G16B16A16_UINT"), 34);
			EnumNames.Emplace(TEXT("PF_R16G16B16A16_SINT"), 35);
			EnumNames.Emplace(TEXT("PF_R5G6B5_UNORM"), 36);
			EnumNames.Emplace(TEXT("PF_R8G8B8A8"), 37);
			EnumNames.Emplace(TEXT("PF_A8R8G8B8"), 38);
			EnumNames.Emplace(TEXT("PF_BC4"), 39);
			EnumNames.Emplace(TEXT("PF_R8G8"), 40);
			EnumNames.Emplace(TEXT("PF_ATC_RGB"), 41);
			EnumNames.Emplace(TEXT("PF_ATC_RGBA_E"), 42);
			EnumNames.Emplace(TEXT("PF_ATC_RGBA_I"), 43);
			EnumNames.Emplace(TEXT("PF_X24_G8"), 44);
			EnumNames.Emplace(TEXT("PF_ETC1"), 45);
			EnumNames.Emplace(TEXT("PF_ETC2_RGB"), 46);
			EnumNames.Emplace(TEXT("PF_ETC2_RGBA"), 47);
			EnumNames.Emplace(TEXT("PF_R32G32B32A32_UINT"), 48);
			EnumNames.Emplace(TEXT("PF_R16G16_UINT"), 49);
			EnumNames.Emplace(TEXT("PF_ASTC_4x4"), 50);
			EnumNames.Emplace(TEXT("PF_ASTC_6x6"), 51);
			EnumNames.Emplace(TEXT("PF_ASTC_8x8"), 52);
			EnumNames.Emplace(TEXT("PF_ASTC_10x10"), 53);
			EnumNames.Emplace(TEXT("PF_ASTC_12x12"), 54);
			EnumNames.Emplace(TEXT("PF_BC6H"), 55);
			EnumNames.Emplace(TEXT("PF_BC7"), 56);
			EnumNames.Emplace(TEXT("PF_R8_UINT"), 57);
			EnumNames.Emplace(TEXT("PF_L8"), 58);
			EnumNames.Emplace(TEXT("PF_MAX"), 59);
	...
	uint32 Get_Z_Construct_UEnum_CoreUObject_EPixelFormat_CRC() { return 2753035353U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EInterpCurveMode(EInterpCurveMode_StaticEnum, TEXT("/Script/CoreUObject"), TEXT("EInterpCurveMode"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_CoreUObject_EInterpCurveMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("CIM_Linear"), 0);
			EnumNames.Emplace(TEXT("CIM_CurveAuto"), 1);
			EnumNames.Emplace(TEXT("CIM_Constant"), 2);
			EnumNames.Emplace(TEXT("CIM_CurveUser"), 3);
			EnumNames.Emplace(TEXT("CIM_CurveBreak"), 4);
			EnumNames.Emplace(TEXT("CIM_CurveAutoClamped"), 5);
			EnumNames.Emplace(TEXT("CIM_MAX"), 6);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Regular);
	...
	uint32 Get_Z_Construct_UEnum_CoreUObject_EInterpCurveMode_CRC() { return 4195276483U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EAxis(EAxis_StaticEnum, TEXT("/Script/CoreUObject"), TEXT("EAxis"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_CoreUObject_EAxis()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("EAxis::None"), 0);
			EnumNames.Emplace(TEXT("EAxis::X"), 1);
			EnumNames.Emplace(TEXT("EAxis::Y"), 2);
			EnumNames.Emplace(TEXT("EAxis::Z"), 3);
			EnumNames.Emplace(TEXT("EAxis::EAxis_MAX"), 4);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_CoreUObject_EAxis_CRC() { return 2205948604U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ELogTimes(ELogTimes_StaticEnum, TEXT("/Script/CoreUObject"), TEXT("ELogTimes"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_CoreUObject_ELogTimes()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ELogTimes::None"), 0);
			EnumNames.Emplace(TEXT("ELogTimes::UTC"), 1);
			EnumNames.Emplace(TEXT("ELogTimes::SinceGStartTime"), 2);
			EnumNames.Emplace(TEXT("ELogTimes::ELogTimes_MAX"), 3);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_CoreUObject_ELogTimes_CRC() { return 1750121603U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESearchDir(ESearchDir_StaticEnum, TEXT("/Script/CoreUObject"), TEXT("ESearchDir"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_CoreUObject_ESearchDir()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESearchDir::FromStart"), 0);
			EnumNames.Emplace(TEXT("ESearchDir::FromEnd"), 1);
			EnumNames.Emplace(TEXT("ESearchDir::ESearchDir_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_CoreUObject_ESearchDir_CRC() { return 2632683975U; }
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESearchCase(ESearchCase_StaticEnum, TEXT("/Script/CoreUObject"), TEXT("ESearchCase"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_CoreUObject_ESearchCase()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("ESearchCase::CaseSensitive"), 0);
			EnumNames.Emplace(TEXT("ESearchCase::IgnoreCase"), 1);
			EnumNames.Emplace(TEXT("ESearchCase::ESearchCase_MAX"), 2);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_CoreUObject_ESearchCase_CRC() { return 1391684494U; }
	UScriptStruct* Z_Construct_UScriptStruct_FAutomationEvent()
	{
		...
		UPackage* Outer = Z_Construct_UPackage__Script_CoreUObject();
		extern uint32 Get_Z_Construct_UScriptStruct_FAutomationEvent_CRC();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("AutomationEvent"), sizeof(FAutomationEvent), Get_Z_Construct_UScriptStruct_FAutomationEvent_CRC(), false);
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("AutomationEvent"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, NULL, EStructFlags(0x00000008), sizeof(FAutomationEvent), ALIGNOF(FAutomationEvent));
			UProperty* NewProp_Timestamp = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Timestamp"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Timestamp, FAutomationEvent), 0x0010000000000000, Z_Construct_UScriptStruct_FDateTime());
			UProperty* NewProp_LineNumber = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("LineNumber"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(LineNumber, FAutomationEvent), 0x0010000000000000);
			UProperty* NewProp_Filename = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Filename"), RF_Public|RF_Transient|RF_MarkAsNative) UStrProperty(CPP_PROPERTY_BASE(Filename, FAutomationEvent), 0x0010000000000000);
			UProperty* NewProp_Context = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Context"), RF_Public|RF_Transient|RF_MarkAsNative) UStrProperty(CPP_PROPERTY_BASE(Context, FAutomationEvent), 0x0010000000000000);
			UProperty* NewProp_Message = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Message"), RF_Public|RF_Transient|RF_MarkAsNative) UStrProperty(CPP_PROPERTY_BASE(Message, FAutomationEvent), 0x0010000000000000);
			UProperty* NewProp_Type = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Type"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(Type, FAutomationEvent), 0x0010000000000000, Z_Construct_UEnum_CoreUObject_EAutomationEventType());
			...
			MetaData->SetValue(NewProp_Timestamp, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
			MetaData->SetValue(NewProp_LineNumber, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
			MetaData->SetValue(NewProp_Filename, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
			MetaData->SetValue(NewProp_Context, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
			MetaData->SetValue(NewProp_Message, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
			MetaData->SetValue(NewProp_Type, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FAutomationEvent_CRC() { return 410482589U; }
	...
	{
		UPackage* Outer = Z_Construct_UPackage__Script_CoreUObject();
		extern uint32 Get_Z_Construct_UScriptStruct_FPrimaryAssetId_CRC();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("PrimaryAssetId"), sizeof(FPrimaryAssetId), Get_Z_Construct_UScriptStruct_FPrimaryAssetId_CRC(), false);
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PrimaryAssetId"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, NULL, EStructFlags(0x00000008), sizeof(FPrimaryAssetId), ALIGNOF(FPrimaryAssetId));
			UProperty* NewProp_PrimaryAssetName = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("PrimaryAssetName"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(PrimaryAssetName, FPrimaryAssetId), 0x0010000000000005);
			UProperty* NewProp_PrimaryAssetType = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("PrimaryAssetType"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(PrimaryAssetType, FPrimaryAssetId), 0x0010000000000005, Z_Construct_UScriptStruct_FPrimaryAssetType());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("BlueprintType"), TEXT("true"));
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
			MetaData->SetValue(ReturnStruct, TEXT("ToolTip"), TEXT("This identifies an object as a \"primary\" asset that can be searched for by the AssetManager and used in various tools"));
			MetaData->SetValue(NewProp_PrimaryAssetName, TEXT("Category"), TEXT("PrimaryAssetId"));
			MetaData->SetValue(NewProp_PrimaryAssetName, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
			MetaData->SetValue(NewProp_PrimaryAssetName, TEXT("ToolTip"), TEXT("The Name of this object, by default it's short name"));
			MetaData->SetValue(NewProp_PrimaryAssetType, TEXT("Category"), TEXT("PrimaryAssetId"));
			MetaData->SetValue(NewProp_PrimaryAssetType, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
			MetaData->SetValue(NewProp_PrimaryAssetType, TEXT("ToolTip"), TEXT("The Type of this object, by default it's base class's name"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FPrimaryAssetId_CRC() { return 1438431073U; }
	UScriptStruct* Z_Construct_UScriptStruct_FPrimaryAssetType()
	{
		UPackage* Outer = Z_Construct_UPackage__Script_CoreUObject();
		extern uint32 Get_Z_Construct_UScriptStruct_FPrimaryAssetType_CRC();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("PrimaryAssetType"), sizeof(FPrimaryAssetType), Get_Z_Construct_UScriptStruct_FPrimaryAssetType_CRC(), false);
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PrimaryAssetType"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, NULL, EStructFlags(0x00000008), sizeof(FPrimaryAssetType), ALIGNOF(FPrimaryAssetType));
			UProperty* NewProp_Name = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Name"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(Name, FPrimaryAssetType), 0x0040000000000000);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("BlueprintType"), TEXT("true"));
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
			MetaData->SetValue(ReturnStruct, TEXT("ToolTip"), TEXT("A type of primary asset, this is a wrapper around FName and can be cast back and forth"));
			MetaData->SetValue(NewProp_Name, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
			MetaData->SetValue(NewProp_Name, TEXT("ToolTip"), TEXT("The Type of this object, by default it's base class's name"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FPrimaryAssetType_CRC() { return 893344895U; }
	...
	UScriptStruct* Z_Construct_UScriptStruct_FBox2D()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_bIsValid = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bIsValid"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(bIsValid, FBox2D), 0x0010000000000000);
			...
			MetaData->SetValue(NewProp_bIsValid, TEXT("ModuleRelativePath"), TEXT("Public/UObject/NoExportTypes.h"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FBox2D_CRC() { return 3480512114U; }
	...
	uint32 Get_Z_Construct_UScriptStruct_FIntVector_CRC() { return 2763987625U; }
	...
	UClass* Z_Construct_UClass_UObject()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UObject> > StaticCppClassTypeInfo;
	...
	*/
	IMPLEMENT_CLASS(UObject, 2708960695);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ELifetimeCondition(ELifetimeCondition_StaticEnum, TEXT("/Script/CoreUObject"), TEXT("ELifetimeCondition"), false, nullptr, nullptr);
	UEnum* Z_Construct_UEnum_CoreUObject_ELifetimeCondition()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Emplace(TEXT("COND_None"), 0);
			EnumNames.Emplace(TEXT("COND_InitialOnly"), 1);
			EnumNames.Emplace(TEXT("COND_OwnerOnly"), 2);
			EnumNames.Emplace(TEXT("COND_SkipOwner"), 3);
			EnumNames.Emplace(TEXT("COND_SimulatedOnly"), 4);
			EnumNames.Emplace(TEXT("COND_AutonomousOnly"), 5);
			EnumNames.Emplace(TEXT("COND_SimulatedOrPhysics"), 6);
			EnumNames.Emplace(TEXT("COND_InitialOrOwner"), 7);
			EnumNames.Emplace(TEXT("COND_Custom"), 8);
			EnumNames.Emplace(TEXT("COND_ReplayOrOwner"), 9);
			EnumNames.Emplace(TEXT("COND_ReplayOnly"), 10);
			EnumNames.Emplace(TEXT("COND_SimulatedOnlyNoReplay"), 11);
			EnumNames.Emplace(TEXT("COND_SimulatedOrPhysicsNoReplay"), 12);
			EnumNames.Emplace(TEXT("COND_SkipReplay"), 13);
			EnumNames.Emplace(TEXT("COND_Max"), 14);
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Regular);
	...
	uint32 Get_Z_Construct_UEnum_CoreUObject_ELifetimeCondition_CRC() { return 2619509045U; }
	...
	UPackage* Z_Construct_UPackage__Script_CoreUObject()
	{
		...
		if (!ReturnPackage)
		{
			ReturnPackage = CastChecked<UPackage>(StaticFindObjectFast(UPackage::StaticClass(), nullptr, FName(TEXT("/Script/CoreUObject")), false, false));
			...
			Z_Construct_UScriptStruct_FAutomationEvent();
		}
